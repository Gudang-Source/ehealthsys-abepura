...
return array (
  ...
  'CDbCommand failed to execute the SQL statement: {error}' => ((YII_DEBUG) ? 'CDbCommand gagal menjalankan statementSQL:{error}' : 'Data Tidak Dapat Dihapus Karena Masih Digunakan Di Tabel Lain'),
