...
/**
 * This is the model class for table "pasientindaklanjutkeri_v".
 *
 * The followings are the available columns in table 'pasientindaklanjutkeri_v':
 ...
 */
class PasientindaklanjutkeriV extends CActiveRecord
{
	/**
	...
	{
		return 'pasientindaklanjutkeri_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, kelurahan_id, pendaftaran_id, carabayar_id, penjamin_id, shift_id, penanggungjawab_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, rujukan_id, pasienpulang_id, lamarawat, pasienbatalpulang_id, rujukankeluar_id, pegawai_id, kelompokumur_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'kelompokumur_nama' => 'Kelompok Umur',
		);
	}
