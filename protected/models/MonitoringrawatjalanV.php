...
/**
 * This is the model class for table "monitoringrawatjalan_v".
 *
 * The followings are the available columns in table 'monitoringrawatjalan_v':
 ...
 */
class MonitoringrawatjalanV extends CActiveRecord
{
                public $tgl_awal;
                public $tgl_akhir;
                public $nama_dokter;
	 ...
	 * @return MonitoringrawatjalanV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_pasien, statusperiksa, statuspasien, kunjungan, carabayar_nama, penjamin_nama, ruangan_nama, instalasi_nama, kelaspelayanan_nama', 'length', 'max'=>50),
