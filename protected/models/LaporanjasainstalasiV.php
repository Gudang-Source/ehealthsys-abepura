...
class LaporanjasainstalasiV extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('profilrs_id, pasien_id, rt, rw, anakke, jumlah_bersaudara, pendaftaran_id, tindakanpelayanan_id, penjamin_id, carabayar_id, kelaspelayanan_id, instalasi_id, ruangan_id, daftartindakan_id, tipepaket_id, qty_tindakan, tindakansudahbayar_id, shift_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'subsisidirumahsakit_tindakan' => 'Subsisidi Rumahsakit Tindakan',
