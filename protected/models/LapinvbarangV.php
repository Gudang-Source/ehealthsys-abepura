...
/**
 * This is the model class for table "lapinvbarang_v".
 *
 * The followings are the available columns in table 'lapinvbarang_v':
 ...
 */
class LapinvbarangV extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('invbarang_id, mengetahui_id, petugas1_id, petugas2_id, invbarangdet_id, inventarisasi_id, formulirinvbarang_id, forminvbarangdet_id', 'numerical', 'integerOnly'=>true),
			array('invbarang_totalnetto, volume_fisik, harga_satuan, jumlah_harga, harga_netto, jumlah_netto, barang_harganetto, barang_hpp, inventarisasi_qty_in, inventarisasi_qty_out, inventarisasi_qty_skrg, forminvbarang_totalvolume, forminvbarang_totalharga, volume_inventaris', 'numerical'),
			...
			array('invbarang_id, invbarang_no, invbarang_tgl, invbarang_ket, invbarang_totalnetto, mengetahui_id, petugas1_id, petugas2_id, create_time, update_time, update_loginpemakai_id, create_loginpemakai_id, create_ruangan, invbarangdet_id, volume_fisik, harga_satuan, jumlah_harga, harga_netto, jumlah_netto, kondisi_barang, barang_kode, barang_nama, barang_merk, barang_noseri, barang_satuan, barang_harganetto, barang_hpp, inventarisasi_id, inventarisasi_qty_in, inventarisasi_qty_out, inventarisasi_qty_skrg, formulirinvbarang_id, forminvbarang_no, forminvbarang_tgl, forminvbarang_totalvolume, forminvbarang_totalharga, forminvbarangdet_id, volume_inventaris', 'safe', 'on'=>'search'),
		);
	}
