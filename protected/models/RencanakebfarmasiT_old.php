...
class RencanakebfarmasiT extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('update_time, update_loginpemakai_id, tglmengetahui, tglmenyetujui', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('rencanakebfarmasi_id, ruangan_id, pegawai_id, otorisasipimpinan_id, otorisasikeuangan_id, tglperencanaan, noperencnaan, create_time, update_time, create_loginpemakai_id, update_loginpemakai_id, create_ruangan, pegawaimengetahui_id, pegawaimenyetujui_id, statusrencana, tglmengetahui, tglmenyetujui, jmlwaktupemakaian, leadtime_lt', 'safe', 'on'=>'search'),
		);
	}
