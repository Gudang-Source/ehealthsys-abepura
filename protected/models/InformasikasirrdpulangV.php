...
/**
 * This is the model class for table "informasikasirrdpulang_v".
 *
 * The followings are the available columns in table 'informasikasirrdpulang_v':
 ...
 */
class InformasikasirrdpulangV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
        public $pegawai_id;
	 ...
	 * @return InformasikasirrdpulangV the static model class
	 */
	...
	{
		return 'informasikasirrdpulang_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, pekerjaan_id, carabayar_id, penjamin_id, shift_id, penanggungjawab_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, pasienpulang_id, pembayaranpelayanan_id, lamarawat', 'numerical', 'integerOnly'=>true),
