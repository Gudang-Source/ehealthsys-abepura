...
/**
 * This is the model class for table "inforawatdaruratapotikblbayar_v".
 *
 * The followings are the available columns in table 'inforawatdaruratapotikblbayar_v':
 ...
 */
class InforawatdaruratapotikblbayarV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
        public $pilihanx;
	 ...
	 * @return InforawatdaruratapotikblbayarV the static model class
	 */
	...
	{
		return 'inforawatdaruratapotikblbayar_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_pasien, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, pekerjaan_nama, transportasi, keadaanmasuk, statusperiksa, statuspasien, kunjungan, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, caramasuk_nama, nama_perujuk, asalrujukan_nama, pengantar, hubungankeluarga, nama_pj, ruangan_nama, instalasi_nama, kelaspelayanan_nama, nama_pegawai, carakeluar, kondisipulang, status_konfirmasi', 'length', 'max'=>50),
