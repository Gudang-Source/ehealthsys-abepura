 ...
 * @property integer $jeniswaktu_nourut
 */
class JenisWaktuM extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('jeniswaktu_nama', 'required'),
			...
			array('jeniswaktu_id, jeniswaktu_nama, jeniswaktu_namalain, jeniswaktu_jam, jeniswaktu_aktif, jeniswaktu_nourut', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'jeniswaktu_id' => 'ID',
			'jeniswaktu_nama' => 'Nama Jenis Waktu',
			'jeniswaktu_namalain' => 'Nama Lain',
			'jeniswaktu_jam' => 'Jam',
			'jeniswaktu_aktif' => 'Aktif',
                        'jeniswaktu_nourut'=>'No. Urut',
		);
	}
