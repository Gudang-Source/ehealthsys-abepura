...
/**
 * This is the model class for table "rinciantagihapasienlaboratorium_v".
 *
 * The followings are the available columns in table 'rinciantagihapasienlaboratorium_v':
 ...
 * @property boolean $is_alkes
 */
class RinciantagihapasienlaboratoriumV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RinciantagihapasienlaboratoriumV the static model class
	 */
	...
	{
		return 'rinciantagihapasienlaboratorium_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('tarif_rsakomodasi, tarif_medis, tarif_paramedis, tarif_bhp, tarif_satuan, tarif_tindakan, qty_tindakan, tarifcyto_tindakan, discount_tindakan, pembebasan_tindakan, subsidiasuransi_tindakan, subsidipemerintah_tindakan, subsisidirumahsakit_tindakan, iurbiaya_tindakan, biayaservice, biayaadministrasi, biayakonseling', 'numerical'),
	...
	public function search()
	{
		...
		$criteria->compare('is_alkes',$this->is_alkes);
