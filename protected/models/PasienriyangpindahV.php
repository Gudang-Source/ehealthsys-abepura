...
/**
 * This is the model class for table "pasienriyangpindah_v".
 *
 * The followings are the available columns in table 'pasienriyangpindah_v':
 ...
 */
class PasienriyangpindahV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
	/**
	 ...
	 * @return PasienriyangpindahV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_pasien, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, pekerjaan_nama, transportasi, keadaanmasuk, statusperiksa, statuspasien, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, caramasuk_nama, nama_perujuk, asalrujukan_nama, pengantar, hubungankeluarga, nama_pj, ruanganasal_nama, instalasiasal_nama, kelaspelayanan_nama, kunjungan, nama_pegawai, nomasukkamar, ruangan_nama, instalasi_nama', 'length', 'max'=>50),
	...
	public function search()
	{
        ...
        public function getTglAdmisiPindahKamar(){
            $time = $this->tgladmisi.'/<br>'.$this->tglmasukkamar;
            return $time;
        }
