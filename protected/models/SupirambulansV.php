...
/**
 * This is the model class for table "supirambulans_v".
 *
 * The followings are the available columns in table 'supirambulans_v':
 ...
 */
class SupirambulansV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SupirambulansV the static model class
	 */
