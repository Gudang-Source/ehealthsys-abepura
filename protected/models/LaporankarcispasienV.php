...
/**
 * This is the model class for table "laporankarcispasien_v".
 *
 * The followings are the available columns in table 'laporankarcispasien_v':
 ...
 */
class LaporankarcispasienV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
	/**
	 ...
	 * @return LaporankarcispasienV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, carabayar_id, penjamin_id, shift_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, rujukan_id, pasienpulang_id, profilrs_id, karcis_id, daftartindakan_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'shift_id' => 'Shift',
			'ruangan_id' => 'Ruangan',
			'ruangan_nama' => 'Ruangan Nama / Poliklinik',
