...
/**
 * This is the model class for table "produkpos_v".
 *
 * The followings are the available columns in table 'produkpos_v':
 ...
 */
class ProdukposV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProdukposV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('harganetto, hargajual, discount, ppn_persen, margin, gp_persen', 'numerical'),
