...
/**
 * This is the model class for table "laporantindaklanjutrd_v".
 *
 * The followings are the available columns in table 'laporantindaklanjutrd_v':
 ...
 */
class LaporantindaklanjutrdV extends CActiveRecord
{
                public $tgl_awal;
                public $tgl_akhir;
	/**
	 ...
	 * @return LaporantindaklanjutrdV the static model class
	 */
	...
	{
		return 'laporantindaklanjutrd_v';
	}
