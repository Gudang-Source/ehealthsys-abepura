...
/**
 * This is the model class for table "laporankunjunganpersalinan_v".
 *
 * The followings are the available columns in table 'laporankunjunganpersalinan_v':
 ...
 */
class LaporankunjunganpersalinanV extends CActiveRecord
{
      public $tgl_awal;
        public $tgl_akhir;
        public $data;
	 ...
	 * @return LaporankunjunganpersalinanV the static model class
	 */
	...
	{
		return 'laporankunjunganpersalinan_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, carabayar_id, penjamin_id, caramasuk_id, shift_id, asalrujukan_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, rujukan_id', 'numerical', 'integerOnly'=>true),
