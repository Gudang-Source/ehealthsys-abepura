...
/**
 * This is the model class for table "laporantriasepasien_v".
 *
 * The followings are the available columns in table 'laporantriasepasien_v':
 ...
 */
class LaporantriasepasienV extends CActiveRecord
{
        public $tgl_awal, $tgl_akhir;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporantriasepasienV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, pendaftaran_id, carabayar_id, penjamin_id, shift_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, rujukan_id, pasienpulang_id, lamarawat, pasienbatalpulang_id, triase_id, anamesa_id, diagnosa_id', 'numerical', 'integerOnly'=>true),
