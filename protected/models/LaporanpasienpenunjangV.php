...
/**
 * This is the model class for table "laporanpasienpenunjang_v".
 *
 * The followings are the available columns in table 'laporanpasienpenunjang_v':
...
class LaporanpasienpenunjangV extends CActiveRecord
{
	 ...
	 * @return LaporanpasienpenunjangV the static model class
	 */
	...
	{
		return 'laporanpasienpenunjang_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, pendaftaran_id, shift_id, ruanganasal_id, jeniskasuspenyakit_id, kelaspelayanan_id, ruanganpenunj_id, instalasiasal_id, pasienadmisi_id, pasienkirimkeunitlain_id, pegawai_id, gelarbelakang_id, carabayar_id, penjamin_id, propinsi_id, kabupaten_id, kecamatan_id, kelurahan_id', 'numerical', 'integerOnly'=>true),
