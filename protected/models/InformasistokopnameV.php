...
/**
 * This is the model class for table "informasistokopname_v".
 *
 * The followings are the available columns in table 'informasistokopname_v':
 ...
 */
class InformasistokopnameV extends CActiveRecord
{
	/**
