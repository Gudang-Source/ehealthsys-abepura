...
/**
 * This is the model class for table "laporankonsulantarpoli_v".
 *
 * The followings are the available columns in table 'laporankonsulantarpoli_v':
 ...
 */
class LaporankonsulantarpoliV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
	 ...
	 * @return LaporankonsulantarpoliV the static model class
	 */
	...
	{
		return 'laporankonsulantarpoli_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, pendaftaran_id, shift_id, ruanganasal_id, jeniskasuspenyakit_id, kelaspelayanan_id, ruangantujuan_id', 'numerical', 'integerOnly'=>true),
			...
			array('nama_pasien, transportasi, keadaanmasuk, statuspasien, kunjungan, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, ruanganasal_nama, kelaspelayanan_nama, statusperiksa, ruangantujuan_nama', 'length', 'max'=>50),
