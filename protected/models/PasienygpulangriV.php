...
/**
 * This is the model class for table "pasienygpulangri_v".
 *
 * The followings are the available columns in table 'pasienygpulangri_v':
 ...
 */
class PasienygpulangriV extends CActiveRecord
{
