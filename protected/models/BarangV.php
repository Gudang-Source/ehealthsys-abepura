...
class BarangV extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'invtanah_kode' => 'Kode Barang (Jaringan)',
			'invtanah_noregister' => 'No. Registrasi (Jaringan)',
			'invtanah_namabrg' => 'Nama Barang (Jaringan)',
			...
			'invtanah_umurekonomis' => 'Umur Ekonomis (Jaringan)',
