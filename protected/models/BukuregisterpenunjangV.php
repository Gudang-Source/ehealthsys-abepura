...
/**
 * This is the model class for table "bukuregisterpenunjang_v".
 *
 * The followings are the available columns in table 'bukuregisterpenunjang_v':
...
class BukuregisterpenunjangV extends CActiveRecord
{
	 ...
	 * @return BukuregisterpenunjangV the static model class
	 */
	...
	{
		return 'bukuregisterpenunjang_v';
	}
