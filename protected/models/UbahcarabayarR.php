...
/**
 * This is the model class for table "ubahcarabayar_r".
 *
 * The followings are the available columns in table 'ubahcarabayar_r':
 * @property integer $ubahacarabayar_id
 * @property integer $carabayar_id
 * @property integer $penjamin_id
 * @property integer $pendaftaran_id
 * @property string $tglubahcarabayar
 ...
 */
class UbahcarabayarR extends CActiveRecord
{
        public $pakeAsuransi;
	/**
	...
	public function rules()
	{
		...
		return array(
			array('tglubahcarabayar, alasanperubahan, carabayar_id, penjamin_id, pendaftaran_id', 'required'),
	...
	{
		return array(
			'ubahacarabayar_id' => 'Ubah cara bayar',
			'carabayar_id' => 'Cara bayar',
			'penjamin_id' => 'Penjamin',
			'pendaftaran_id' => 'Pendaftaran',
			'tglubahcarabayar' => 'Tanggal ubah cara bayar',
	...
	public function search()
	{
		...
		$criteria->compare('ubahacarabayar_id',$this->ubahacarabayar_id);
		$criteria->compare('carabayar_id',$this->carabayar_id);
		$criteria->compare('penjamin_id',$this->penjamin_id);
		$criteria->compare('pendaftaran_id',$this->pendaftaran_id);
		$criteria->compare('LOWER(tglubahcarabayar)',strtolower($this->tglubahcarabayar),true);
