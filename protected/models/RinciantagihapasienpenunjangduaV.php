...
/**
 * This is the model class for table "rinciantagihapasienpenunjangdua_v".
 *
 * The followings are the available columns in table 'rinciantagihapasienpenunjangdua_v':
 ...
 */
class RinciantagihapasienpenunjangduaV extends CActiveRecord
{
	/**
	...
	{
		return 'rinciantagihapasienpenunjangdua_v';
	}
