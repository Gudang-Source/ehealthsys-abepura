...
/**
 * This is the model class for table "pasienrawatinapkasir_v".
 *
 * The followings are the available columns in table 'pasienrawatinapkasir_v':
 ...
 * @property string $ruanganawal_nama
 ...
 */
class PasienrawatinapkasirV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
	 ...
	 * @return PasienrawatinapkasirV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, pekerjaan_id, carabayar_id, penjamin_id, shift_id, golonganumur_id, asalrujukan_id, penanggungjawab_id, ruanganakhir_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, pasienadmisi_id, kamarruangan_id, ruanganawal_id, pembayaranpelayanan_id, pasienpulang_id, pasienbatalpulang_id, lamarawat', 'numerical', 'integerOnly'=>true),
			...
			array('nama_pasien, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, pekerjaan_nama, transportasi, keadaanmasuk, statusperiksa, statuspasien, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, nama_perujuk, asalrujukan_nama, pengantar, hubungankeluarga, nama_pj, ruanganakhir_nama, instalasi_nama, kelaspelayanan_nama, kunjungan, nama_pegawai, ruanganawal_nama, carakeluar, kondisipulang, satuanlamarawat', 'length', 'max'=>50),
			array('tempat_lahir, golonganumur_nama', 'length', 'max'=>25),
			array('golongandarah', 'length', 'max'=>2),
			array('photopasien', 'length', 'max'=>200),
			array('alamatemail, jeniskasuspenyakit_nama, penerimapasien', 'length', 'max'=>100),
			...
			array('tanggal_lahir, alamat_pasien, tgl_rekam_medik, tgl_pendaftaran, alihstatus, byphone, kunjunganrumah, tanggal_rujukan, diagnosa_rujukan, tgladmisi, tglpulang, statuskeluar, rawatgabung, tglpasienpulang, create_time, create_loginpemakai_id, create_ruangan', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('pasien_id, jenisidentitas, no_identitas_pasien, namadepan, nama_pasien, nama_bin, jeniskelamin, tempat_lahir, tanggal_lahir, alamat_pasien, rt, rw, agama, golongandarah, photopasien, alamatemail, statusrekammedis, statusperkawinan, no_rekam_medik, tgl_rekam_medik, propinsi_id, propinsi_nama, kabupaten_id, kabupaten_nama, kelurahan_id, kelurahan_nama, kecamatan_id, kecamatan_nama, pendaftaran_id, pekerjaan_id, pekerjaan_nama, no_pendaftaran, tgl_pendaftaran, no_urutantri, transportasi, keadaanmasuk, statusperiksa, statuspasien, alihstatus, byphone, kunjunganrumah, statusmasuk, umur, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_id, carabayar_nama, penjamin_id, penjamin_nama, shift_id, golonganumur_id, golonganumur_nama, no_rujukan, nama_perujuk, tanggal_rujukan, diagnosa_rujukan, asalrujukan_id, asalrujukan_nama, penanggungjawab_id, pengantar, hubungankeluarga, nama_pj, ruanganakhir_id, ruanganakhir_nama, instalasi_id, instalasi_nama, jeniskasuspenyakit_id, jeniskasuspenyakit_nama, kelaspelayanan_id, kelaspelayanan_nama, pasienadmisi_id, tgladmisi, tglpulang, kunjungan, statuskeluar, rawatgabung, kamarruangan_id, kamarruangan_nokamar, kamarruangan_nobed, gelardepan, nama_pegawai, gelarbelakang_nama, ruanganawal_id, ruanganawal_nama, pembayaranpelayanan_id, pasienpulang_id, pasienbatalpulang_id, tglpasienpulang, carakeluar, kondisipulang, penerimapasien, lamarawat, satuanlamarawat, create_time, create_loginpemakai_id, create_ruangan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ruanganawal_nama' => 'Ruanganawal Nama',
	...
	public function search()
	{
		...
		$criteria->compare('LOWER(ruanganawal_nama)',strtolower($this->ruanganawal_nama),true);
