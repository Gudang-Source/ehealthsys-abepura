...
/**
 * This is the model class for table "pasienriygpindahruangan_v".
 *
 * The followings are the available columns in table 'pasienriygpindahruangan_v':
 ...
 */
class PasienriygpindahruanganV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PasienriygpindahruanganV the static model class
	 */
	...
	{
		return 'pasienriygpindahruangan_v';
	}
