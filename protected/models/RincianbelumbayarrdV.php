...
/**
 * This is the model class for table "rincianbelumbayarrd_v".
 *
 * The followings are the available columns in table 'rincianbelumbayarrd_v':
 ...
 */
class RincianbelumbayarrdV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RincianbelumbayarrdV the static model class
	 */
    ...
    public function getDokterTindakan()
    {
    	...
    	// $gelarDepan = $modDokter->gelardepan.' '.$modDokter->nama_pegawai.' '.$modDokter->gelarbelakang_nama; 	     

    	if(isset($modDokter->gelardepan)){
    		$gelarDepan = $modDokter->gelardepan.' '.$modDokter->nama_pegawai;
    			if(isset($modDokter->gelarbelakang_nama)){
    				$gelarDepan = $gelarDepan.' '.$modDokter->gelarbelakang_nama; 
    			}
    	}else if(isset($modDokter->gelarbelakang_nama)){
    		$gelarDepan = $modDokter->nama_pegawai.' '.$modDokter->gelarbelakang_nama; 	     
    	}else{
    		$gelarDepan = isset($modDokter->nama_pegawai)?$modDokter->nama_pegawai:' - ';
    	}
