...
/**
 * This is the model class for table "pasienbatalperiksa_v".
 *
 * The followings are the available columns in table 'pasienbatalperiksa_v':
 ...
 */
class PasienbatalperiksaV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
        public $pendidikan_id, $suku_id , $pekerjaan_id, $bulan;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PasienbatalperiksaV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, carabayar_id, penjamin_id, caramasuk_id, shift_id, asalrujukan_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, rujukan_id, pasienpulang_id, profilrs_id', 'numerical', 'integerOnly'=>true),
			...
			array('nama_pasien, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, transportasi, keadaanmasuk, statusperiksa, statuspasien, kunjungan, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, caramasuk_nama, nama_perujuk, asalrujukan_nama, ruangan_nama, instalasi_nama, kelaspelayanan_nama', 'length', 'max'=>50),
	...
	public function attributeLabels()
	{
		return array(
			...
			'jeniskasuspenyakit_nama' => 'Jenis Kasuspenyakit',
