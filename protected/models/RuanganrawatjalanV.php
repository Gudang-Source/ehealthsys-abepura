...
/**
 * This is the model class for table "ruanganrawatjalan_v".
 *
 * The followings are the available columns in table 'ruanganrawatjalan_v':
 ...
 */
class RuanganrawatjalanV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RuanganrawatjalanV the static model class
	 */
