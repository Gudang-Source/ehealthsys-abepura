 ...
 *
 * The followings are the available columns in table 'laporankunjunganrj_v':
 ...
 */
class LaporankunjunganrjV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporankunjunganrjV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, carabayar_id, penjamin_id, caramasuk_id, shift_id, asalrujukan_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id', 'numerical', 'integerOnly'=>true),
