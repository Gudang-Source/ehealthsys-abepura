...
/**
 * This is the model class for table "rinciantagihapasienri_v".
 *
 * The followings are the available columns in table 'rinciantagihapasienri_v':
 ...
 * @property integer $ruanganadmisi_id
 * @property integer $tindakansudahbayar_id
 */
class RinciantagihanpasienriV extends CActiveRecord
{
        public $tgl_awal, $tgl_akhir, $statusBayar, $totaltagihan;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RinciantagihanpasienriV the static model class
	 */
	...
	{
		return 'rinciantagihapasienri_v';
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ruanganadmisi_id' => 'Ruanganadmisi',
	...
	public function search()
	{
		...
		$criteria->compare('ruanganadmisi_id',$this->ruanganadmisi_id);
