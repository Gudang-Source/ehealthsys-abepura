...
/**
 * This is the model class for table "laporansensuharianpersalinan_v".
 *
 * The followings are the available columns in table 'laporansensuharianpersalinan_v':
 ...
 */
class LaporansensuharianpersalinanV extends CActiveRecord
{
    public $tgl_awal, $tgl_akhir, $data, $jumlah, $tick, $pilihan;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporansensuharianpersalinanV the static model class
	 */
	...
	{
		return 'laporansensuharianpersalinan_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('photopasien, diagnosa_nama, daftartindakan_nama', 'length', 'max'=>200),
