...
class LokasiasetM extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('lokasi_id, lokasiaset_kode, lokasiaset_namainstalasi, lokasiaset_namabagian, lokasiaset_namalokasi, lokasiaset_aktif', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'lokasi_id' => 'ID',
			'lokasiaset_kode' => 'Kode Lokasi Aset',
			'lokasiaset_namainstalasi' => 'Instalasi',
			'lokasiaset_namabagian' => 'Ruangan',
			'lokasiaset_namalokasi' => 'Nama Lokasi Aset',
			'lokasiaset_aktif' => 'Aktif',
		);
	}
...
//                $criteria->addCondition('lokasiaset_aktif is true');
