...
class InfoimplementasiaskepV extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('implementasiaskep_tgl, create_time, update_time, create_loginpemakai_id, update_loginpemakai_id, create_ruangan, tgl_pendaftaran, alamat_pasien, tgllahir_pj, alamat_pj', 'safe'),
