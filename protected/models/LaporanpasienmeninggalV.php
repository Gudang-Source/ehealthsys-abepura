...
/**
 * This is the model class for table "laporanpasienmeninggal_v".
 *
 * The followings are the available columns in table 'laporanpasienmeninggal_v':
 ...
 */
class LaporanpasienmeninggalV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
	 ...
	 * @return LaporanpasienmeninggalV the static model class
	 */
	...
	{
		return 'laporanpasienmeninggal_v';
	}
	...
	public function search()
	{
        ...
        {
            return GolonganumurM::model()->findAll('golonganumur_aktif=TRUE ORDER BY golonganumur_nama');
        }
