...
/**
 * This is the model class for table "laporanextrafoodinggizi_v".
 *
 * The followings are the available columns in table 'laporanextrafoodinggizi_v':
 ...
 */
class LaporanextrafoodinggiziV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporanextrafoodinggiziV the static model class
	 */
	...
	{
		return 'laporanextrafoodinggizi_v';
	}
