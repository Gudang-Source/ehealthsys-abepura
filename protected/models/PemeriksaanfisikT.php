...
class PemeriksaanfisikT extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('frek_auskultasi, portio_genitalia, tekanandarah_text, meanarteripressure, td_systolic, td_diastolic, bb_ideal, kulit, mata, telinga, hidung, leher, tenggorokan, jantung, payudara, abdomen, update_time, update_loginpemakai_id,Lila, LingkarPinggang, LingkarPinggul, TebalLemak, TinggiLutut, denyutjantung_janin, tinggifundus_uteri', 'safe'),
