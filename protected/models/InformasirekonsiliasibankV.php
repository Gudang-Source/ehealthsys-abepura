...
/**
 * This is the model class for table "informasirekonsiliasibank_v".
 *
 * The followings are the available columns in table 'informasirekonsiliasibank_v':
 ...
 */
class InformasirekonsiliasibankV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InformasirekonsiliasibankV the static model class
	 */
	...
	{
		return 'informasirekonsiliasibank_v';
	}
