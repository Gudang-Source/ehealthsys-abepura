...
/**
 * This is the model class for table "laporanrekaptransaksi_v".
 *
 * The followings are the available columns in table 'laporanrekaptransaksi_v':
 ...
 */
class LaporanrekaptransaksiV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporanrekaptransaksiV the static model class
	 */
    
        public $tgl_awal, $tgl_akhir, $bulan, $tahun, $komponentarif_id;
	...
	{
		return 'laporanrekaptransaksi_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('profilrs_id, pasien_id, rt, rw, anakke, jumlah_bersaudara, pendaftaran_id, tindakanpelayanan_id, penjamin_id, carabayar_id, kelaspelayanan_id, instalasi_id, ruangan_id, daftartindakan_id, tipepaket_id, jeniskasuspenyakit_id, pembayaranpelayanan_id, kategoritindakan_id, pegawai_id, gelarbelakang_id, ruanganpendaftaran_id, tindakansudahbayar_id', 'numerical', 'integerOnly'=>true),
			array('tarif_rsakomodasi, tarif_medis, tarif_paramedis, tarif_bhp, tarif_satuan, tarif_tindakan, qty_tindakan, tarifcyto_tindakan, discount_tindakan, pembebasan_tindakan, subsidiasuransi_tindakan, subsidipemerintah_tindakan, subsisidirumahsakit_tindakan, iurbiaya_tindakan', 'numerical'),
