...
/**
 * This is the model class for table "rl3_3_kegiatangigimulut_v".
 *
 * The followings are the available columns in table 'rl3_3_kegiatangigimulut_v':
 ...
 */
class Rl33KegiatangigimulutV extends CActiveRecord
{
	/**
	...
	{
		return 'rl3_3_kegiatangigimulut_v';
	}
