...
class PenerimaanlinendetailT extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('penerimaanlinendetail_id, linen_id, jenisperawatanlinen', 'required'),
			array('penerimaanlinendetail_id, linen_id, penerimaanlinen_id', 'numerical', 'integerOnly'=>true),
