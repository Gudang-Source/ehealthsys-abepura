...
/**
 * This is the model class for table "informasipermintaanpenawaran_v".
 *
 * The followings are the available columns in table 'informasipermintaanpenawaran_v':
 ...
 */
class InformasipermintaanpenawaranV extends CActiveRecord
{
	/**
	...
	{
		return 'informasipermintaanpenawaran_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('permintaanpenawaran_id, instalasi_id, ruangan_id, pegawaimengetahui_id, pegawaimenyetujui_id, pegawai_id, supplier_id, supplier_termin', 'numerical', 'integerOnly'=>true),
			array('nosuratpenawaran, instalasi_nama, ruangan_nama, pegawaimengetahui_nama, pegawaimenyetujui_nama, pegawai_nama, supplier_telp, supplier_fax, supplier_kodepos, supplier_matauang, supplier_website, supplier_email', 'length', 'max'=>50),
			array('pegawaimengetahui_gelardepan, pegawaimenyetujui_gelardepan, pegawai_gelardepan, supplier_kode', 'length', 'max'=>10),
			array('pegawaimengetahui_gelarbelakang, pegawaimenyetujui_gelarbelakang, pegawai_gelarbelakang', 'length', 'max'=>15),
			...
			array('supplier_jenis, statuspenawaran', 'length', 'max'=>20),
			array('tglpenawaran, supplier_alamat, ispenawaranmasuk', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('permintaanpenawaran_id, tglpenawaran, nosuratpenawaran, instalasi_id, instalasi_nama, ruangan_id, ruangan_nama, pegawaimengetahui_id, pegawaimengetahui_gelardepan, pegawaimengetahui_nama, pegawaimengetahui_gelarbelakang, pegawaimenyetujui_id, pegawaimenyetujui_gelardepan, pegawaimenyetujui_nama, pegawaimenyetujui_gelarbelakang, pegawai_id, pegawai_gelardepan, pegawai_nama, pegawai_gelarbelakang, supplier_id, supplier_kode, supplier_nama, supplier_namalain, supplier_alamat, supplier_propinsi, supplier_kabupaten, supplier_telp, supplier_fax, supplier_kodepos, supplier_npwp, supplier_norekening, supplier_namabank, supplier_rekatasnama, supplier_matauang, supplier_website, supplier_email, supplier_logo, supplier_cp, supplier_cp_hp, supplier_cp_email, supplier_cp2, supplier_cp2_hp, supplier_cp2_email, supplier_jenis, supplier_termin, statuspenawaran, ispenawaranmasuk', 'safe', 'on'=>'search'),
		);
	}
