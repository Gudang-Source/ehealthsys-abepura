...
/**
 * This is the model class for table "rl3_9_pelayananrehabilitasimedik_v".
 *
 * The followings are the available columns in table 'rl3_9_pelayananrehabilitasimedik_v':
 ...
 */
class Rl39PelayananrehabilitasimedikV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Rl39PelayananrehabilitasimedikV the static model class
	 */
	...
	{
		return 'rl3_9_pelayananrehabilitasimedik_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('tahun, profilrs_id, nokode_rumahsakit, nama_rumahsakit, daftartindakan_id, daftartindakan_nama, jumlah', 'safe', 'on'=>'search'),
		);
	}
