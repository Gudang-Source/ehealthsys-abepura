...
class LaporanjurnalV extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('jenisjurnal_nama, nmrekening1', 'length', 'max'=>100),
			...
			array('nmrekening2, uraiantransaksi', 'length', 'max'=>200),
