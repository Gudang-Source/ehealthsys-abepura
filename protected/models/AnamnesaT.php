...
class AnamnesaT extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('riwayatpenyakitterdahulu, riwayatpenyakitkeluarga, pengobatanygsudahdilakukan, riwayatalergiobat, riwayatkelahiran, riwayatmakanan, paramedis_nama, riwayatperjalananpasien', 'length', 'max'=>1000),
