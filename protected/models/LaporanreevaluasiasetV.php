...
/**
 * This is the model class for table "laporanreevaluasiaset_v".
 *
 * The followings are the available columns in table 'laporanreevaluasiaset_v':
 ...
 */
class LaporanreevaluasiasetV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporanreevaluasiasetV the static model class
	 */
	...
	{
		return 'laporanreevaluasiaset_v';
	}
