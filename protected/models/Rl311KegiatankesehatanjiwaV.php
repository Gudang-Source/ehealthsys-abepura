...
/**
 * This is the model class for table "rl3_11_kegiatankesehatanjiwa_v".
 *
 * The followings are the available columns in table 'rl3_11_kegiatankesehatanjiwa_v':
 ...
 */
class Rl311KegiatankesehatanjiwaV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Rl311KegiatankesehatanjiwaV the static model class
	 */
	...
	{
		return 'rl3_11_kegiatankesehatanjiwa_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('tgl_laporan, qty_tindakan', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('tgl_laporan, propinsi, koders, profilrs_id, kabupaten, namars, jeniskegiatan_id, jeniskegiatan_kode, jeniskegiatan_nama, qty_tindakan', 'safe', 'on'=>'search'),
