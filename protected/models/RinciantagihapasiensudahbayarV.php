...
/**
 * This is the model class for table "rinciantagihapasiensudahbayar_v".
 *
 * The followings are the available columns in table 'rinciantagihapasiensudahbayar_v':
 ...
 */
class RinciantagihapasiensudahbayarV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RinciantagihapasiensudahbayarV the static model class
	 */
	...
	{
		return 'rinciantagihapasiensudahbayar_v';
	}
