...
/**
 * This is the model class for table "laporanpendapatanpenunjang_v".
 *
 * The followings are the available columns in table 'laporanpendapatanpenunjang_v':
 ...
 */
class LaporanpendapatanpenunjangV extends CActiveRecord
{
	/**
	...
	{
		return 'laporanpendapatanpenunjang_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('profilrs_id, pasien_id, rt, rw, anakke, jumlah_bersaudara, pendaftaran_id, penjamin_id, carabayar_id, kelaspelayanan_id, instalasi_id, ruangan_id, tipepaket_id, tindakansudahbayar_id, shift_id, perawat_id, rujukan_id', 'numerical', 'integerOnly'=>true),
			...
			array('jenisidentitas, namadepan, jeniskelamin, statusperkawinan, agama, rhesus, no_mobile_pasien, no_pendaftaran, no_masukpenunjang', 'length', 'max'=>20),
