 ...
 */
class Tindakanrm extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Tindakanrm the static model class
	 */
	...
	public function attributeLabels()
	{
		return array(
			...
			'tindakanrm_namalainnya' => 'Tindakanrm Namalainnya',
			'tindakanrm_aktif' => 'Tindakanrm Aktif',
		);
	}
