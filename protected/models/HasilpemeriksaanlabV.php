...
/**
 * This is the model class for table "hasilpemeriksaanlab_v".
 *
 * The followings are the available columns in table 'hasilpemeriksaanlab_v':
 ...
 */
class HasilpemeriksaanlabV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return HasilpemeriksaanlabV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, pendaftaran_id, pekerjaan_id, carabayar_id, penjamin_id, shift_id, golonganumur_id, ruanganasal_id, instalasiasal_id, jeniskasuspenyakit_id, kelaspelayanan_id, ruangan_id, pasienadmisi_id, pasienmasukpenunjang_id, pegawai_id, hasilpemeriksaanlab_id', 'numerical', 'integerOnly'=>true),
			array('jenisidentitas, namadepan, jeniskelamin, agama, statusperkawinan, no_masukpenunjang, no_pendaftaran, nohasilperiksalab', 'length', 'max'=>20),
			array('no_identitas_pasien, nama_bin, umur', 'length', 'max'=>30),
			array('nama_pasien, pekerjaan_nama, keadaanmasuk, statuspasien, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, ruanganasal_nama, instalasiasal_nama, kelaspelayanan_nama, nama_dokterasal, kunjungan, statusperiksa, ruangan_nama, nama_pegawai, hasil_kelompokumur, hasil_jeniskelamin, statusperiksahasil', 'length', 'max'=>50),
