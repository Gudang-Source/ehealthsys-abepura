...
/**
 * This is the model class for table "laporanpasiendirujuk_v".
 *
 * The followings are the available columns in table 'laporanpasiendirujuk_v':
 ...
 */
class LaporanpasiendirujukV extends CActiveRecord
{
        public $tgl_awal, $tgl_akhir;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporanpasiendirujukV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, pendaftaran_id, carabayar_id, penjamin_id, shift_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, rujukan_id, pasienpulang_id, lamarawat, pasienbatalpulang_id, rujukankeluar_id', 'numerical', 'integerOnly'=>true),
			...
			array('nama_pasien, transportasi, keadaanmasuk, statusperiksa, statuspasien, kunjungan, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, ruangan_nama, instalasi_nama, carakeluar, kondisipulang, satuanlamarawat, rumahsakitrujukan, telp_fax, nosuratrujukan', 'length', 'max'=>50),
	...
	public function attributeLabels()
	{
		return array(
			...
			'tgldirujuk' => 'Tanggal Di Rujuk',
			'kepadayth' => 'Yth Dokter',
			'dirujukkebagian' => 'Di Rujuk Kebagian',
