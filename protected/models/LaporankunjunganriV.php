...
/**
 * This is the model class for table "laporankunjunganri_v".
 *
 * The followings are the available columns in table 'laporankunjunganri_v':
 ...
 */
class LaporankunjunganriV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
        public $pilihanx;
	 ...
	 * @return LaporankunjunganriV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, carabayar_id, penjamin_id, caramasuk_id, asalrujukan_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, masukkamar_id, pindahkamar_id, shift_id', 'numerical', 'integerOnly'=>true),
