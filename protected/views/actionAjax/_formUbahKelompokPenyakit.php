...
<script type="text/javascript">
    function loadDataPendaftaran()
    {
        ...
        $.post("<?php echo ($menu == 'RD' ? Yii::app()->createUrl('ActionAjax/getDataPendaftaranRD') : Yii::app()->createUrl('ActionAjax/getDataPendaftaranRJ')); ?>", { pendaftaran_id: pendaftaran_id },
            function(data){
                ...
                $('#PendaftaranT_ruangan_id').val(data.ruangan_id);
    ...
    {
        $.post("<?php echo Yii::app()->createUrl('ActionAjax/getKasusPenyakit')?>", { id_ruangan: id_ruangan },
            function(data){
                $('#PendaftaranT_jeniskasuspenyakit_id').empty().append(data.listPenyakit);
            },
        "json");        
    }
</script>