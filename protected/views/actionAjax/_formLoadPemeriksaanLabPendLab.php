...
<tr id="periksalab_<?php echo $idPemeriksaanLab; ?>">
    <td><?php echo CHtml::checkBox('LKTindakanPelayananT[cek][]',true, array('onclick'=>'myAlert("Silahkan klik tombol \'Pilih Pemeriksaan Laboratorium\' untuk membatalkan pemeriksaan"); $(this).attr("checked",true);'));?></td>    
    <td>
