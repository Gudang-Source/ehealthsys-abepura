...
Class Params
{
	...
	const KELOMPOKPEGAWAI_ID_TENAGA_LAB = 11; //kelompokpegawai_m tenaga lab (analis lab)
	const KELOMPOKPEGAWAI_ID_TENAGA_RAD = 11; //kelompokpegawai_m tenaga rad (radiografer)
