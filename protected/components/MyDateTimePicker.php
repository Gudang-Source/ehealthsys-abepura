...
class MyDateTimePicker extends CJuiDateTimePicker
{
    ...
    {
        switch($this->mode){
            case 'date' : $span = '<span id ="'. $this->htmlOptions['id'] . '_date' .'" class="add-on"><i class="icon-calendar"></i></span>';break;
            case 'time' : $span = '<span id ="'. $this->htmlOptions['id'] . '_date' .'" class="add-on"><i class="icon-time"></i></span>';break;
            case 'datetime' : $span = '<span id ="'. $this->htmlOptions['id'] . '_date' .'" class="add-on"><i class="icon-calendar"></i><i class="icon-time"></i></span>';break;
            default : $span = '';
        }
