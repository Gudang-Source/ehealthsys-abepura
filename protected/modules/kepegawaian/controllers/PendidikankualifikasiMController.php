...
//	public $layout='//layouts/column1';
	...
	public function actionCreate()
		...
		$model=new KPPendidikankualifikasiM;
	...
	{
		$dataProvider=new CActiveDataProvider('KPPendidikankualifikasiM');
	...
	public function actionAdmin()
	{
		...
		$model=new KPPendidikankualifikasiM('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['KPPendidikankualifikasiM']))
			$model->attributes=$_GET['KPPendidikankualifikasiM'];
	...
	{
		$model=KPPendidikankualifikasiM::model()->findByPk($id);
		if($model===null)
...
//                    $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('admin'));
        ...
        if(isset($_POST['id']))
        {
           $update = KPPendidikankualifikasiM::model()->updateByPk($id,array('pendkualifikasi_aktif'=>false));
           if($update)
            {
                if (Yii::app()->request->isAjaxRequest)
                {
        ...
        {
            $model= new KPPendidikankualifikasiM;
            $model->attributes=$_REQUEST['KPPendidikankualifikasiM'];
            $judulLaporan='Data Kualifikasi Pendidikan';
