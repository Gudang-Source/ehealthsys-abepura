	...
	<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
		...
		'columns'=>array(
			...
			array(
				...
				'filter'=> CHtml::activeDropDownList($model,'jabatan_id',CHtml::listData(KPJabatanM::model()->findAll("jabatan_aktif is true"), "jabatan_id", "jabatan_nama"),array('empty'=>'--Pilih--')),
			),
			array(
				...
				'filter'=> CHtml::activeDropDownList($model,'jenispenilaian_id',CHtml::listData(KPJenispenilaianM::model()->findAll("jenispenilaian_aktif is true"), "jenispenilaian_id", "jenispenilaian_nama"),array('empty'=>'--Pilih--')),
			),
			array(
				'header'=>'Kompetensi',
				'name'=>'kompetensi_id',
				'value'=>'(isset($data->kompetensi->kompetensi_nama) ? $data->kompetensi->kompetensi_nama : "-")',
				'filter'=> CHtml::activeDropDownList($model,'kompetensi_id',CHtml::listData(KPKompetensiM::model()->findAll("kompetensi_aktif is true"), "kompetensi_id", "kompetensi_nama"),array('empty'=>'--Pilih--')),
			),
...
<script type="text/javascript">
	...
	{
		$("#kpindikatorperilaku-m-search :input[name='"+obj.name+"']").val(obj.value);
	}	
