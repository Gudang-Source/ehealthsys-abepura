...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('kppenilaianpegawai-t-grid', {
		data: $(this).serialize()
	});
	return false;
});
			...
			'class'=>'bootstrap.widgets.BootButtonColumn',
                        ...
                        'buttons'=>array(
                                        'remove' => array (
                                                ...
                                                'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/removeTemporary",array("id"=>"$data->penilaianpegawai_id"))',
...
{
    window.open("${urlPrint}/"+$('#kppenilaianpegawai-t-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
