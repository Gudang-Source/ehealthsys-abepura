...
<ol class="row-fluid">
    <div class="span6">        
        ...
        <li>
            Icon <i class="icon-time"></i> untuk menentukan waktu presensi.
        </li>       
        <li>
        ...
        <li>
            Tombol  <div class="btn btn-primary" type="button"><i class="icon-ok icon-white"></i> Simpan</div>
            berfungsi untuk menyimpan.
        </li>
    </div>
    <div class="span6">
        <li>
            Tombol  <div class="btn btn-danger"type="button"><i class="icon-refresh icon-white"></i> Ulang</div>
            berfungsi untuk melakukan transaksi ulang.
        </li>
        <li>
            Tombol  <div class="btn btn-info" type="button"><i class="icon-print icon-white"></i></div> dapat digunakan (sedang aktif)
        ...
        <li>
            Tombol  <div class="btn btn-info" type="button"><i class="icon-print icon-white"></i> Print</div>
            berfungsi untuk mencetak presensi.
        </li>
    </div>
</ol>
