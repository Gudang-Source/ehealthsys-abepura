...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('kpkolomrating-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
	...
	<!--<div class="block-tabel">-->
		<!--<h6 class="rim2">Tabel Kolom Rating</h6>-->
	<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
		'id'=>'kpkolomrating-m-grid',
...
<!--</div>-->
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Kolom Rating',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
...
{
    $("#kpkolomrating-m-search :input[name='"+ obj.name +"']").val(obj.value);
}
function print(caraPrint)
{
    window.open("${urlPrint}/"+$('#kpkolomrating-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
