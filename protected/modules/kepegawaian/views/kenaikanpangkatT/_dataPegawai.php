...
<fieldset id="divRiwayatPendidikanpegawai">
    <div>
        <legend class="accord1" style="width:460px;"><?php echo CHtml::checkBox('cekRiwayatpegawai',false, array('onkeypress'=>"return $(this).focusNextInputField(event)",'onclick'=>'ViewRiwayatPangkat()')) ?> Riwayat Pangkat Pegawai </legend>
                    ...
                    array(
                        ...
                        'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","",array("class"=>"btn-small", 
                                        ...
                                        "onClick" => "$(\"#NIP\").val(\"$data->nomorindukpegawai\");
                                                      ...
                                                      $(\"#KPKenaikanpangkatT_uskenpangkat_masakerjabulan\").val(\"$data->tglditerima\");
                                                      $(\"#KPKenaikanpangkatT_pangkat\").val($data->pangkat_id);
                                                      $(\"#KPKenaikanpangkatT_jabatan\").val($data->jabatan_id);
                                                      ...
                                                      kurangiTanggal(\"$data->tglditerima\");
                                                      return false;
                                            "))',
                    ),
                'nomorindukpegawai',
