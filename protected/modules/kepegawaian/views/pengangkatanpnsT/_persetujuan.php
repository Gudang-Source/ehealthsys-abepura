...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $form->textField($model, 'perspeng_masakerjatahun', array('class' => 'span1 currency', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?> <label>Tahun</label>
        <?php echo $form->textField($model, 'perspeng_masakerjabulan', array('class' => 'span1 currency', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?> <label>Bulan</label>
    </div>    
</div>
...
<?php echo $form->textFieldRow($model,'perspeng_gajipokok',array('class'=>'span3  currency', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
