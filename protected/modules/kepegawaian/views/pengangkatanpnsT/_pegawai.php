                    ...
                    array(
                        ...
                        'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","",array("class"=>"btn-small", 
                                        ...
                                        "onClick" => "
													  ...
													  $(\"#pangkat\").val(\"".(($data->pangkat->pangkat_nama)?$data->pangkat->pangkat_nama : null)."\");
													  ...
													  $(\"#KPPengangkatanpnsT_jabatan\").val(\"".$data->jabatan->jabatan_nama."\");
													  $(\"#KPPengangkatanpnsT_pangkat\").val(\"".(($data->pangkat->pangkat_nama)?$data->pangkat->pangkat_nama : null)."\");
													  $(\"#KPPengangkatanpnsT_pendidikan\").val(\"".$data->pendidikan->pendidikan_nama."\");
