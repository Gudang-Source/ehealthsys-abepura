...
<tr>
                            ...
                            <td style="padding-right:0px;">
                                ...
                                <?php echo $form->textField($model,'['.$i.']nourutperj',array('class'=>'span1 pegawai', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
                            </td>
                            <td>
                                <?php echo $form->textField($model,'['.$i.']tujuandinas',array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>30)); ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php echo $form->dropDownList($model,'['.$i.']propinsi_nama',CHtml::listData(PropinsiM::model()->findAll(), 'propinsi_nama', 'propinsi_nama'),array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
                            ...
                            <td>
                                <?php echo $form->dropDownList($model,'['.$i.']kotakabupaten_nama',CHtml::listData(KabupatenM::model()->findAll(), 'kabupaten_nama', 'kabupaten_nama'),array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
                            ...
                            <td>
                                <?php echo $form->textField($model,'['.$i.']negaratujuan',array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>10)); ?>
                            </td>
                            <td>
