        ...
        <div class="white">
            ...
            //                ),
                    ...
                    array(
                        'header'=>'Hapus',
                        'type'=>'raw',
                        'value'=>'($data->jabatan_aktif)?CHtml::link("<i class=\'icon-form-silang\'></i> ","javascript:removeTemporary($data->jabatan_id)",array("id"=>"$data->jabatan_id","rel"=>"tooltip","title"=>"Menonaktifkan"))." ".CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->jabatan_id)",array("id"=>"$data->jabatan_id","rel"=>"tooltip","title"=>"Hapus")):CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->jabatan_id)",array("id"=>"$data->jabatan_id","rel"=>"tooltip","title"=>"Hapus"));',
