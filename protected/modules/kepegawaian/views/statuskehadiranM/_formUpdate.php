...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->textFieldRow($model,'statuskehadiran_nama',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
            <?php echo $form->textFieldRow($model,'statuskehadiran_singkatan',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>1)); ?>
            <div>
                <?php echo $form->checkBoxRow($model,'statuskehadiran_aktif', array('onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
            </div>
