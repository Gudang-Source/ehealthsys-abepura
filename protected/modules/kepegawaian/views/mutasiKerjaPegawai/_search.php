            ...
            <tr>
                ...
                <td>                    
                    <div class = "control-group">
                       ...
                       <div class = "controls">
                           <?php echo $form->dropDownList($model,'unitkerja', Chtml::listData(RuanganM::model()->findAll("ruangan_aktif = TRUE ORDER BY ruangan_nama ASC"), 'ruangan_nama', 'ruangan_nama'),array('empty'=>'-- Pilih --')) ?>
                       </div>
                   </div>
                    ...
                    <div class = "control-group">
                       ...
                       <div class = "controls">
                           <?php echo $form->dropDownList($model,'unitkerja_baru', Chtml::listData(RuanganM::model()->findAll("ruangan_aktif = TRUE ORDER BY ruangan_nama ASC"), 'ruangan_nama', 'ruangan_nama'),array('empty'=>'-- Pilih --')) ?>
                       </div>
                   </div>
                </td>                
            </tr>
