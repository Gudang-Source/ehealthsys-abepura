...
$this->widget('bootstrap.widgets.BootMenu', array(
    ...
    'items'=>array(
        ...
        array('label'=>'Status kepemilikan rumah', 'url'=>$this->createUrl('/kepegawaian/statuskepemilikanrumahM/admin'), 'active'=>true ),
        ...
        array('label'=>'Golongan Gaji', 'url'=>$this->createUrl('/kepegawaian/golonganGajiM/admin')),
