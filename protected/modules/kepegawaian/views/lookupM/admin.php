...
<fieldset class="box row-fluid">
    ...
    <!--<div class="biru">
        <div class="white">-->
            ...
            $this->menu=array(
            //        array('label'=>Yii::t('mds','Manage').' Minat Pekerjaan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master')),
            //	array('label'=>Yii::t('mds','List').' Lookup', 'icon'=>'list', 'url'=>array('index')),
            //	array('label'=>Yii::t('mds','Create').' Minat Pekerjaan', 'icon'=>'file', 'url'=>array('create')),
            );
            ...
            <!--<div class="block-tabel">-->
                <!--<h6>Tabel <b>Minat Pekerjaan</b></h6>-->
