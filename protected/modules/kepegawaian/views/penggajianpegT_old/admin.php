...
$arrMenu = array();
                (Yii::app()->user->checkAccess(Params::DEFAULT_ADMIN)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' KPPenggajianpegT ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) :  '' ;
