...
<fieldset class="box row-fluid">
    <legend class="rim">Pengaturan Golongan Pegawai</legend>
    <?php
        ...
        <div class="white">-->
            ...
            //                ),
                    ...
                    array(
                        'header'=>'Hapus',
                        'type'=>'raw',
                        'value'=>'($data->golonganpegawai_aktif)?CHtml::link("<i class=\'icon-form-silang\'></i> ","javascript:removeTemporary($data->golonganpegawai_id)",array("id"=>"$data->golonganpegawai_id","rel"=>"tooltip","title"=>"Menonaktifkan"))." ".CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->golonganpegawai_id)",array("id"=>"$data->golonganpegawai_id","rel"=>"tooltip","title"=>"Hapus")):CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->golonganpegawai_id)",array("id"=>"$data->golonganpegawai_id","rel"=>"tooltip","title"=>"Hapus"));',
    ...
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Golongan Pegawai', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl(Yii::app()->controller->id.'/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
