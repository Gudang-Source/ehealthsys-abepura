...
<fieldset id="divRiwayatPendidikanpegawai">
    <div>
        <legend class="accord1" style="width:460px;"><?php echo CHtml::checkBox('cekRiwayatpegawai',false, array('onkeypress'=>"return $(this).focusNextInputField(event)",'onclick'=>'ViewRiwayatJabatan()')) ?> Riwayat Susunan Keluarga </legend>
