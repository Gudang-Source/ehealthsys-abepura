...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->textFieldRow($model,'nilai_angkamin',array('class'=>'span3 integer', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
            <?php echo $form->textFieldRow($model,'nilai_angkamaks',array('class'=>'span3 integer', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
            ...
            <?php //echo $form->checkBoxRow($model,'nilai_aktif', array('onkeypress'=>"return $(this).focusNextInputField(event);",'checked'=>true)); ?>
