...
<fieldset id="divRiwayatPendidikanpegawai">
    <div>
        <table class="table table-striped table-condensed" id="tableRiwayatpendidikanpegawai" style="display:none;">
               
            <thead>
                    <tr>
                        <th colspan="12" bgcolor="white">Pendidikan Pegawai</th>
                    </tr>
                    <tr>
...
<fieldset id="">
    <div>
            ...
            <table class="table table-bordered table-striped table-condensed" style="display:none;" id="tableRiwayatOrganisasi">
                <thead>
                    <tr>
                        <th colspan="7" bgcolor="white">Pengorganisasian Pegawai</th>
                    </tr>
                    <tr>
                        <th>No. Urut</th>
