<div class="white-container">
    <legend class="rim2">Penjualan Resep <b>Rumah Sakit</b></legend>
    <?php
    ...
    if(isset($_GET['sukses'])){
        if($_GET['sukses'] == 1){
            Yii::app()->user->setFlash("success","Tansaksi Penjualan resep berhasil disimpan!");
        }
    }
    ?>
    ...
    <fieldset class="box" id="form-infopasien">
        ...
        <div class="row-fluid">
            <?php $this->renderPartial($this->path_view.'_formInfoPasien', array('form'=>$form,'modInfoRI'=>$modInfoRI)); ?>
        </div>
    </fieldset>
    <div class="row-fluid">
        <div class="span6">
            <fieldset class="box" id="form-dataresep">
                <legend class="rim">Data Resep</legend>
                    ...
                    <?php $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
                        'id'=>'form-detailresep',
                        'content'=>array(
                            'content-detailresep'=>array(
                                'header'=>CHtml::htmlButton("<i class='icon-minus icon-white'></i>",array('class'=>'btn btn-primary btn-mini','onclick'=>'','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk tampilkan detail resep')).'<b> Detail Resep</b>',
                                'isi'=>$this->renderPartial($this->path_view.'_tabelResepturDetail', array('modDetailReseptur'=>$modDetailReseptur), true),
                                'active'=>false,
                                ),   
                            ),
                    )); ?>
    ...
    <div class="form-actions">
            ...
            ?>
            <?php
                $content = $this->renderPartial('tips/tipsPenjualanResepRS',array(),true);
