<div class="row-fluid" >
    <div class="span6">
        ...
        <div class="control-group">  
            ...
            <div class="controls">
                ...
                <div style="float:left;">
                    <?php
                    $modReseptur->dokter = (empty($modPenjualan->pegawai_id) ? NULL : $modPenjualan->pegawai_id);
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                echo CHtml::dropDownList('jenisresep', '', array(0 => 'Non Racikan', 1 => 'Racikan'), array('key' => 'jenisresep', 'class' => 'span3', 'onchange' => 'formjenisresep(this.value); setDropDownRke();')
                );
                ?><br>
            </div>
        </div>
    ...
    <div class="span6">
        ...
        <?php
        echo $form->dropDownListRow($modPenjualan, 'carabayar_id', CHtml::listData($modPenjualan->getCaraBayarItems(), 'carabayar_id', 'carabayar_nama'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)",
