<div class="white-container">
    <legend class="rim2">Penjualan <b>Dokter</b></legend>
    <?php
    ...
    if(isset($_GET['sukses'])){
        if($_GET['sukses'] == 1){
            Yii::app()->user->setFlash("success","Transaksi Penjualan Dokter berhasil disimpan!");
        }
    }
    ?>
    ...
    <fieldset class="box" id="form-info">
        <legend class="rim"><span class='judul'>Data </span><span class='tombol' style='display:none;'><?php echo CHtml::htmlButton('<i class="icon-refresh icon-white"></i>',array('class'=>'btn btn-danger btn-mini','onclick'=>'setInfoPegawaiReset();','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk mengulang data kunjungan')); ?></span></legend>
        <div class="row-fluid">
    ...
    <?php $this->renderPartial($this->path_view_karyawan.'_jsFunctions', array('modPenjualan'=>$modPenjualan,'modReseptur'=>$modReseptur)); ?>
</div>