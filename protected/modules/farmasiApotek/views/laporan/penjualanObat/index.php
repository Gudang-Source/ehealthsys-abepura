<div class="white-container">
    <legend class="rim2">Laporan <b>Penjualan Obat</b></legend>
    <?php
    ...
    <div class="block-tabel">
        <h6>Tabel <b>Penjualan</b></h6>
        <?php $model = new FALaporanpenjualanobatV; ?>
        <?php $this->renderPartial('penjualanObat/_tablePenjualanObat', array('model'=>$model)); ?>
    </div>
    <div class="block-tabel">
