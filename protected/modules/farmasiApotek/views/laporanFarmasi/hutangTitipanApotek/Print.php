...
<?php
if ($caraPrint != 'GRAFIK')
    $this->renderPartial('hutangTitipanApotek/_table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK')
echo $this->renderPartial('_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true); 
if(isset($caraPrint))
$this->renderPartial('hutangTitipanApotek/_tandatangan', array('model'=>$model, 'caraPrint'=>$caraPrint));
?>
