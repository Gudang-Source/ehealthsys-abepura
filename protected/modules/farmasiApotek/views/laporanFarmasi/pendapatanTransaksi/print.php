...
if ($caraPrint != 'GRAFIK' && $caraPrint != 'EXCEL'){
    $this->renderPartial('pendapatanTransaksi/_tablePrint', array('model'=>$model, 'caraPrint'=>$caraPrint));
}
if ($caraPrint == 'GRAFIK')
echo $this->renderPartial('_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true); 
if ($caraPrint == 'EXCEL')
echo $this->renderPartial('pendapatanTransaksi/_tableExcel', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true); 
