...
<div class="search-form" style="">
    ...
    $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
        ...
        'type' => 'horizontal',
        'id' => 'searchLaporan',
        'focus' => '#FAPenjualanResepT_noresep',
            ...
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php //echo $form->dropDownList($model, 'noresep', CHtml::listData(PegawaiM::model()->findAll(array('order'=>'nama_pegawai')), 'pegawai_id', 'nama_pegawai'),array('class'=>'span3', 'empty'=>'-- Pilih Nama Dokter --')); ?>
                    </div>
                </div>
            </td>
        </tr>
