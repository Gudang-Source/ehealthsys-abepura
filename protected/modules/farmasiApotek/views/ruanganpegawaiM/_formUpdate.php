	...
	<p class="help-block"><?php echo Yii::t('mds','Fields with <span class="required">*</span> are required.') ?></p>
        ...
        <table id="tabelKasuspenyakitdiagnosa" class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                {
                    $hapus = Yii::app()->createUrl('farmasiApotek/ruanganpegawaiM/Delete',array('id'=>"$value->ruangan_id",'pegawai'=>"$value->pegawai_id"));
                    $tr = '<tr>';
                    ...
                    $tr .= '<td>'.CHtml::link("<i class='icon-trash'></i>",$hapus, array('onclick'=>'remove(this);')).'</td>';
                    $tr .= '</tr>';
                    echo $tr;
                }
