<div class="white-container">
    <legend class="rim2">Tambah <b>Diagnosa Obat</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Diagnosa Obat ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
