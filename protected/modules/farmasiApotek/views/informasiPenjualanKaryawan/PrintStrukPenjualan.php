...
<table>
    ...
    <tr>
        ...
        <td>Dokter</td>
        <td>:</td>
        <td><?php echo  ($reseptur->jenispenjualan == Params::JENISPENJUALAN_RESEP OR  $reseptur->jenispenjualan == Params::JENISPENJUALAN_RESEP_LUAR) ? '-' : $reseptur->pegawai->nama_pegawai;?></td>
    </tr>
    <tr>
        <td>Cara Bayar</td>
        <td>:</td>
...
<table id="tableObatAlkes" class="table table-bordered table-condensed" style="width: 98%; margin: auto;" >
    ...
    <?php
    $no=1;
    $lainLain = $reseptur->biayaadministrasi+$reseptur->biayakonseling+$reseptur->totaltarifservice; //+$reseptur->jasadokterresep << SDH TERMASUK DLM HARGA OBAT
