...
<table border="0" style="padding :none;">
  ...
  <tr>
    ...
    <td>Icon <i class="icon-chevron-down"></i> untuk menampilkan form yang tersembunyi.</td>
      ...
      <td>3. </td>
        <td>Gunakan icon ini <i class="icon-list-alt"></i> berfungsi untuk menampilkan lis</td>
  </tr>.
      </tr>
      <td>4. </td>
        <td>Gunakan tombol ini <button class="btn btn-primary" type="button" name="yt0" rel="tooltip" onkeypress="" onclick="addDataResep();return false;" data-original-title="Klik untuk menambahkan resep">
...
Ulang
  ...
  <tr>
    <td>8. </td>
    <td>Gunakan tombol ini <a class="btn btn-primary disabled" href="javascript:void(0);" rel="tooltip" onclick="return false;" data-original-title="">
<i class="icon-shopping-cart icon-white"></i>
Pembayaran
</a> untuk tindak lanjut pembelian resep.</td>
  </tr>
</table>
</p>
