...
<table border="0" style="padding :none;">
  ...
  <tr>
    <td>2. </td>
    <td>Icon  <i class="icon-list-alt"></i> berfungsi untuk menindak lanjuti proses transaksi atau detail data dari informasi.</td>
  </tr>
<tr>
    <td>3. </td>
    <td>Icon  <i class="icon-remove"></i> berfungsi untuk melakukan pembatalan.</td>
  </tr>
  <tr>
    <td>4. </td>
