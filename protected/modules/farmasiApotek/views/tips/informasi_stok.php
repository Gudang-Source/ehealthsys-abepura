...
<!--  <tr>
    <td>1. </td>
    <td>Icon <i class="icon-calendar"></i> untuk menentukan tanggal transaksi / pendaftaran.</td>
  </tr>-->
 
<!--   <tr>
    <td>2. </td>
    <td>Icon <i class="icon-list-alt"></i> untuk melihat detail rincian / transaksi.</td>
  </tr>-->
  <tr>
    <td>1. </td>
    <td>Gunakan tombol ini  <a class="btn btn-primary" name="yt0"><i class="icon-search icon-white"></i>
Cari
</a> berfungsi untuk mencari</td>
  </tr>
  <tr>
    <td>2. </td>
