...
<style>
    .grid{
        ...
        Fungsi            : Saudara Dhika & Fahmi Minta Diganti Font nya : EHS-1032
        */
        font-family: tahoma;
        font-weight: bold;
        /*font-family: serif;*/
    ...
    <tbody>
        <tr>
            ...
            <td class="tandatangan" align="center">
                <?php echo Yii::app()->user->getState('kabupaten_nama')?>, <?php echo MyFormatter::formatDateTimeId($modTandaBukti->tglbuktibayar);?><br>
