...
<div class='control-group'>
    ...
    <div class='controls'>
        <?php echo $form->dropDownList($modPasienMasukPenunjang,'ruangan_id', CHtml::listData(BKPendaftaranT::model()->getRuanganItems(Params::INSTALASI_ID_RAD), 'ruangan_id', 'ruangan_nama') ,
                              array('empty'=>'-- Pilih --',
