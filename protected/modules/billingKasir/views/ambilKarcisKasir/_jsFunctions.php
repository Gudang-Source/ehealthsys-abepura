...
function printKarcisKasir(antrian_id, caraprint)
{
    window.open("<?php echo $this->createUrl('PrintKarcisKasir') ?>&id="+antrian_id+"&caraprint="+caraprint,"",'location=_new, width=240px, height=480px, left=640px, top=100px');
}
