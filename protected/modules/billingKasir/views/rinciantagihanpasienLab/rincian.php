...
//        echo CHtml::htmlButton(Yii::t('mds','{icon} PDF',array('{icon}'=>'<i class="icon-book icon-white"></i>')),array('class'=>'btn btn-primary', 'type'=>'button','onclick'=>'print(\'PDF\')'))."&nbsp&nbsp"; 
        ...
        if(!empty($modRincianTagihan->tindakansudahbayar_id)){//sudah bayar / lunas
...
//        $urlPrintPdf=  Yii::app()->createAbsoluteUrl('billingKasir/rinciantagihanpasienV/rincianKasirBaruPrint');
        $pendaftaran_id = (isset($modRincianTagihan->pendaftaran_id) ? $modRincianTagihan->pendaftaran_id : null); 
        $pembayaranpelayanan_id = (isset($modRincianTagihan->pembayaranpelayanan_id) ? $modRincianTagihan->pembayaranpelayanan_id : null); 
$js = <<< JSCRIPT
