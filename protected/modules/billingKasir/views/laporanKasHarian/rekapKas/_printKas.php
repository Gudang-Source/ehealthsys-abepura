    ...
    <div>
        <table style="max-width:300px;align:center;font-size:14px;font-family:tahoma;margin-left:250px;">
            ...
            <tr>
                ...
                <td style='border-bottom:1px solid #000000; border-radius:2px;padding:2px;'><div style='border-bottom:0px solid #000000; border-radius:2px;padding:0px;text-align:right;'></div><font style="text-align:right;float:right"><?php echo (isset($piutang) ? number_format($piutang) : 0); ?></font></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td style='border-bottom:1px solid #000000; border-radius:2px;padding:2px;'><div style='border-bottom:0px solid #000000; border-radius:2px;padding:0px;float:right;text-align:right;'><font style="text-align:right;float:right"><?php echo (isset($totalpengeluaran) ? number_format($totalpengeluaran) : 0); ?></font></td>
            </tr>
            <tr>
