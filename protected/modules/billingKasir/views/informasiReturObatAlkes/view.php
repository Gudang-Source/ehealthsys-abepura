    ...
    if (count($modDetail) > 0){
        foreach($modDetail AS $i=>$data){
            ...
            echo "<tr style='border:1px solid;''>
                ...
                <td style='text-align: center;'>".(!empty($data->obatpasien->oasudahbayar_id) ? "Sudah Lunas" : "Belum Lunas")."</td>            
             </tr>";  
        $no++;
        }
...
$urlPrint=  Yii::app()->createAbsoluteUrl('billingKasir/informasiReturObatAlkes/viewRincian&id='.$model->returresep_id);
$js = <<< JSCRIPT
