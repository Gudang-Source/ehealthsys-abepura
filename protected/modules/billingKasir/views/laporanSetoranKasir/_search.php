    ...
    label.checkbox, label.radio{
        ...
        <div class="row-fluid">
         <div class="span4">
             ...
             <?php echo CHtml::label('Periode', 'tgl_setoran', array('class' => 'control-label')) ?>
             <div class="controls">
...
function setPeriode(){
    namaPeriode = $('#PeriodeName').val();
        ...
        $.post('${urlPeriode}',{namaPeriode:namaPeriode},function(data){
            $('#BKLaporansetorankasirbendaharaV_tgl_awal').val(data.periodeawal);
            $('#BKLaporansetorankasirbendaharaV_tgl_akhir').val(data.periodeakhir);
