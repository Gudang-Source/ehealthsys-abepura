...
$(document).ready(function(){
    ...
    ?>
        var params = [];
        params = {instalasi_id:<?php echo Yii::app()->user->getState("instalasi_id"); ?>, modul_id:<?php echo Params::MODUL_ID_KEUANGAN ?>, judulnotifikasi:'Pengeluaran Umum', isinotifikasi:'Telah dilakukan pengeluaran umum dengan <?php echo $modPengUmum->nopengeluaran ?> pada <?php echo $modPengUmum->tglpengeluaran ?>'}; // 16 
