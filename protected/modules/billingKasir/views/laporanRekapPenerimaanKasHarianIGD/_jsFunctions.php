...
<script type="text/javascript">
    ...
    function konfirmasiBatal(){
        myConfirm("Apakah anda ingin membatalkan ini?",
        "Perhatian!",
        function(r){
    ...
    function searchForm(){
        $('#laporanrekapterimasejenisri-grid').addClass('animation-loading');
        $('#laporanrekapterimasejenisrj-grid').addClass('animation-loading');
	return false;
    }
