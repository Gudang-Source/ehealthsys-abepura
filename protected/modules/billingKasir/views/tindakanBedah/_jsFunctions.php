 ...
 */
function updateChecklistPemeriksaanBedahSentral(){
    $('#content-pemeriksaan-lab .checklists').addClass("animation-loading");
    $.ajax({
        type:'POST',
        url:'<?php echo $this->createUrl('SetChecklistPemeriksaanBedahSentral'); ?>',
 ...
 * di copy dari radiologi/pendaftaranRadiologiRujukanRS
 */
function setChecklistPemeriksaanBedahSentral(){
    ...
    if(penjamin_id == "" && kelaspelayanan_id==""){
        ...
        setChecklistPemeriksaanBedahSentralReset();
    }else{
        ...
        updateChecklistPemeriksaanBedahSentral();
    }
}
/**
 ...
 * di copy dari radiologi/pendaftaranRadiologiRujukanRS
 */
function setChecklistPemeriksaanBedahSentralReset(){
...
/**
 * set checked tindakan yang sudah ada di daftar
 * di copy dari radiologi/pendaftaranRadiologiRujukanRS
 */
...
function printStatus()
{
    ...
    if(pendaftaran_id != ""){
        window.open('<?php echo Yii::app()->createUrl('billingKasir/tindakanBedah/printStatusBedah'); ?>&pendaftaran_id='+pendaftaran_id,'printwin','left=100,top=100,width=480,height=640');
    }else{
