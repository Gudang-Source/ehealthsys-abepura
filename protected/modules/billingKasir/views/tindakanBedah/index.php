...
<?php 
    if(isset($_GET['sukses'])){
        Yii::app()->user->setFlash('success', "Data tindakan pasien bedah sentral berhasil disimpan !");
    }
?>
...
<fieldset>
    <div class="row-fluid box">
        ...
        <fieldset id='content-pemeriksaan-lab' class='box2'>
            <legend class="rim">Daftar Tindakan Bedah Sentral</legend>
            <?php 
    ...
    <div class="row-fluid">
        <div class="form-actions">
            <?php 
                ...
                $content = $this->renderPartial('tips/tipsTindakanBedah',array(),true);
