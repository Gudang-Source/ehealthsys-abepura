...
Cari
</button> berfungsi untuk melakukan pencarian</td>
  </tr>
  <tr>
    <td>3. </td>
...
Ulang
  ...
  <tr>
    <td>4. </td>
    <td>Gunakan tombol ini <a class="btn btn-primary" href="/simrs/index.php?r=rawatInap/pasienRawatInap/formTindakLanjutDariPasienRI">
<i class="icon-print icon-white"></i>
Print
</a> untuk melakukan print.</td>
  </tr>
</table>
</p>
