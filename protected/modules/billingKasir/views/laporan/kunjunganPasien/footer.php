...
//        'buttons'=>array(
//            array('label'=>'Print', 'icon'=>'icon-print icon-white', 'url'=>'', 'htmlOptions'=>array('onclick'=>'print(\'PRINT\')', 'style'=>'cursor:pointer;')),
...
//    ));
   ...
   ?>
<?php
    $content = $this->renderPartial('billingKasir.views.laporan.kunjunganPasien.tips',array(),true); 
