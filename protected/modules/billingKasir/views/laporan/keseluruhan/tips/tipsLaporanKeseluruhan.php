...
<table border="0" style="padding :none;">
  <tr>
    <td>1. </td>
    <td>Icon <i class="icon-calendar"></i> untuk menentukan tanggal dan waktu pendaftaran.</td>
  </tr>
   <tr>
    <td>2. </td>
    <td>Gunakan tombol ini <i class="icon-list-alt"></i> untuk melihat rincian tagihan.</td>
  </tr>
  <tr>
    <td>3. </td>
...
Ulang
   ...
   <tr>
    <td>5. </td>
    <td>Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="icon-print icon-white"></i>
Print
</button> berfungsi untuk mencetak data.</td>
  </tr>
   <tr>
    <td>6. </td>
    <td>Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="icon-book icon-white"></i>
PDF
</button> berfungsi untuk mencetak data ke PDF.</td>
  </tr>
   <tr>
    <td>7. </td>
    <td>Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="icon-pdf icon-white"></i>
Excel
</button> berfungsi untuk mencetak data ke Excel.</td>
  </tr>
<!--   <tr>
    <td>8. </td>
    <td>Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="icon-print icon-white"></i>
Grafik
</button> berfungsi untuk mencetak data ke Grafik.</td>
  </tr>-->
<!--  <tr>
    <td>9. </td>
    <td><table border="0">
  <tr>
    <td>Navigasi dibawah berfungsi untuk menampilkan pencarian dalam bentuk diagram batang, pie, atau garis.</td>
  </tr>
  <tr>
