            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        ...
                        <?php echo CHtml::encode(isset($modPendaftaran->dokter->nama_pegawai) ? $modPendaftaran->dokter->nama_pegawai:null); ?>                        
                    </td>
                    <Td></td>
                    <td></td>
                </tr>
...
$urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printRincianTagihan');
