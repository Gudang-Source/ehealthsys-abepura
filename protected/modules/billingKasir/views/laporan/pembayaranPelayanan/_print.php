...
<?php $this->widget($table,array(
	...
	'columns'=>array(
                ...
                array(
                    ...
                    'value'=>'"Rp. ".MyFormatter::formatNumberForPrint($data->totalbiayaoa)',
                ...
                array(
                    ...
                    'type'=>'raw',
                    'htmlOptions'=>array('style'=>'text-align:right;'),
                    'value'=>'"Rp. ".MyFormatter::formatNumberForPrint($data->totalbiayapelayanan)',
                    'footerHtmlOptions'=>array('style'=>'text-align:right;'),
                ...
                array(
                    'name'=>'totaliurbiaya',
                    'type'=>'raw',
                    'value'=>'"Rp. ".MyFormatter::formatNumberForPrint($data->totaliurbiaya)',
                    'htmlOptions'=>array('style'=>'text-align:right;'),
                    'footerHtmlOptions'=>array('style'=>'text-align:right;'),
                ...
                array(
                    ...
                    'type'=>'raw',
                    'value'=>'"Rp. ".MyFormatter::formatNumberForPrint($data->totalpembebasan)',
                    'htmlOptions'=>array('style'=>'text-align:right;'),
                    'footerHtmlOptions'=>array('style'=>'text-align:right;'),
                ...
                array(
                    ...
                    'type'=>'raw',
                    'value'=>'"Rp. ".MyFormatter::formatNumberForPrint($data->totalbayartindakan)',
                    'htmlOptions'=>array('style'=>'text-align:right;'),
                    'footerHtmlOptions'=>array('style'=>'text-align:right;'),
