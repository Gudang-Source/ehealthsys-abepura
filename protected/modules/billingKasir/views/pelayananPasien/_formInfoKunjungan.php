...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    $modDialogKunjungan = new BKInfopasienpengunjungV('searchDialogKunjungan');
    $modDialogKunjungan->unsetAttributes();
    $modDialogKunjungan->instalasi_id = Params::INSTALASI_ID_RJ;
    if(isset($_GET['BKInfopasienpengunjungV'])) {
        $modDialogKunjungan->attributes = $_GET['BKInfopasienpengunjungV'];
        $modDialogKunjungan->no_pendaftaran = (isset($_GET['BKInfopasienpengunjungV']['no_pendaftaran']) ? $_GET['BKInfopasienpengunjungV']['no_pendaftaran'] : "");
        $modDialogKunjungan->no_rekam_medik = (isset($_GET['BKInfopasienpengunjungV']['no_rekam_medik']) ? $_GET['BKInfopasienpengunjungV']['no_rekam_medik'] : "");
        $modDialogKunjungan->nama_pasien = (isset($_GET['BKInfopasienpengunjungV']['nama_pasien']) ? $_GET['BKInfopasienpengunjungV']['nama_pasien'] : "");
        $modDialogKunjungan->carabayar_nama = (isset($_GET['BKInfopasienpengunjungV']['carabayar_nama']) ? $_GET['BKInfopasienpengunjungV']['carabayar_nama'] : "");
        $modDialogKunjungan->ruangan_nama = (isset($_GET['BKInfopasienpengunjungV']['ruangan_nama']) ? $_GET['BKInfopasienpengunjungV']['ruangan_nama'] : "");
    }
