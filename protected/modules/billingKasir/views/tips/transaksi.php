...
<i class="icon-search"></i>
  ...
  <tr>  <td>5. </td>
        <td>Gunakan tombol ini <button id="btnAddKelurahan" class="btn btn-primary" type="button" name="yt3" rel="tooltip" onkeypress="" onclick="" data-original-title="">
<i class="icon-plus-sign icon-white"></i>
</button> berfungsi untuk menambahkan data</td>
 </tr>
     <tr>
	 <td>6. </td>
        <td>Gunakan tombol ini <a class="btn btn-info" href="#" onclick="printKasir($('#FAPendaftaranT_pendaftaran_id').val());return false">
