<div class="white-container">
    ...
    <legend class="rim2">Transaksi Pengajuan <b>Klaim / Piutang</b></legend>
    <fieldset class="box">
        <legend class="rim"> Pencarian </legend>
        <?php 
            $this->renderPartial($this->path_view.'_search',
                    array('modPendaftaran'=>$modPendaftaran,'modPasien'=>$modPasien,'modPengajuanKlaim'=>$modPengajuanKlaim,
            ...
            <tr>
                <td>
                    <div class="control-group ">
                        ...
                        <?php echo CHtml::label('Tanggal Pengajuan','tglpengajuanklaimanklaim', array('class'=>'control-label inline')) ?>
                        <div class="controls">
                            <?php   
                        ...
                        <?php echo CHtml::label('Tanggal Jatuh Tempo','tgljatuhtempo', array('class'=>'control-label inline')) ?>
                        <div class="controls">
                            <?php   
                                    $this->widget('MyDateTimePicker',array(
                                                    'model'=>$modPengajuanKlaim,
                ...
                <td>
                                    <div class="control-group ">
                        <?php echo CHtml::label('No. Pengajuan <font color="red">*</font>','noPembayaran', array('class'=>'control-label inline')) ?> 
                        <div class="controls">
