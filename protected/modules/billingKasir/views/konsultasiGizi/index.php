...
<?php 
    if(isset($_GET['sukses'])){
        Yii::app()->user->setFlash('success', "Data pemeriksaan pasien konsultasi gizi berhasil disimpan !");
    }
?>
...
<fieldset>
    <div class="row-fluid box">
        ...
        <fieldset id='content-pemeriksaan-lab' class='box2'>
            <legend class="rim">Daftar Pemeriksaan Konsultasi Gizi</legend>
            <?php 
        ...
        <div class="span4">
            <fieldset class="box2">
                <legend class="rim">Data Kunjungan Konsultasi Gizi</legend>
            ...
            <div class="block-tabel">
                <h6>Tabel Pemeriksaan <b>Konsultasi Gizi</b></h6>
                <div id="form-tindakanpemeriksaan" style="overflow-x: scroll;">
                    <table class="table table-condensed table-striped">
                        <thead>
                            <th>No.</th>
                            <th>Nama Pemeriksaan Konsultasi</th>
                            <th>Jumlah</th>
                            <th>Satuan</th>
                            <th>Harga</th>
                        </thead>
    ...
    <div class="row-fluid">
        <div class="form-actions">
            <?php 
                ...
                $content = $this->renderPartial('tips/tipsPemeriksaanKonsultasiGizi',array(),true);
...
<?php $this->endWidget(); ?>
<?php $this->renderPartial($this->path_view.'_jsFunctions', array('modKunjungan'=>$modKunjungan,'modPendaftaran'=>$modPendaftaran,'modPasienAdmisi'=>$modPasienAdmisi,'modPasienMasukPenunjang'=>$modPasienMasukPenunjang,'modTindakan'=>$modTindakan, 'modObatAlkesPasien'=>$modObatAlkesPasien)); ?>
