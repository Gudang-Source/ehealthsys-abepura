<div class = "span4">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php
			$date = date('Y-m-d');
			echo CHtml::hiddenField('tglselesaiperiksa',$modKunjungan->tglselesaiperiksa,array('readonly'=>true,'value'=>$date, 'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
        </div>
    </div>
    <div class="control-group">
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    $this->widget('ext.bootstrap.widgets.BootGridView',array(
            ...
            'dataProvider'=>$modDialogKunjungan->searchDialogKunjunganUangMuka(),
