<div class="row-fluid">
    <div class = "span4">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->hiddenField($model,'ruangan_id',array('class'=>'span2 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);","readonly"=>true)); ?>
                <?php echo $form->textField($model,'totbiayasementara',array('class'=>'span2 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo $form->labelEx($model, 'jumlahuangmuka', array('class'=>'control-label','style'=>'font-weight:bold;'))?>
            <div class="controls">
                <?php echo $form->textField($model,'jumlahuangmuka',array('class'=>'span2 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'onblur'=>'hitungJmlpembulatan();hitungJmlpembayaran();')); ?>
            </div>
        </div>
        <div class="control-group">
