...
<div class='control-group'>
    ...
    <div class='controls'>
        <?php echo $form->dropDownList($modPasienMasukPenunjang,'ruangan_id', CHtml::listData(BKPendaftaranT::model()->getRuanganItems(Params::INSTALASI_ID_REHAB), 'ruangan_id', 'ruangan_nama') ,
                              array('empty'=>'-- Pilih --',
...
<?php echo $form->dropDownListRow($modPasienMasukPenunjang,'kelaspelayanan_id', CHtml::listData(BKPendaftaranT::model()->getKelasPelayananItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('onchange'=>'setChecklistPemeriksaanRehab();','empty'=>'-- Pilih --','onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'span3')); ?>
<div class="control-group">
