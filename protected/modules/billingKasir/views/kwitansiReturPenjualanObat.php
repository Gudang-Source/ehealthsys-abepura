...
//                                                    }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;"><?php echo MyFormatter::formatUang($modReturPenjualan->totaloaretur ); ?></td>
                                                        <td style="text-align: right;"><?php echo MyFormatter::formatUang($modReturPenjualan->biayaadministrasi ); ?></td>
                                                        <td style="text-align: right;"><?php echo MyFormatter::formatUang($subTotal); ?></td>
                                                    </tr>
                                            <?php 
                                           ...
                                           // }?>
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><?php echo MyFormatter::formatUang($totalSubTotal); //echo MyFunction::formatNumber($pembayaran->totaliurbiaya); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
