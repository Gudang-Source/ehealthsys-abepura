<div class="white-container">
    <legend class="rim2">Pembayaran Tagihan <b>Pasien Penunjang</b></legend>
    ...
    <div class="block-tabel">
        <h6>Rincian Tagihan <b>Tindakan Penunjang</b> <?php echo CHtml::htmlButton('<i class="icon-refresh icon-white"></i>',array('class'=>'btn btn-danger btn-mini','onclick'=>'setRincianTindakan();','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk me-refresh rincian tagihan tindakan')); ?></h6>
        <div style="overflow-x: auto; max-width: 100%;margin-bottom: 5px;" id="form-rinciantindakan">
            <?php $this->renderPartial('_formRincianTindakanPenunjang', array('dataTindakanPenunjangs'=>$dataTindakanPenunjangs)); ?>
        </div>
        <fieldset class="box">
	...
	<div class="form-actions">
                ...
                <?php
                    if($model->isNewRecord){
                        echo CHtml::link(Yii::t('mds', '{icon} Print Rincian', array('{icon}'=>'<i class="icon-print icon-white"></i>')), 'javascript:void(0);', array('class'=>'btn btn-info','onclick'=>"printRincianPenunjangBelumBayar();return false",'disabled'=>FALSE  ));
                        echo "&nbsp;";
