<table class="table table-striped table-condensed">
    ...
    //                  DISAMAKAN DENGAN subtotal >>  $tindakan->iurbiaya_tindakan = $format->formatNumberForUser($tindakan->iurbiaya_tindakan);
                    ...
                    echo '<tr>'
                            ...
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']qty_tindakan',array('readonly'=>true,'class'=>'inputFormTabel lebar1 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']tarif_satuan',array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']tarifcyto_tindakan',array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']discount_tindakan',array('onblur'=>'hitungTotalTindakan();','class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']pembebasan_tindakan',array('onblur'=>'hitungTotalTindakan();','class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']subsidiasuransi_tindakan',array('onblur'=>'hitungTotalTindakan();','class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']subsisidirumahsakit_tindakan',array('onblur'=>'hitungTotalTindakan();','class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']iurbiaya_tindakan',array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                            .'<td>'.CHtml::activeTextField($tindakan, '['.$i.']['.$ii.']subtotal',array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer', 'onkeyup'=>"return $(this).focusNextInputField(event);")).'</td>'
                        .'</tr>';
                }
            }
        }
