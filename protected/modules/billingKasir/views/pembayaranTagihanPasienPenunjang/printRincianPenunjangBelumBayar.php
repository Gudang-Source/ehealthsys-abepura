...
//        $alamat_pjp         = $dataPendaftar->alamat_pj;
        ...
        $kelastindakan_nama[$key]   = $dataPendaftar->kelaspelayanan_nama;
        $subtotal[$key]     = $tarif_satuan[$key]*$qty_tindakan[$key];
        $daftartindakan_nama[$key]  = $dataPendaftar->daftartindakan_nama;
        $ruangantindakan_nama[$key] = $dataPendaftar->ruangan_nama;
        $tgl_tindakan[$key] = $dataPendaftar->tgl_tindakan;
        $dokter_tindakan[$key]      = $dataPendaftar->gelardepan." ".$dataPendaftar->nama_pegawai.", ".$dataPendaftar->gelarbelakang_nama;
            ...
            <table width="100%" style='margin-left:auto; margin-right:auto;' class='table table-striped table-bordered table-condensed'>
                ...
                ?>
                 <tfoot>
                    ...
                    <tr>
                        <td colspan="5"><div class='pull-right'>Uang Muka</div></td>
                        <td style="text-align:right;"><?php echo number_format($data['uang_muka'],0,',','.');?></td>
                    </tr>
                    <tr>
                        <td colspan="5"><div class='pull-right'>Tanggungan Pasien</div></td>
                        <td style="text-align:right;">
                        <?php 
                            $tanggungan = $total - $data['uang_muka'];
                            if($total < $data['uang_muka']){
                                $tanggungan = 0;
                            }
                            echo number_format($tanggungan,0,',','.');
                        ?></td>
                    </tr>
                </tfoot>
