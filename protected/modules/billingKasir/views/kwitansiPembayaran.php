        ...
        <td colspan="3" height="100px">
            <?php // echo $this->renderPartial('application.views.headerReport.headerDefault'); ?>
                    ...
                    <tr>
                        <td>Nama Pasien</td>
                        <td>:</td>
                        <?php if(isset($model->bayaruangmuka_id)){ ?>
                        <td><?php echo isset($model->bayaruangmuka->pendaftaran->pasien->nama_pasien)?$model->bayaruangmuka->pendaftaran->pasien->nama_pasien:" - "; ?>  No. RM : <?php echo isset($model->bayaruangmuka->pendaftaran->pasien->no_rekam_medik)?$model->bayaruangmuka->pendaftaran->pasien->no_rekam_medik:' - '; ?></td>
                        <?php }else{ ?>
                        <td><?php echo isset($model->pembayaran->pendaftaran->pasien->nama_pasien)?$model->pembayaran->pendaftaran->pasien->nama_pasien:" - "; ?>  No. RM : <?php echo isset($model->pembayaran->pendaftaran->pasien->no_rekam_medik)?$model->pembayaran->pendaftaran->pasien->no_rekam_medik:" - "; ?></td>
                        <?php } ?>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center" class="tandatangan">
                                ...
                                <div><?php echo Yii::app()->user->getState('kabupaten_nama'); ?>, 
                                    <?php 
                                            $format = new MyFormatter();
