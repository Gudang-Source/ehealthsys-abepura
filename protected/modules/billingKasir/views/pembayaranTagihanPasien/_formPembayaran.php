<div class="row-fluid">
    <div class = "span4">
		...
		<?php echo $form->textFieldRow($model,'totalbiayapelayanan',array('readonly'=>true,'class'=>'span2 integer2', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
	...
	<div class = "span4">
        ...
        <?php echo $form->textFieldRow($modPemakaianuangmuka,'totaluangmuka',array('readonly'=>true,'class'=>'span2 integer2', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
		<div class="control-group">
            <?php echo $form->labelEx($modPemakaianuangmuka, 'pemakaianuangmuka', array('class'=>'control-label required','style'=>'font-weight:bold;'))?>
            <div class="controls">
                <?php echo $form->textField($modPemakaianuangmuka,'pemakaianuangmuka',array('onblur'=>'hitungUangKembalian();','class'=>'span2 integer2', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>	
        <?php echo $form->textFieldRow($modPemakaianuangmuka,'sisauangmuka',array('readonly'=>true,'class'=>'span2 integer2', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
	</div> 
	<div class = "span4">        
		<div class="control-group">
        ...
        <?php echo $form->textFieldRow($model,'totalsisatagihan',array('readonly'=>true,'class'=>'span2 integer2', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
