...
class RuanganpegawaiMController extends MyAuthController
{
	...
	public function actionIndex()
	{
		$this->render('index');
                ...
                {
                    $model = new RMRuanganpegawaiM('search');
                    $model->unsetAttributes();
                    if (isset($_GET['RMRuanganpegawaiM'])){
                        $model->attributes = $_GET['RMRuanganpegawaiM'];
                        }
	...
	public function loadModel($id, $pegawai = null)
	{
		...
		return $model;
                ...
                {
                    $model= new RMRuanganpegawaiM;
                    $model->attributes=$_REQUEST['RMRuanganpegawaiM'];
