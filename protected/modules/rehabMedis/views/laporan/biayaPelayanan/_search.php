                                ...
                                'isi'=>  '<table>
                                            <tr>
                                                <td>'.CHtml::radioButton('tampilGrafik', true, array('name'=>'dataGrafik', 'value' => 'carabayar')).' <label>Cara Bayar</label></td>                                               
                                                 <td>'.CHtml::radioButton('tampilGrafik', false, array('name'=>'dataGrafik', 'value' => 'kelaspelayanan')).' <label>Kelas Pelayanan</label></td>                                               
                                            </tr>                                            
                                        </table>',          
                                'active'=>TRUE,
                                    ),
...
function checkSemua() {
            if ($("#checkSemuaid").is(":checked")) {
                $('.penjamin input[name*="RMLaporanbiayapelayanan"]').each(function(){
