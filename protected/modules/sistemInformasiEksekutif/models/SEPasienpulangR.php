 ...
 */
class SEPasienpulangR extends PasienpulangR {

    public $jns_periode;
    public $periode, $id, $jenis, $jumlah_pulang, $jumlah_rujuk, $jumlah_paksa, $jumlah_meninggal, $jumlah_ri, $jumlah_lain_lain, $jumlah_lari;
