...
//                chart_bar.rotate = true;
    ...
    function setDataSet(diagnosa_id) {
        chart_bar.dataProvider = chartDataBar[diagnosa_id];
        chart_bar.validateData();
    }
</script>
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Kegiatan Operasi - Periode <?php echo $awal; ?> sd <?php echo $akhir; ?></div>
    ...
    <div class="panel-body">
        <div class="form-group" style="float: left;
             text-align: left;
             font-weight: normal;">
            <label for="pelayanan">Kegiatan Operasi:</label>
            <select class="form-control" id="pelayanan" onchange="setDataSet(this.options[this.selectedIndex].value);" style="display: inline-block;
                    width: auto;">
                    <?php
                    foreach ($dataKegOperasi as $data) {
                        $id = $data['id'];
                        $nama = $data['nama'];
                        ?>
