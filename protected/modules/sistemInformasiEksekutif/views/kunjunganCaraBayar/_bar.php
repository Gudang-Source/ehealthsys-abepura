...
//                chart_bar.rotate = true;
    ...
    function setDataSet(carabayar_id) {
        chart_bar.dataProvider = chartDataBar[carabayar_id];
        chart_bar.validateData();
    }
</script>
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Grafik Angka Kunjungan Berdasarkan Cara Bayar - Periode <?php echo $awal; ?> sd <?php echo $akhir; ?></div>
    ...
    <div class="panel-body">
        <div class="form-group" style="float: left;
            ...
            <select class="form-control" id="carabayar" onchange="setDataSet(this.options[this.selectedIndex].value);" style="display: inline-block;
                    width: auto;">
                    <?php
                    foreach ($dataCaraBayar as $data) {
                        $id = $data['id'];
                        $nama = $data['nama'];
                        ?>
