...
//                chart_bar.rotate = true;
    ...
    function setDataSet(obatalkes_id) {
        chart_bar.dataProvider = chartDataBar[obatalkes_id];
        chart_bar.validateData();
    }
</script>
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Grafik Pemakaian Obat dan Alkes</div>
    ...
    <div class="panel-body">
        <div class="form-group" style="float: left;
             text-align: left;
             font-weight: normal;">
            <label for="pelayanan">Obat / Alkes:</label>
