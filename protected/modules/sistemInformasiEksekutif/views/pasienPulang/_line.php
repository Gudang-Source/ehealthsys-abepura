...
<script>
    ...
    var chartDataLine = <?php echo json_encode($dataBarLineChart) ?>;
    ...
    AmCharts.ready(function () {
        ...
        // GRAPHS
        // first graph
        chart_line.graphs = <?php echo json_encode($graphs) ?>;
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Grafik Cara Pasien Pulang</div>
