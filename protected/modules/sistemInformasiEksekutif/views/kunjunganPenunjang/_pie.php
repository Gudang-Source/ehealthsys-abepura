...
<script>
	...
	AmCharts.ready(function () {
		...
		chart_pie.angle = 10;
		chart_pie.colors = ["#eb0000","#00ebeb"];
		chart_pie.titles = [
            {
                "text": <?php echo $model->thn_awal;  ?>,
                "size": 15
            }
        ];
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">Grafik Persentase Kunjungan ke Penunjang Dari<b>
		<?php
	...
	<table align="center" cellspacing="20">
		<tr>
			<td>
				<input type="radio" name="group" id="rb1" onclick="setLabelPosition()">labels outside
				<input type="radio" checked="true" name="group" id="rb2" onclick="setLabelPosition()">labels inside</td>
			<td>
				<input type="radio" checked="true" name="group2" id="rb3" onclick="set3D()">3D
				<input type="radio" name="group2" id="rb4" onclick="set3D()">2D</td>
