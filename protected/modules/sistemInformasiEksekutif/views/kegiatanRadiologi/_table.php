...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Tabel Kegiatan Radiologi - Periode <?php echo $awal ?> s.d. <?php echo $akhir ?></div>
                    ...
                    foreach ($row as $key => $value) {
                        ...
                        <tr>
                            <td>
                                <?php
								if(!empty($key)){
									$modJenis = JenispemeriksaanradM::model()->findByAttributes(array('jenispemeriksaanrad_nama'=>$key));
									echo CHtml::Link($key,'#', array('onClick' => "setDataSet($modJenis->jenispemeriksaanrad_id)"));
								}
								else{
									echo $key;
								}
