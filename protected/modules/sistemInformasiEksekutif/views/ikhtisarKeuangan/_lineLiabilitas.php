...
<script>
    ...
    var chartDataLiabilitas = <?= json_encode($dataChartLiabilitas) ?>;
    ...
    AmCharts.ready(function () {
        ...
        // SERIAL CHART
        chart_line_liab = new AmCharts.AmSerialChart();

        chart_line_liab.dataProvider = chartDataAset;
        chart_line_liab.categoryField = "periode";
        ...
        // AXES
        // category
        var categoryAxis = chart_line_liab.categoryAxis;
        ...
        chart_line_liab.addValueAxis(valueAxis1);
        ...
        chart_line_liab.addGraph(graph1);

        // CURSOR
        var chartCursor = new AmCharts.ChartCursor();
        chartCursor.cursorAlpha = 0.1;
        chartCursor.fullWidth = true;
        chart_line_liab.addChartCursor(chartCursor);

        // SCROLLBAR
        var chartScrollbar = new AmCharts.ChartScrollbar();
        chart_line_liab.addChartScrollbar(chartScrollbar);

        // WRITE
        chart_line_liab.write("liabilitas");
    });


    // this method is called when chart is first inited as we listen for "dataUpdated" event
    function zoomChartLiabilitas() {
        // different zoom methods can be used - zoomToIndexes, zoomToDates, zoomToCategoryValues
        chart_line_liab.zoomToIndexes(0, 30);
    }
</script>
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Grafik Liabilitas (dalam Juta Rupiah)</div>
    ...
    <div class="panel-body">
        <div id="liabilitas" style="width: 100%; height: 400px;"></div>
    </div>
</div>
