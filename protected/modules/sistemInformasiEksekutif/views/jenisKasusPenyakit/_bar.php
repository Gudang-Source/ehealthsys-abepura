...
//                chart_bar.rotate = true;
        ...
        graph.lineAlpha = 0;
        graph.fillAlphas = 1;
		//graph.fillColors = ["#eb0000","#00ebeb","#003beb","#ebb000","#00eb3b"];
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Grafik Jenis Kasus Penyakit Pasien - Periode <?php echo $awal; ?> s.d. <?php echo $akhir; ?></div>
