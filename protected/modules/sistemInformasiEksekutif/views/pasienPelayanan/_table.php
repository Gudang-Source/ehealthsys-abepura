...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Tabel Pelayanan Pasien - <?php echo $awal ?> sd <?php echo $akhir ?></div>
                ...
                <tbody>
                    ...
                    foreach ($row as $key => $value) {
                        ...
                        <tr>
                            <td>
                                <?php
									$modJenis = KelompoktindakanM::model()->findByAttributes(array('kelompoktindakan_nama'=>$key));
									echo CHtml::Link($key,'#', array('onClick' => "setDataSet($modJenis->kelompoktindakan_id)"));
