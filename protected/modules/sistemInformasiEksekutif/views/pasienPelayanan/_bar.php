...
//                chart_bar.rotate = true;
        ...
        graph.lineAlpha = 0;
        graph.fillAlphas = 1;
		//graph.fillColors = getRandomColor();
    ...
    function setDataSet(tindakan_id) {
        chart_bar.dataProvider = chartDataBar[tindakan_id];
		chart_bar.graphs.fillColors = getRandomColor();
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">Grafik Jenis Pelayanan Pasien - Periode <?php echo $awal; ?> sd <?php echo $akhir; ?></div>
