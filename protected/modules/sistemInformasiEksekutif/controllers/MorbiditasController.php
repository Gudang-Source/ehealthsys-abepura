...
class MorbiditasController extends MyAuthController {

    public $path_view = 'sistemInformasiEksekutif.views.morbiditas.';
    ...
    public function actionSetIFrameDashboard() {
        ...
        if (isset($_GET['SEMorbiditasR'])) {
            $model->attributes = $_GET['SEMorbiditasR'];
            $model->jns_periode = $_GET['SEMorbiditasR']['jns_periode'];
            $model->tgl_awal = $format->formatDateTimeForDb($_GET['SEMorbiditasR']['tgl_awal']);
            $model->tgl_akhir = $format->formatDateTimeForDb($_GET['SEMorbiditasR']['tgl_akhir']);
            $model->bln_awal = $format->formatMonthForDb($_GET['SEMorbiditasR']['bln_awal']);
            $model->bln_akhir = $format->formatMonthForDb($_GET['SEMorbiditasR']['bln_akhir']);
            $bln_akhir = $model->bln_akhir . "-" . date("t", strtotime($model->bln_akhir));
            $model->thn_awal = $_GET['SEMorbiditasR']['thn_awal'];
            $model->thn_akhir = $_GET['SEMorbiditasR']['thn_akhir'];
