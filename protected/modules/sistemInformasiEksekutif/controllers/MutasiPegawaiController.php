...
class MutasiPegawaiController extends MyAuthController {
	...
	public function actionSetIFrameDashboard() {
		...
		$format = new MyFormatter();
		$model = new SEInformasipegawaimutasiR();
		...
		if (isset($_GET['SEInformasipegawaimutasiR'])) {
			$model->attributes = $_GET['SEInformasipegawaimutasiR'];
			$model->jns_periode = $_GET['SEInformasipegawaimutasiR']['jns_periode'];
			$model->tgl_awal = $format->formatDateTimeForDb($_GET['SEInformasipegawaimutasiR']['tgl_awal']);
			$model->tgl_akhir = $format->formatDateTimeForDb($_GET['SEInformasipegawaimutasiR']['tgl_akhir']);
			$model->bln_awal = $format->formatMonthForDb($_GET['SEInformasipegawaimutasiR']['bln_awal']);
			$model->bln_akhir = $format->formatMonthForDb($_GET['SEInformasipegawaimutasiR']['bln_akhir']);
			$bln_akhir = $model->bln_akhir . "-" . date("t", strtotime($model->bln_akhir));
			$model->thn_awal = $_GET['SEInformasipegawaimutasiR']['thn_awal'];
			$model->thn_akhir = $_GET['SEInformasipegawaimutasiR']['thn_akhir'];
