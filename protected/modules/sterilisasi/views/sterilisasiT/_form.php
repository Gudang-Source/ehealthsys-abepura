...
//                                'maxDate' => 'd',
		...
		<div class="control-group ">
			...
			<div class="controls">
				...
				$this->widget('MyJuiAutoComplete', array(
					...
					'htmlOptions' => array(
						'placeholder'=>'Ketikan Pegawai Sterilisasi',
						'class'=>'pegsterilisasi_nama',
	...
	<div class="span4">
		<?php echo $form->textAreaRow($modSterilisasi,'sterilisasi_ket',array('rows'=>3, 'cols'=>50, 'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);",'placeholder'=>'Keterangan Sterilisasi')); ?>
	</div>	
</div>
