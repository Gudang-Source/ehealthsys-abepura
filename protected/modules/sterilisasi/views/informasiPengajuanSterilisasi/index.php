		...
		<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
			...
			'columns'=>array(
				...
				array(
					...
					'type'=>'raw',
					'value'=>'CHtml::link("<i class=\'icon-form-input\'></i> ",  Yii::app()->controller->createUrl("/sterilisasi/penerimaanPeralatanSterilT/index",array("pengajuansterlilisasi_id"=>$data->pengajuansterlilisasi_id)),array("rel"=>"tooltip","title"=>"Klik untuk Detail Pengajuan Sterilisasi"));', 'htmlOptions'=>array('style'=>'text-align: center; width:40px')
				),
			),
