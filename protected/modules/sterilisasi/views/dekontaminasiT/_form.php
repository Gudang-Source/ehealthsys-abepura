...
//                                'maxDate' => 'd',
		...
		<?php
			echo $form->textFieldRow($modDekontaminasi,'dekontaminasi_no',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>20,'readonly'=>true)); 
        ?>
	</div>
	<div class="span4">
		<div class="control-group ">
			<?php echo $form->labelEx($modDekontaminasi, 'pegpetugas_id', array('class' => 'control-label')); ?>
			<div class="controls">
				...
				$this->widget('MyJuiAutoComplete', array(
					...
					'htmlOptions' => array(
						'placeholder'=>'Ketikan Pegawai Dekontaminasi',
						'class'=>'pegpetugas_nama',
	...
	<div class="span4">
		<?php echo $form->textAreaRow($modDekontaminasi,'dekontaminasi_ket',array('rows'=>3, 'cols'=>50, 'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);",'placeholder'=>'Keterangan Dekontaminasi')); ?>
	</div>	
</div>
