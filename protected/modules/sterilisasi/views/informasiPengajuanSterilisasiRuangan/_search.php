...
<div class="row-fluid">
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::label('Tanggal Pengajuan','pengajuansterlilisasi_tgl', array('class'=>'control-label')) ?>
			<div class="controls">
				<?php   
	...
	<div class="span4">
		<div class="control-group ">
			...
			<div class="controls">
			   <?php echo $form->textField($model,'pengajuansterlilisasi_no',array('placeholder'=>'Ketik No. Pengajuan', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
		<div class="control-group">
