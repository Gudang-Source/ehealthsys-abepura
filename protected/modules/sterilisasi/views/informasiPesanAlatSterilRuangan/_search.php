...
$form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'method'=>'get',
	'id'=>'pemesananperalatansteril-info-search',
	'type'=>'horizontal',
	'focus'=>'#'.CHtml::activeId($model,'pesanperlinensteril_no'),
...
<div class="row-fluid">
	...
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::activeLabel($model,'pesanperlinensteril_no',array('class'=>'control-label')); ?>
			<div class="controls">
			   <?php echo $form->textField($model,'pesanperlinensteril_no',array('placeholder'=>'Ketik No. Sterilisasi', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
		<div class="control-group">
