<div class="col-sm-3 col-xs-6">
	<div class="tile-stats tile-red">
		...
		<h3>Jumlah Simpanan Anggota</h3> <p>Periode bulan <?php echo $periode; ?>.</p>
	</div>
</div>
...
<div class="col-sm-3 col-xs-6">
	<div class="tile-stats tile-green">
		...
		<h3>Jumlah Pinjaman Anggota</h3> <p>Periode bulan <?php echo $periode; ?>.</p>
	</div>
</div>
...
<div class="col-sm-3 col-xs-6">
	<div class="tile-stats tile-aqua">
		...
		<h3>Jumlah Anggota</h3> <p>Permohonan Pinjaman Hari ini.</p>
	</div>
</div>
...
<div class="col-sm-3 col-xs-6">
	<div class="tile-stats tile-blue">
		...
		<h3>Jumlah Bayar Angsuran</h3> <p>Periode bulan <?php echo $periode; ?>.</p>
	</div>
</div>