<div class="panel panel-primary col-sm-12">
		...
		<div class="form-group">
			...
			<?php 
				$this->widget('bootstrap.widgets.TbDatePicker', array(
					'model'=>$kaskeluar, 'attribute'=>'revieweddate', 'htmlOptions'=>array('class'=>'form-control'), 'options'=>array('format'=>'dd/mm/yyyy'),
				));
			?>
	...
	<div class="panel-body col-sm-6">
		...
		<div class="form-group">
			...
			<?php 
				$this->widget('bootstrap.widgets.TbDatePicker', array(
					'model'=>$kaskeluar, 'attribute'=>'approveddate', 'htmlOptions'=>array('class'=>'form-control'), 'options'=>array('format'=>'dd/mm/yyyy'),
				));
			?>
