		...
		<div class="panel-body">
			<div class="form-group">
				<div class="col-sm-12" style="text-align: center;">
					...
					<?php echo CHtml::link('Print BKM', $this->createUrl('/printKwitansi/kasmasuk', array('id'=>$kasmasuk->buktikasmasuk_id,'type'=>'deposito')), array('disabled'=>$kasmasuk->isNewRecord,'class'=>'print btn btn-green', 'target'=>'_blank','rel'=>'tooltip','title'=>'Klik Untuk Mencetak Kwitansi BKM'));?>
