	...
	<div class="span4">
		<div class="control-group">
			<?php echo $form->label($kaskeluar, 'preparedby', array('class'=>'control-label')); ?>
			<div class="controls">
				<?php
				...
				$this->widget('MyJuiAutoComplete',array(
                    ...
                    'options'=>array( 
                       ...
                       'focus'=> 'js:function( event, ui ) {
                            $("#BuktikaskeluarkopT_preparedby").val( ui.item.nama );
                            return false;
                        }', 
                       'select'=>'js:function( event, ui ) {
                            loadPengurus(ui.item.id, ui.item.nama, "#BuktikaskeluarkopT_preparedby", "#preparedby");
                        }',
		...
		<div class="control-group">
			<?php echo $form->labelEx($kaskeluar, 'prepareddate', array('class'=>'control-label')); ?>
			<div class="controls">
			...
			<!--<div class='input-group-addon' onclick="$('#BuktikaskeluarkopT_prepareddate').focus();">
        					<a>
	...
	<div class="span4">
			...
			<div class="controls">
				...
				$this->widget('MyJuiAutoComplete',array(
                    ...
                    'options'=>array( 
                       ...
                       'minLength' => 2,
                       'focus'=> 'js:function( event, ui ) {
                            $("#BuktikaskeluarkopT_reviewedby").val( ui.item.nama );
                            return false;
                        }', 
                       'select'=>'js:function( event, ui ) {
                            loadPengurus(ui.item.id, ui.item.nama, "#BuktikaskeluarkopT_reviewedby", "#reviewedby");
                        }',
		...
		<div class="control-group">
			...
			<!--<div class='input-group-addon' onclick="$('#BuktikaskeluarkopT_revieweddate').focus();">
        					<a>
            			<i class='entypo-calendar'></i>
        					</a>
    					</div>
	...
	<div class="span4">
			...
			<div class="controls">
				...
				$this->widget('MyJuiAutoComplete',array(
                    ...
                    'options'=>array( 
                       ...
                       'minLength' => 2,
                       'focus'=> 'js:function( event, ui ) {
                            $("#BuktikaskeluarkopT_approvedby").val( ui.item.nama );
                            return false;
                        }', 
                       'select'=>'js:function( event, ui ) {
                            loadPengurus(ui.item.id, ui.item.nama, "#BuktikaskeluarkopT_approvedby", "#approvedby");
                        }',
		...
		<div class="control-group">
			...
			<!--<div class='input-group-addon' onclick="$('#BuktikaskeluarkopT_approveddate').focus();">
        					<a>
            			<i class='entypo-calendar'></i>
        					</a>
    					</div>
