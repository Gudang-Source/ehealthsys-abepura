...
.input-group-addon{
    ...
    <legend class="rim2">Informasi <b>Pinjaman Anggota</b></legend>
<div class="col-md-12">
    <div class="block-tabel">
        <h6>Informasi <b>Pinjaman Anggota</b></h6>
...
<?php echo $this->renderPartial('subview/_dialogInformasi', array(), true); ?>
</div>