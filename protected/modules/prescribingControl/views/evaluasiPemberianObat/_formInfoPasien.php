...
//                 echo CHtml::hiddenField('instalasi_id',$modInfoRI->ruangan->instalasi_id,array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);")); 
    ...
    <div class="control-group">
        <?php echo CHtml::label('No. Pemberian Obat<font style=color:red;> * </font>', 'no_pemberianobat', array('class'=>'control-label')); ?>
        <div class="controls">
            <?php echo CHtml::textField('no_pemberianobat',$modInfoRI->no_pemberianobat,array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
		</div>
    </div>
	<div class="control-group">
...
<div class = "span4">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo CHtml::textArea('alamat_pasien',$modInfoRI->alamat_pasien,array('readonly'=>true,'class'=>'span4', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
        </div>
    </div>
</div>
