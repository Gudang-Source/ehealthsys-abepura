...
if (isset($_GET['frame'])){
    ...
    echo CHtml::link(Yii::t('mds','{icon} Close', array('{icon}'=>'<i class="icon-ban-circle icon-white"></i>')), 'javascript:void(0);', array('class'=>'btn btn-danger', 'onclick'=>'$("#dialogDetailStok").attr("src",$(this).attr("href")); window.parent.$("#dialogDetailStok").dialog("close"); return false;'));
?>
