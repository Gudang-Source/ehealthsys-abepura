...
<?php if(isset($modHasilPeriksa) && $modHasilPeriksa->printhasillab == '1') {echo '<div class="watermark">';}  ?>
<?php /*
...
<table style="font-family: arial;font-size: 9pt;" class="grid">
    ...
    <tr>
        <td>Umur </td>
        <td>: <?php echo $modPasien->umur."; ".$modPasien->jeniskelamin; ?></td>
        <td>Alamat</td>
 ...
 */
?> 
<?php if(isset($modHasilPeriksa) && $modHasilPeriksa->printhasillab == '1') {echo '</div>';}  ?>
