...
<table >
    ...
    <tr>
        ...
        <td>Tgl. Diagnosa</td>
        <td>:</td>
        <td><?php echo (isset($detailHasil[0]->tglmorbiditas) ? MyFormatter::formatDateTimeForUser($detailHasil[0]->tglmorbiditas) : "-"); ?> </td>
    </tr>
...
<table class="table table-bordered table-condensed">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo ($i+1); ?></td>
            <td><?php echo isset($hasil->tglmorbiditas) ? MyFormatter::formatDateTimeForUser($hasil->tglmorbiditas) : ""; ?></td>
