...
function printGrafik(caraPrint,type)
{
    ...
    window.open('<?php echo $this->createUrl('GrafikTelingaKanan'); ?>&hearingtest_id='+hearingtest_id+'&pendaftaran_id='+pendaftaran_id+'&caraPrint='+caraPrint+'&type='+type,'printwin','left=100,top=100,width=1000,height=640');
}
</script>