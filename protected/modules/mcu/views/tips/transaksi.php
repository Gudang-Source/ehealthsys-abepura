...
<i class="icon-search"></i>
        ...
        <tr><td>5. </td>
        <td>Gunakan tombol ini <button class="btn btn-primary" type="button" name="yt0" rel="tooltip" onkeypress="inputBarang();return $(this).focusNextInputField(event)" onclick="inputBarang();return false;" data-original-title="Klik untuk menambahkan Barang">
<i class="icon-plus icon-white"></i>
</button>
 berfungsi untuk memasukan data barang.</td>
  </tr>
	   <tr><td>6. </td>
