...
<?php echo $form->dropDownListRow($modAsuransiPasien,'kelastanggunganasuransi_id', CHtml::listData(MCPendaftaranT::model()->getKelasTanggunganItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('disabled'=>true,'empty'=>'-- Pilih --','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
    ...
    <?php echo $form->dropDownList($modRujukanBpjs,'asalrujukan_id', CHtml::listData($modRujukanBpjs->getAsalRujukanItems(), 'asalrujukan_id', 'asalrujukan_nama'), 
                                      array('class'=>'span3','empty'=>'-- Pilih --', 'onkeyup'=>"return $(this).focusNextInputField(event)",
                                            'ajax'=>array('type'=>'POST',
                                                          'url'=>$this->createUrl('GetRujukanDari',array('encode'=>false,'namaModel'=>'MCRujukanbpjsT')),
...
<div class="control-group ">
    <label class="control-label required" for="MCRujukanbpjsT_tanggal_rujukan">
    Tanggal Rujukan
...
<div class="control-group ">
                <label for="MCRujukanbpjsT_kddiagnosa_rujukan" class="control-label">Kode Diagnosa Rujukan <font color="red">*</font><i class="icon-search" onclick="$('#dialogDiagnosa').dialog('open')", style="cursor:pointer;" rel='tooltip' title='klik untuk mencari diagnosa rujukan'></i> </label> 
                <div class="controls">
                    <?php
...
<div class="control-group ">
                <label for="MCRujukanbpjsT_diagnosa_rujukan" class="control-label">Diagnosa Rujukan <font color="red">*</font></label> 
                <div class="controls">
                    <?php
                        $this->widget('application.extensions.FCBKcomplete.FCBKcomplete',array(
                            'model'=>$modRujukanBpjs,
