...
=======
    ...
    <?php echo $form->textFieldRow($modAsuransiPasienBadak,'namaperusahaan',array('placeholder'=>'Nama Perusahaan Asuransi','class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50, 'value'=>'PT. Badak LNG', 'readonly'=>true)); ?>
    <div class="control-group">
            <?php echo CHtml::label("No. Badge / No. Prokespen <span class='required'>*</span>", 'nopeserta', array('class'=>'control-label required'))?>
            <div class="controls">
                <?php 
                    $this->widget('MyJuiAutoComplete', array(
                                    'model'=>$modAsuransiPasienBadak,
                                    ...
                                    'htmlOptions'=>array('placeholder'=>'Ketik No. Peserta','rel'=>'tooltip','title'=>'Ketik No. Badge',
                                        'onkeyup'=>"setNoKartuAsuransi(); return $(this).focusNextInputField(event)",
    //                                    'onblur'=>"if($(this).val()=='') setAsuransiBaru(); else setAsuransiLama('',this.value)",
                                        'class'=>''),
                                )); 
...
>>>>>>> 12f1e5a9c072640a387b6430d541776accbca7b2
    ...
    <div class="control-group">
            ...
            <div class="controls">
                    <?php echo $form->dropDownList($modAsuransiPasienBadak,'kelastanggunganasuransi_id', CHtml::listData(MCPendaftaranT::model()->getKelasTanggunganItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('disabled'=>true,'empty'=>'-- Pilih --','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
            </div>
    </div>
    <!--di comment LNG-360-->
    <!--<div class="control-group">
            ...
            <div class="controls">
                    <?php // echo $form->textField($modAsuransiPasienBadak,'namaperusahaan',array('placeholder'=>'Nama Lengkap Pemilik Asuransi','class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
            </div>
    </div>-->
