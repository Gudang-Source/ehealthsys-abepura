...
<div class="control-group">
        ...
        <div class="controls">
                <?php echo $form->dropDownList($modAsuransiPasienDepartemen,'kelastanggunganasuransi_id', CHtml::listData(MCPendaftaranT::model()->getKelasTanggunganItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('disabled'=>true,'empty'=>'-- Pilih --','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
        </div>
</div>
<!--di comment LNG-360-->
<!--<div class="control-group">
        ...
        <div class="controls">
                <?php // echo $form->textField($modAsuransiPasienDepartemen,'namaperusahaan',array('placeholder'=>'Nama Lengkap Pemilik Asuransi','class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
        </div>
</div>-->
