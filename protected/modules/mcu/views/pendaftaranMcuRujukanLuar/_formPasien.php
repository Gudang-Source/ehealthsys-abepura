			...
			'content'=>array(
				'content-pegawai'=>array(
					'header'=>CHtml::htmlButton("<i class='icon-minus icon-white'></i>",array('class'=>'btn btn-primary btn-mini','onclick'=>'','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk tampilkan data pegawai')).'<b> Pegawai Penanggung Jawab</b>'.'&nbsp'
							.CHtml::htmlButton('<i class="icon-refresh icon-white"></i>',array('class'=>'btn btn-danger btn-mini pull-center','onclick'=>'resetFormPegawai(); setAsuransiBadakReset();','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk membersihkan field pegawai penanggung jawab')).'</span>',
    ...
    $this->widget('ext.bootstrap.widgets.BootGridView',array(
            ...
            'afterAjaxUpdate'=>'function(id, data){
                 ...
                 jQuery(\'#tanggal_lahir\').datepicker(jQuery.extend({
                       ...
                       {\'dateFormat\':\'dd M yy\',\'\':\'d\',\'timeText\':\'Waktu\',\'hourText\':\'Jam\',\'minuteText\':\'Menit\',
...
<script>
    function showDateTime(){
        $( "#MCPasienM_tanggal_lahir").datepicker();
    }
</script>
