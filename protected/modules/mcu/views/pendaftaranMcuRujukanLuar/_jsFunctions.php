...
function sembunyiFormRujukan(){
        ...
        $('#form-rujukan-keluar > .accordion-group > .accordion-heading').find(".icon-ok").addClass("icon-minus").removeClass("icon-ok");
...
function tampilFormRujukan(){
        ...
        $('#form-rujukan-keluar > .accordion-group > .accordion-heading').find(".icon-minus").addClass("icon-ok").removeClass("icon-minus");
...
{
    window.open('<?php echo $this->createUrl('printSuratMcu',array('pendaftaran_id'=>$model->pendaftaran_id,'pasiendirujukeluar_id'=>$modRujukanKeluar->pasiendirujukkeluar_id)); ?>','printwin','left=100,top=100,width=860,height=480');
}
/**
 * print karcis
 */
