...
<script type="text/javascript">
    function loadDataPendaftaran()
    {
        ...
        $.post("<?php echo ($menu == 'MCU' ? $this->createUrl('getDataPendaftaranMCU') : Yii::app()->createUrl('pendaftaranPenjadwalan/infoKunjunganRJ/getDataPendaftaranRJ')); ?>", { pendaftaran_id: pendaftaran_id },
            function(data){
