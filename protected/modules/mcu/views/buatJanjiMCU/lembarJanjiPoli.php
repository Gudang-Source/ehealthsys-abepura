<table>
    ...
    <tr>
        ...
        <td>:</td>
        <td><?php echo MyFormatter::formatDateTimeId($modPasien->tanggal_lahir).' / '.(isset($modPendaftaran->umur)?$modPendaftaran->umur:' - '); ?></td>
    </tr>
    <tr>
        <td>Ruangan</td>
        <td>:</td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>:</td>
        <td><?php echo MyFormatter::formatDateTimeId($modJanjiPoli->tglbuatjanji) ?></td>
    </tr>
     <tr>
        <td>Tanggal Janji Ketemu/Hari</td>
        <td>:</td>
        <td><?php echo MyFormatter::formatDateTimeId($modJanjiPoli->tgljadwal) ?> / <?php echo $modJanjiPoli->harijadwal ?></td>
    </tr>
</table>