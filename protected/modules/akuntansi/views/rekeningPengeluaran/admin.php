...
//                    'type'=>'raw',
//                    'value'=>'$data->rekeningdebit->nmrekening5."".CHtml::Link("<i class=\"icon-pencil\"></i>",Yii::app()->controller->createUrl("jurnalRekPengeluaran/ubahRekeningDebitKredit",array("id"=>$data->jenispengeluaran_id)),
//                            array("class"=>"", 
...
//                    'value'=>'$data->rekeningkredit->nmrekening5."".CHtml::Link("<i class=\"icon-pencil\"></i>",Yii::app()->controller->createUrl("jurnalRekPengeluaran/ubahRekeningDebitKredit",array("id"=>$data->jenispengeluaran_id)),
//                            array("class"=>"", 
//                                  "target"=>"iframeEditRekeningDebitKredit",
//                                  "onclick"=>"$(\"#dialogUbahRekeningDebitKredit\").dialog(\"open\");",
//                                  "rel"=>"tooltip",
			...
			'class'=>'bootstrap.widgets.BootButtonColumn',
                        ...
                        'buttons'=>array(
                                        'remove' => array (
                                                ...
                                                'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/removeTemporary",array("id"=>"$data->jenispengeluaran_id"))',
