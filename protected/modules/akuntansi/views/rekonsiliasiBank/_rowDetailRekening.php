<tr>
	<td><?php echo CHtml::hiddenField('no_urut',0,array('readonly'=>true,'class'=>'span1 integer', 'style'=>'width:20px;')); ?>
	...
	<td><?php echo CHtml::activeTextField($modRekonDetail, '[ii]saldodebit',array('disabled'=>($status == 'debit' ? "" : "disabled"),'class'=>'span2 integer')); ?></td>
	<td><?php echo CHtml::activeTextField($modRekonDetail, '[ii]saldokredit',array('disabled'=>($status == 'kredit' ? "" : "disabled"),'class'=>'span2  integer')); ?></td>
