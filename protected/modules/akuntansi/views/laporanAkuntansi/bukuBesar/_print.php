<?php 
	...
	if ($caraPrint != 'GRAFIK')
	$this->renderPartial('akuntansi.views.laporanAkuntansi.bukuBesar/_table', array('model'=>$model, 'caraPrint'=>$caraPrint,'jmlrekening'=>$jmlRekening, 'modelLaporan'=>$modelLaporan)); 
