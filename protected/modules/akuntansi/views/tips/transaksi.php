...
Ulang
  ...
  <tr>
    <td>7. </td>
    <td>Gunakan tombol ini <a class="btn btn-info" href="#" disabled="disabled">
<i class="icon-print icon-white"></i>
Print
</a> untunk mencetak lebaran kerja.</td>
  </tr>
    </tr>
        <tr><td>8. </td>
        <td>Gunakan tombol ini <button class="btn btn-primary" type="button" name="yt0" rel="tooltip" >
<i class="icon-plus icon-white"></i>
</button>
 berfungsi untuk memasukan data .</td>
  </tr>
</table>
</p>
