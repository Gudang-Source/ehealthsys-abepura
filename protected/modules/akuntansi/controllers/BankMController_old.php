...
class BankMController extends MyAuthController
{
	...
	{
        $model=AKBankRekM::model()->findByAttributes(array('bank_id'=>$id));
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['AKBankM']))
		{
			$model->attributes=$_POST['AKBankM'];
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			$model = AKBankRekM::model()->deleteAllByAttributes(array('bank_id'=>$id));
	...
	{
		$dataProvider=new CActiveDataProvider('AKBankM');
	...
	{
		$model=AKBankM::model()->findByPk($id);
		if($model===null)
	...
	public function actionPrint()
	{
		...
		if(isset($_REQUEST['AKBankRekM'])){
			$model->attributes=$_REQUEST['AKBankRekM'];
		}
