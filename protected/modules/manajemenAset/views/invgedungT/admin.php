<div class="white-container">
    ...
    <legend class='rim2'>Informasi Inventarisasi <b>Gedung dan Bangunan</b></legend>
    ...
    <div class="block-tabel">
        <h6>Tabel Inventarisasi <b>Gedung dan Bangunan</b></h6>
        <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
            ...
            'columns'=>array(
                    ...
                    array(
							...
							'value'=>'(isset($data->pemilikbarang_id) ? $data->pemilikbarang->pemilikbarang_nama : " - " )',
                    ),
                                    array(
                            'name'=>'barang_id',
                    ...
                    'invgedung_kontruksi',
                    array(
                        'name'=>'invgedung_luaslantai',
                        'type'=>'raw',
                        'value'=>'$data->invgedung_luaslantai." m<sup>2</sup"',
                        'htmlOptions'=>array(
                    ...
                    'invgedung_nodokumen',
                    array(
                        'name'=>'invgedung_harga',
                        'type'=>'raw',
                        'value'=>'MyFormatter::formatNumberForPrint($data->invgedung_harga)',
                        'htmlOptions'=>array(
                            'style'=>'text-align: right',
                        ),
                    ),
