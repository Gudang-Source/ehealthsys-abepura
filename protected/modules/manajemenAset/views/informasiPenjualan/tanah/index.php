<div class="white-container">
    <legend class="rim2">Informasi <b>Penjualan Tanah</b></legend>
    <?php
   ...
   // $this->menu=$arrMenu;
    ...
    <div class="block-tabel">
        <h6>Tabel <b>Penjualan Tanah</b></h6>
        <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
            'id'=>'invtanah-t-grid',
            'dataProvider'=>$model->searchInformasiTanah(),
    //	'filter'=>$model,
            'template'=>"{summary}\n{items}\n{pager}",
            ...
            'columns'=>array(                    
                      ...
                      array(
                          ...
                          'name' => 'invtanah_kode',
                          'value' => '$data->invtanah_kode'
                      ),
                      array(
                          'header'=> 'No Register',
                          'name' => 'invtanah_noregister',
                          'value' => '$data->invtanah_noregister'
                      ),
                      array(
                          'header'=> 'Barang',
                          'name' => 'barang_nama',
                      ...
                      array(
                          'header'=> 'Harga',
                          'name' => 'invtanah_harga',
                          'value' => 'number_format($data->invtanah_harga,0 ,"",".")',
    ...
    <fieldset class="box">
        <?php $this->renderPartial($this->path_view.'tanah/_search',array(
                'model'=>$model,
        )); ?>
    </fieldset>
</div>
