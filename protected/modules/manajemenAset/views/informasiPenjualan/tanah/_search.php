            ...
            <tr>
                ...
                <div class='control-group hari'>
                    ...
                    <div class = "control-group">
                       <?php echo Chtml::label("Kode Inventaris",'invtanah_kode', array('class'=>'control-label')) ?>
                       <div class = "controls">
                           <?php echo $form->textField($model,'invtanah_kode',array('class'=>'custom-only')) ?>
                       </div>
                   </div>
                </td>
                <td>
                    ...
                    <div class = "control-group">
                       <?php echo Chtml::label("No Register",'invtanah_noregister', array('class'=>'control-label')) ?>
                       <div class = "controls">
                           <?php echo $form->textField($model,'invtanah_noregister',array('class'=>'custom-only')) ?>
                       </div>
                   </div>
