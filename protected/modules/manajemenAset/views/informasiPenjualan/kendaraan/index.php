<div class="white-container">
    <legend class="rim2">Informasi <b>Penjualan Kendaraan</b></legend>
    <?php
   ...
   // $this->menu=$arrMenu;
    ...
    <div class="block-tabel">
        <h6>Tabel <b>Penjualan Kendaraan</b></h6>
        <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
            'id'=>'invtanah-t-grid',
            'dataProvider'=>$model->searchInformasiKendaraan(),
    //	'filter'=>$model,
            'template'=>"{summary}\n{items}\n{pager}",
    ...
    <fieldset class="box">
        <?php $this->renderPartial($this->path_view.'kendaraan/_search',array(
                'model'=>$model,
        )); ?>
    </fieldset>
</div>
