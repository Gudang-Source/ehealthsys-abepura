<div class="white-container">
    <legend class="rim2">Informasi <b>Penjualan Peralatan Medis</b></legend>
    <?php
   ...
   // $this->menu=$arrMenu;
    ...
    <div class="block-tabel">
        <h6>Tabel <b>Penjualan Peralatan Medis</b></h6>
        <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
            'id'=>'invtanah-t-grid',
            'dataProvider'=>$model->searchInformasiPeralatanMedis(),
    //	'filter'=>$model,
            'template'=>"{summary}\n{items}\n{pager}",
