<div class="white-container">
    <legend class="rim2">Informasi <b>Penjualan Gedung Dan Bangunan</b></legend>
    <?php
   ...
   // $this->menu=$arrMenu;
    ...
    <div class="block-tabel">
        <h6>Tabel <b>Penjualan Gedung Dan Bangunan</b></h6>
        <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
            'id'=>'invtanah-t-grid',
            'dataProvider'=>$model->searchInformasiGedungDanBangunan(),
    //	'filter'=>$model,
            'template'=>"{summary}\n{items}\n{pager}",
            ...
            'columns'=>array(                    
                      ...
                      array(
                          ...
                          'name' => 'invgedung_kode',
                          'value' => '$data->invgedung_kode'
                      ),
                      array(
                          'header'=> 'No Register',
                          'name' => 'invgedung_noregister',
                          'value' => '$data->invgedung_noregister'
                      ),
                      array(
                          'header'=> 'Barang',
                          'name' => 'barang_nama',
                      ...
                      array(
                          'header'=> 'Harga',
                          'name' => 'invtanah_harga',
                          'value' => 'number_format($data->invgedung_harga,0 ,"",".")',
    ...
    <fieldset class="box">
        <?php $this->renderPartial($this->path_view.'gedungDanBangunan/_search',array(
                'model'=>$model,
        )); ?>
    </fieldset>
</div>
