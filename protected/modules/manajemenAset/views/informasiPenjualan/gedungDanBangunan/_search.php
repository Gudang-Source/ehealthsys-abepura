            ...
            <tr>
                ...
                <div class='control-group hari'>
                    ...
                    <div class = "control-group">
                       <?php echo Chtml::label("Kode Inventaris",'invgedung_kode', array('class'=>'control-label')) ?>
                       <div class = "controls">
                           <?php echo $form->textField($model,'invgedung_kode',array('class'=>'custom-only')) ?>
                       </div>
                   </div>
                </td>
                <td>
                    ...
                    <div class = "control-group">
                       <?php echo Chtml::label("No Register",'invgedung_noregister', array('class'=>'control-label')) ?>
                       <div class = "controls">
                           <?php echo $form->textField($model,'invgedung_noregister',array('class'=>'custom-only')) ?>
                       </div>
                   </div>
