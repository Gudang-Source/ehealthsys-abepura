<div class="white-container">
    <legend class="rim2">Register Inventarisasi <b>Jalan Irigasi dan Jaringan</b></legend>
    <?php
    ...
    $arrMenu = array();
                  //  array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Inventarisasi Jalan Irigasi dan Jaringan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
