<tr>   
    ...
    <td><?php echo CHtml::activeTextField($modDetail, '[]jmlbeli', array('class'=>'span1 numbersOnly qty', 'style'=>'text-align: right;', 'onblur'=>'hitungTotal(this)')).' '.$modBarang->barang_satuan; ?></td>
