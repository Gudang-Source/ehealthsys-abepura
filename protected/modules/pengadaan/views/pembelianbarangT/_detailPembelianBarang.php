<tr>   
    ...
    <td><?php echo CHtml::activeTextField($modDetail, '[]hargasatuan', array('class'=>'span2 numbersOnly satuan', 'style'=>'text-align: right;')); ?></td>
    <td><?php echo CHtml::activeTextField($modDetail, '[]jmlbeli', array('class'=>'span1 numbersOnly qty', 'style'=>'text-align: right;')); ?></td>
