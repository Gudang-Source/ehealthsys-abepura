...
<?php echo CHtml::htmlButton(Yii::t('mds','{icon}',array('{icon}'=>'<i class="icon-search icon-white"></i>')),array('class'=>'btn btn-primary pull-right','rel'=>'tooltip','title'=>'klik untuk mencari diagnosa rujukan','onclick'=>'$(\'#dialogDiagnosa\').dialog(\'open\')')); ?>
<br><br>
