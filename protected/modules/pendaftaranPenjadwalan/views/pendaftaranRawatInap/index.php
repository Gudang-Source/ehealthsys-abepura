<div class="white-container">
    <legend class="rim2">Pendaftaran <b>Rawat Inap (Langsung)</b></legend>
    ...
    <fieldset>
		<!--<div class="row-fluid">-->
			<!--<div class = "span4"><legend class="rim">Admisi Ruangan</legend></div>-->
			<!--<div class = "span4"> &nbsp; </div>-->
			<!--<div class = "span4"><legend class="rim">Rujukan</legend></div>-->
		<!--</div>-->
