...
<!--  RND-3123  <tr>
    ...
    <tr>
        ...
        <td>:</td>
        <td><?php echo $modPasienAdmisi->carabayar->carabayar_nama; ?>/<?php echo $modPasienAdmisi->penjamin->penjamin_nama; ?></td>
    </tr>
    <tr>
        <td align="center" valig="middle" colspan="3">
    ...
    <tr>
        ...
        <td>:</td>
        <td><?php echo $modPasienAdmisi->ruangan->ruangan_nama; ?> / No.<?php echo isset($modPasienAdmisi->kamarruangan) ? $modPasienAdmisi->kamarruangan->kamarruangan_nokamar : "-"; ?></td>
    </tr>
<!--    <tr>
        <td>Karcis</td>
        <td>:</td>
