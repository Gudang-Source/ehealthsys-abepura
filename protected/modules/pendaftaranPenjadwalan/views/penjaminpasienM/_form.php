	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <table id="tbl-penjaminPasien" class="table table-striped table-bordered table-condensed">
            <tr>
                ...
                <td>
                    <?php echo $form->textField($model,'[1]penjamin_namalainnya',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>70, 'placeholder'=> $model->getAttributeLabel('penjamin_namalainnya'))); ?>
                </td>
                <td>
