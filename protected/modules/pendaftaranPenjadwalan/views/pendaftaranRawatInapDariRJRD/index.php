<div class="white-container">
    <legend class="rim2">Pendaftaran <b>Rawat Inap</b></legend>
    ...
    <fieldset class="box" id="form-pasien">
        <legend class="rim"><span class='judul' id="judul_pasien">Data Pasien Rawat Jalan</span><span class='tombol' style='display:none;'><?php echo CHtml::htmlButton('<i class="icon-refresh icon-white"></i>',array('class'=>'btn btn-danger btn-mini','onclick'=>'setPasienRJRDReset();','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk ulang pencarian')); ?></span></legend>
        <div class="row-fluid">    
                ...
                <?php $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
                        ...
                        'content'=>array(
                            'content-riwayatpasien'=>array(
                                ...
                                'isi'=>$this->renderPartial($this->path_view_rj.'_tableRiwayatPasien',array(
                                        'form'=>$form,
                                        'modPasien'=>$modPasien,
                                        ),true),
                                'active'=>true,
