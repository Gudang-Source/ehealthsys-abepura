<div class="white-container">
    ...
    $url = Yii::app()->createUrl('pendaftaranPenjadwalan/laporan/frameGrafikAlamatRD&id=1');
    if (Yii::app()->user->getState('ruangan_id') == Params::RUANGAN_ID_REKAM_MEDIS){
        $url = Yii::app()->createUrl('rekamMedis/laporan/frameGrafikAlamatRD&id=1');
    }
    ...
    $this->widget('bootstrap.widgets.BootMenu', array(
        ...
        'items'=>array(
            ...
            array('label'=>'Alamat Lengkap', 'url'=>$this->createAbsoluteUrl($controller.'/laporanAlamatKunjunganRD'),'active'=>true),
    ...
    <div class="biru">
        <div class="white">
            <!--<div class="block-tabel">-->
                <!--<h6>Table Kunjungan <b>Rawat Darurat - Alamat</b></h6>-->
    ...
    $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
    $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
    $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printAlamatKunjunganRD');
