...
if ($caraPrint != 'GRAFIK'){
    if ($initial == 'RI'){
        $this->renderPartial('pendaftaranPenjadwalan.views.laporan.rawatInap._tableAlasanPulangRI', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
    }else{
...
if ($caraPrint == 'GRAFIK')
echo $this->renderPartial('pendaftaranPenjadwalan.views.laporan._grafikAlasanPulang', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'colspan'=>9), true); 
