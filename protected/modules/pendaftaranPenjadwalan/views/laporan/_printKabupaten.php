...
if ($caraPrint != 'GRAFIK'){
    if ($initial == 'RI'){
        $this->renderPartial('pendaftaranPenjadwalan.views.laporan.rawatInap._tableKabupatenRI', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
    }else{
        $this->renderPartial('pendaftaranPenjadwalan.views.laporan._tableKabupaten', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
    }
}
