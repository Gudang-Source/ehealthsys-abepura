<div class='white-container'>
    ...
    $this->widget('bootstrap.widgets.BootMenu', array(
        ...
        'items'=>array(
            array('label'=>'Global', 'url'=>$this->createAbsoluteUrl($controller.'/laporanKunjunganPenunjang'),'active'=>true),
    ...
    <div class="biru">
        <div class="white">
            <!--<div class='block-tabel'>-->
                ...
                <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan._tablePenunjang', array('model'=>$model)); ?>
            <!--</div>-->
        </div>
    </div>
    <div class='block-tabel'> 
    ...
    $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
    $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
    $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printKunjunganPenunjang');
