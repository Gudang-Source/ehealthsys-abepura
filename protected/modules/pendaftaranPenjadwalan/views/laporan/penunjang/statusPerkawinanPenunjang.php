<div class="white-container">
    ...
    $url = Yii::app()->createUrl('pendaftaranPenjadwalan/laporan/frameGrafikStatusPerkawinanPenunjang&id=1');
    ...
    $this->widget('bootstrap.widgets.BootMenu', array(
        ...
        'items'=>array(
            ...
            array('label'=>'Status Perkawinan', 'url'=>$this->createAbsoluteUrl($controller.'/laporanStatusPerkawinanKunjunganPenunjang'),'active'=>true),
    ...
    <?php
        $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
        $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
        $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printStatusPerkawinanKunjunganPenunjang');
