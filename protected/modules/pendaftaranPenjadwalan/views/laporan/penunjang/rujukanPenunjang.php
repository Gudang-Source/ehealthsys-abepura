<div class="white-container">
    ...
    $url = Yii::app()->createUrl('pendaftaranPenjadwalan/laporan/frameGrafikRujukanPenunjang&id=1');
    ...
    $this->widget('bootstrap.widgets.BootMenu', array(
        ...
        'items'=>array(
            ...
            array('label'=>'Rujukan', 'url'=>$this->createAbsoluteUrl($controller.'/laporanRujukanKunjunganPenunjang'),'active'=>true),
    ...
    <?php
        $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
        $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
        $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printRujukanKunjunganPenunjang');
