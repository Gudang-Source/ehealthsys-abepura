                                    ...
                                    'content'=>array(
                                        ...
                                        'isi'=>'<table>
                                                    <tr>
                                                        ...
                                                        <td>'.$form->dropDownList($modPPInfoKunjunganV, 'instalasi_id', CHtml::listData(InstalasiM::model()->findAll("instalasi_aktif = true AND instalasi_id = '".Params::INSTALASI_ID_RI."' ORDER BY instalasi_nama ASC"), 'instalasi_id', 'instalasi_nama'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)",
                                                            'ajax' => array('type' => 'POST',
...
$format = new MyFormatter();
//$modPPInfoKunjunganV->tgl_awal = $format->formatDateTimeForDb($modPPInfoKunjunganV->tgl_awal);
//$modPPInfoKunjunganV->tgl_akhir = $format->formatDateTimeForDb($modPPInfoKunjunganV->tgl_akhir);
//$modPPInfoKunjunganV->bln_awal = $format->formatMonthForDb($modPPInfoKunjunganV->bln_awal);
//$modPPInfoKunjunganV->bln_akhir = $format->formatMonthForDb($modPPInfoKunjunganV->bln_akhir);
?>
...
?>
<?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan.rawatInap/_jsFunctions', array('model'=>$modPPInfoKunjunganV));?>
<script>
