<div class="white-container">
    ...
    $this->widget('bootstrap.widgets.BootMenu', array(
        ...
        'items'=>array(
            array('label'=>'Global', 'url'=>$this->createAbsoluteUrl($controller.'/laporanKunjunganRI'),'active'=>true),
    ...
    <div class="biru">
        <div class="white">
            <!--<div class="block-tabel">-->
                <!--<h6>Table Kunjungan <b>Rawat Inap</b></h6>-->
                <div class="table-responsive">
                    <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan.rawatInap._table', array('model'=>$model)); ?>
                </div>
            <!--</div>-->
        </div>
    </div>
    <div class="block-tabel">
        ...
        <iframe class="biru" src="" id="Grafik" width="88%" height='0'  onload="javascript:resizeIframe(this);">
        </iframe>        
    </div>
    <?php 
    ...
    $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
    $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
    $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printKunjunganRI');
