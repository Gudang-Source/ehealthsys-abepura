<div class="white-container">
    ...
    $url = Yii::app()->createUrl('pendaftaranPenjadwalan/laporan/frameGrafikAgamaRI&id=1');
    if (Yii::app()->user->getState('ruangan_id') == Params::RUANGAN_ID_REKAM_MEDIS){
        $url = Yii::app()->createUrl('rekamMedis/laporan/frameGrafikAgamaRI&id=1');
    }
    ...
    $this->widget('bootstrap.widgets.BootMenu', array(
        ...
        'items'=>array(
            ...
            array('label'=>'Agama', 'url'=>$this->createAbsoluteUrl($controller.'/laporanAgamaKunjunganRI'),'active'=>true),
    ...
    <div class="biru">
        <div class="white">
            <!--<div class="block-tabel">-->
                <!--<h6>Table Kunjungan <b>Rawat Inap - Agama</b></h6>--> 
                <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan.rawatInap._tableAgamaRI', array('model'=>$model)); ?>
            <!--</div>-->
        </div>
    </div>
    <div class="block-tabel">
    ...
    $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
    $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
    $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printAgamaKunjunganRI');
