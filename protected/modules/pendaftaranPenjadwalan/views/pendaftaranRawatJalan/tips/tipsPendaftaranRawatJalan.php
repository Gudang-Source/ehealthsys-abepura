<ol class="row-fluid">
    ...
    <div class="span6">
        ...
        <li>
            ...
            berfungsi untuk melakukan pendaftaran ulang.
        </li>
        <li>
        ...
        <li>
            Tombol  <div class="btn btn-info" name="yt0" type="button"><i class="icon-print icon-white"></i> Print Kartu Pasien</div>
            berfungsi untuk mencetak kartu pasien.
        </li>
    </div>
</ol>
