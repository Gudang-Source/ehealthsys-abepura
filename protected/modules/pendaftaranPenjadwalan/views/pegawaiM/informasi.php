...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('petugas-pegawai-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="white-container">
    <legend class="rim2">Informasi <b>Petugas Loket</b></legend>

<?php // echo CHtml::link(Yii::t('mds','{icon} Advanced Search',array('{icon}'=>'<i class="icon-search"></i>')),'#',array('class'=>'search-button btn')); ?>
<div class="search-form" style="display:none" hidden>
...
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'petugas-pegawai-grid',
	'dataProvider'=>$model->searchPetugasLoket(),
	'filter'=>$model,
        'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		...
		'nama_pegawai',
                array(
                    ...
                    'type'=>'raw',
                    'value'=>function($data) {
                        $lp = LoginpemakaiK::model()->findByAttributes(array('pegawai_id'=>$data->pegawai_id));
                        if (!empty($lp)) return $lp->nama_pemakai;
                    }
                ),
		//'nomorindukpegawai',
