...
<?php echo $form->textFieldRow($modPegawai,'unit_perusahaan',array('style'=>'width:166px;', 'onkeyup'=>"return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
<div class="control-group ">
    ...
    <div class="controls">
        <?php   
			...
			echo $form->textField($modPegawai,'jabatan_nama',array('style'=>'width:166px;', 'onkeyup'=>"return $(this).focusNextInputField(event);",'readonly'=>true));
		?>
