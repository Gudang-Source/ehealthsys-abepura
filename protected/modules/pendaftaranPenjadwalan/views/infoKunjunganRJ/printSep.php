...
<table width="100%">
    <tr>
        ...
        <td colspan='5' align='center' style="font-weight:bold"><?php echo $judul_print; ?><br><?php echo Yii::app()->user->getState('nama_rumahsakit'); ?></td>
        <td rowspan='2'><img src="<?php echo Params::urlProfilRSDirectory().Yii::app()->user->getState('nama_rumahsakit'); ?>" width="60"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3"></td>
        <td colspan="3"></td>
        <td ><img src="<?php echo Yii::app()->getBaseUrl('webroot').'/images/inova.PNG'; ?>" width="120"></td>
    </tr>
