...
<table border="0" style="padding :none;">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>Icon <i class="icon-list-alt"></i> untuk melihat detail tarif..</td>
  </tr>
   <tr>
    <td style="vertical-align: middle;">4. </td>
    <td>Icon <i class="icon-form-lihat"></i> untuk data pegawai lebih lanjut.</td>
  </tr>
  <tr>
    <td style="vertical-align: middle;">5. </td>
    <td>Icon <i class="icon-form-ubah"></i> untuk mengedit lembaran kerja terpilih.</td>
  </tr>
  <tr>
...
Ulang
    ...
    <td>Gunakan tombol ini <a class="btn btn-info" href="#" disabled="">
<i class="icon-print icon-white"></i>
Print
</a> untunk mencetak lembaran kerja.</td>
  </tr>
</table>
</p>
