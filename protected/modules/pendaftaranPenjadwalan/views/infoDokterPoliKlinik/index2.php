...
<legend class="rim2">Penjadwalan Dokter Poli Klinik</legend>
...
timePicker;
	...
	'dataProvider'=>$model->searchJadwalRJ(),
//                'filter'=>$model,
                'template'=>"{pager}\n{items}",
    ...
    <table class="table">
        <tr>
            <td>
                ...
                <?php echo $form->dropDownListRow($model,'ruangan_id', CHtml::listData(PPPendaftaranT::model()->getRuanganItems(Params::INSTALASI_ID_RJ), 'ruangan_id', 'ruangan_nama') ,
                                                      array('empty'=>'-- Pilih --',
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(Yii::t('mds', '{icon} Reset', array('{icon}'=>'<i class="icon-refresh icon-white"></i>')), $this->createUrl('infoDokterPoliKlinik/index'), array('class'=>'btn btn-danger')); ?>
    <?php 
