                ...
                foreach ($list1 as $i=>$v){
                    ...
                    $dataRuangan ='';
                        ...
                        foreach ($v['kamar'] as $j=>$w){
                            ...
                            $result .='<div class="pintu"></div><h3 class="popover-title"><img src=\''. Yii::app()->baseUrl.'/images/blue-home-icon.png\' style=\'height:30px;\'/>'.$v['name'].' - '.$w['kelaspelayanan'].' - '.$w['jml'].' Bed <a href="" class="pull-right poping" data-content="'.strtr($dataRuangan,$vars).'" onclick="return false;" style = "padding-left:200px;"><img src=\''. Yii::app()->baseUrl.'/images/fasilitas.png\' style=\'height:30px;\'/>Detail</a></h3>
                                <ul>';
...
//                                            $dataPasien .='<p><label class=\'control-label\'>Jenis Kelamin :</label> '.$kamar->admisi->pasien->jeniskelamin.'</p>';
                                        ...
                                        if ($booked == 0){
                                            if ($v['ruangan_id'] == Params::RUANGAN_ID_ANAK):
                                                $result .='<p><a style="text-align:left;" href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'anak-kosong' : 'anak-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            elseif ($v['ruangan_id'] == Params::RUANGAN_ID_PRIA):
                                                $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'pria-kosong' : 'pria-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            elseif ($v['ruangan_id'] == Params::RUANGAN_ID_WANITA):
                                                $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'wanita-kosong' : 'wanita-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            elseif ($v['ruangan_id'] == Params::RUANGAN_ID_ICU):
                                                $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'icu-kosong' : 'icu-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            elseif ($v['ruangan_id'] == Params::RUANGAN_ID_PERINATOLOGI):
                                                $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'perina-kosong' : 'perina-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            elseif ($v['ruangan_id'] == Params::RUANGAN_ID_BERSALIN):
                                                $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'wanita-kosong' : 'wanita-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            elseif ($v['ruangan_id'] == Params::RUANGAN_ID_BEDAH):
                                                $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'bedah-kosong' : 'bedah-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                            else:                                              
                                                if ($jeniskelamin == 'LAKI-LAKI'):
                                                    $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'pria-kosong' : 'pria-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                                elseif ($jeniskelamin == 'PEREMPUAN'):
                                                    $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'pria-kosong' : 'wanita-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                                else:
                                                    $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Pasien Kosong' : $dataPasien).'" onclick="return false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=\''. Yii::app()->baseUrl.'/images/icon_kamar/'.(($b['status']) ?  'pria-kosong' : 'wanita-isi').'.png\'/><br>'.$b['no'].'</a></p>';
                                                endif;                                                
                                            endif;
                                        } else {
                                            $result .='<p><a style="text-align:left;"  href="" class="btn '.(($b['status']) ? 'btn-danger' : 'btn-primary').'" rel="popover" data-content="'.(($b['status']) ? 'Sudah dibooking' : $dataPasien).'" onclick="return false"><img src=\''. Yii::app()->baseUrl.'/images/'.'RanjangRumahSakit3'.'.png\'/>'.$b['no'].'</a></p>';
                                        }
                                    }
