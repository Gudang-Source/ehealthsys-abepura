...
class LaporanController extends MyAuthController {
    ...
    {
        $model = new RELaporanpemakaiobatalkesruanganV;
        ...
        if(isset($_GET['RELaporanpemakaiobatalkesruanganV']))
        {
            $model->attributes = $_GET['RELaporanpemakaiobatalkesruanganV'];
            $model->ruangan_id = Yii::app()->user->getState('ruangan_id');
            $model->jns_periode = $_GET['RELaporanpemakaiobatalkesruanganV']['jns_periode'];
            $model->tgl_awal = $format->formatDateTimeForDb($_GET['RELaporanpemakaiobatalkesruanganV']['tgl_awal']);
            $model->tgl_akhir = $format->formatDateTimeForDb($_GET['RELaporanpemakaiobatalkesruanganV']['tgl_akhir']);
            $model->bln_awal = $format->formatMonthForDb($_GET['RELaporanpemakaiobatalkesruanganV']['bln_awal']);
            $model->bln_akhir = $format->formatMonthForDb($_GET['RELaporanpemakaiobatalkesruanganV']['bln_akhir']);
            $model->thn_awal = $_GET['RELaporanpemakaiobatalkesruanganV']['thn_awal'];
            $model->thn_akhir = $_GET['RELaporanpemakaiobatalkesruanganV']['thn_akhir'];
    ...
    public function actionPrintLaporanPemakaiObatAlkes() {
        $model = new RELaporanpemakaiobatalkesruanganV('search');
        $format = new MyFormatter();
        $model->ruangan_id = Yii::app()->user->getState('ruangan_id');
        $model->jns_periode = "hari";
        $model->tgl_awal = date('Y-m-d');
        ...
        if (isset($_REQUEST['RELaporanpemakaiobatalkesruanganV'])) {
            $model->attributes = $_REQUEST['RELaporanpemakaiobatalkesruanganV'];
            $model->ruangan_id = Yii::app()->user->getState('ruangan_id');
            $model->jns_periode = $_GET['RELaporanpemakaiobatalkesruanganV']['jns_periode'];
            $model->tgl_awal = $format->formatDateTimeForDb($_GET['RELaporanpemakaiobatalkesruanganV']['tgl_awal']);
            $model->tgl_akhir = $format->formatDateTimeForDb($_GET['RELaporanpemakaiobatalkesruanganV']['tgl_akhir']);
