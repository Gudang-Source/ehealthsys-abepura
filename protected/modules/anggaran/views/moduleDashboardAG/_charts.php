...
<div class="panel panel-primary" id="charts_env">
	...
	<div class="panel-heading">
		<div class="panel-title">Jumlah Rencana Anggaran Bulan ini</div>
		...
		<thead>
			<tr>
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Realisasi Rencana Anggaran Penerimaan Bulan Ini</div>
				...
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Realisasi Rencana Anggaran Pengeluaran Bulan Ini</div>
...
$(document).ready(function($) 
{
        ...
        data: [
			...
			if(count($dataAreaChart) > 0){
				foreach ($dataAreaChart as $i => $chart) { ?>
					 x: "<?php echo date("d",strtotime($chart['tgl'])); ?>", 
	...
	Morris.Line({
		...
		labels: ['Kunjungan Baru', 'Kunjungan Lama', 'Pengunjung Baru', 'Pengunjung Lama'],
		parseTime: false,
