...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
    ...
    $('#infopenerimaan-form').submit(function(){
...
<legend class="rim2">Informasi <b>Anggaran Penerimaan</b></legend>
<?php 
$sukses = null;
...
?>
    <div class="block-tabel">
        <h6>Tabel <b>Anggaran Penerimaan</b></h6>
        <div class="table-responsive">
        <?php
            $this->widget('ext.bootstrap.widgets.BootGridView', array(
                'id'=>'inforencanggpen-grid',
                'dataProvider'=>$model->searchInformasiAnggPen(),
                'template'=>"{summary}\n{items}\n{pager}",
                ...
                'columns'=>array(
							...
							array(
								'header'=>'Realisasi',
								'type'=>'raw',
								'value'=>'(($data->getIsRealisasi($data->renanggpenerimaan_id)) ?  "Sudah direalisasikan " : CHtml::link("<icon class=\'icon-form-detailtagihan\'></icon> ", Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/Realisasi", array("renanggpenerimaan_id"=>$data->renanggpenerimaan_id,"frame"=>true)), array("rel"=>"tooltip", "title"=>"Klik untuk realisasi")))',
								'htmlOptions'=>array('style'=>'text-align: left;'),
							),
                    ),
        ...
        <div class="row-fluid">
			...
			<div class="span4">
				...
				<?php echo $form->labelEx($model,'Periode Anggaran', array('class'=>'control-label')) ?>
					<div class="controls">
						<?php echo $form->dropDownList($model, 'konfiganggaran_id', CHtml::listData(AGKonfiganggaranK::model()->findAllByAttributes(array('isclosing_anggaran'=>false),array('order'=>'deskripsiperiode')), 'konfiganggaran_id', 'deskripsiperiode'), array('empty'=>'--Pilih--','class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'periodeAnggaran();')); ?>
