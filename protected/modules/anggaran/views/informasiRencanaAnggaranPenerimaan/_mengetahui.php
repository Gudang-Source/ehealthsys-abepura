	...
	<div class="span6" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				array('class'=>'btn btn-primary',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('Mengetahui',array('renanggpenerimaan_id'=>$model->renanggpenerimaan_id,'renpen_mengetahui_id'=>$model->renpen_mengetahui_id)).'";} ); return false;'));  
			}
			?>
		</div>	
...
<?php 
    ...
    $urlPrint= $this->createUrl('printMengetahui',array('renanggpenerimaan_id'=>$model->renanggpenerimaan_id));
