...
<div class="row-fluid">
	<div class="span4">
		<?php echo $form->textFieldRow($model, 'noren_penerimaan', array('class' => 'span3 numberOnly', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Ketik no. Penerimaan')); ?>
