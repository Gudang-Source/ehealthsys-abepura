<div class="" style="overflow-x:scroll;">
    <?php 
    $modPendaftaran = new LBPendaftaranT("searchRiwayatPasien");
...
//                ),
                ...
                array(
                    'header'=>'Cara Bayar',
                    'type'=>'raw',
                    'value'=>'(!empty($data->carabayar_id) ? $data->carabayar->carabayar_nama : "")',
                ),
                array(
                    'header'=>'Penjamin',
                    'type'=>'raw',
                    'value'=>'(!empty($data->penjamin_id) ? $data->penjamin->penjamin_nama : "")',
                ),
            ),
        )); 
    ?>
