...
<?php
    $this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
        ...
        $modDataPasien = new LBPasienM('searchDialog');
        $modDataPasien->unsetAttributes();
        if(isset($_GET['LBPasienM'])) {
            $modDataPasien->attributes = $_GET['LBPasienM'];
            $modDataPasien->cari_kelurahan_nama = $_GET['LBPasienM']['cari_kelurahan_nama'];
            $modDataPasien->cari_kecamatan_nama = $_GET['LBPasienM']['cari_kecamatan_nama'];
        }
