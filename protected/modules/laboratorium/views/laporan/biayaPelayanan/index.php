<div class="white-container">
    <legend class="rim2">Laporan Biaya <b>Pelayanan Laboratorium</b></legend>
    <?php
    ...
    $url = Yii::app()->createUrl('laboratorium/laporan/frameGrafikLaporanBiayaPelayanan&id=1');
    ...
    <div class="block-tabel"> 
        <h6>Tabel Biaya <b>Pelayanan Laboratorium</b></h6>
