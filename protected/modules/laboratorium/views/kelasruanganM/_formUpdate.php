...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<p class="help-block"><?php echo Yii::t('mds','Fields with <span class="required">*</span> are required.') ?></p>
        ...
        <table id="tabelkelasruangan" class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                {
                    $hapus = Yii::app()->createUrl('laboratorium/kelasruanganM/Delete',array('ruangan_id'=>"$value->ruangan_id",'kelaspelayanan_id'=>"$value->kelaspelayanan_id"));
                    $tr = '<tr>';
	...
	<div class="form-actions">
                        ...
                        <?php
                            ...
                            $content = $this->renderPartial('laboratorium.views.tips.tipsaddedit3',array(),true);
