...
class LBLaporanjasainstalasiV extends LaporanjasainstalasiV {
    ...
    public function searchGrafik() {
        ...
        $criteria->select = "count(pendaftaran_id) as jumlah, case when tindakansudahbayar_id is null then 'BELUM LUNAS' else 'LUNAS' end as data";
        $criteria->group = 'data';
		$criteria->order = '';
