<div class="white-container">
    ...
    <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Kasus Penyakit Diagnosa', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('/persalinan/kasuspenyakitdiagnosaM/Admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
