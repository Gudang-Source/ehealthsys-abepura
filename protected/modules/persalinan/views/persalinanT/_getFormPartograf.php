        ...
        <table width="100%" class="table-condensed" id='statusPar'>
            <tr>
                <td>
                    ...
                    <?php echo $form->hiddenField($modPartograf,'[0]persalinan_id') ?>
                    ...
                    <div class = "control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->dropDownList($modPartograf, '[0]pto_airketuban', LookupM::getItems('partografketuban'), array('class'=>'span2', 'empty' => '-- Pilih --')); ?>
                        </div>
                    </div>
                    ...
                    <div class = "control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->dropDownList($modPartograf, '[0]pto_penyusupan',  LookupM::getItems('partografpenyusupan'),array('class'=>'span2', 'empty' => '-- Pilih --')); ?>
                        </div>
                    </div>
                    ...
                    <div class = "control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->dropDownList($modPartograf, '[0]kontraksi_lama_detik', LookupM::getItems('partograflama'), array('class'=>'span2', 'empty' => '-- Pilih --')).' detik'; ?>
                        </div>
                    </div>
                    <br/>
                ...
                <td>
                    ...
                    <div class = "control-group">
                        ...
                        <div class="controls">
                            <?php 
                                echo $form->dropDownList($modPartograf, '[0]urine_protein', LookupM::getItems('partografproteinaseton'), array('class'=>'span2', 'empty' => '-- Pilih --')).' detik';
                            ?>
                        </div>
                    </div>
                    ...
                    <div class = "control-group">
                        ...
                        <div class="controls">
                            <?php 
                                echo $form->dropDownList($modPartograf, '[0]urine_aseton', LookupM::getItems('partografproteinaseton'), array('class'=>'span2', 'empty' => '-- Pilih --')).' detik';
                            ?>
                        </div>
                    </div>
