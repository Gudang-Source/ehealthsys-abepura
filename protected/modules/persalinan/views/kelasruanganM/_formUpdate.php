...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<p class="help-block"><?php echo Yii::t('mds','Fields with <span class="required">*</span> are required.') ?></p>
        ...
        <table id="tabelkelasruangan" class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                foreach ($modKelasruangan as $value)
                {
                    $hapus = Yii::app()->createUrl('persalinan/kelasruanganM/Delete',array('ruangan_id'=>"$value->ruangan_id",'kelaspelayanan_id'=>"$value->kelaspelayanan_id"));
                    $tr = '<tr>';
                    $tr .= '<td>'.$modInstalasi->instalasi_nama.'</td>';
                    $tr .= '<td>'.$value->ruangan->ruangan_nama.'</td>';
                    $tr .= '<td>'.$value->kelaspelayanan->kelaspelayanan_nama.'</td>';
                    $tr .= '<td>'.$value->kelaspelayanan->kelaspelayanan_namalainnya.'</td>';
	...
	<div class="form-actions">
            ...
            <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Kelas Ruangan', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('/persalinan/kelasruanganM/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
            <?php
