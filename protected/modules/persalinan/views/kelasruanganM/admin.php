...
//                'extraRowColumns' => array('ruangan.ruangan_nama'),
	...
	'columns'=>array(
                    ...
                    array(
                        ...
                        'filter'=>  CHtml::listData($model->getKelaspelayananItems(),'kelaspelayanan_id','kelaspelayanan_nama'),
                    ),
                    array(
                        'header'=>'Nama Lainnya',
                        'name'=>'kelaspelayanan_id',
                        'value'=>'$data->kelaspelayanan->kelaspelayanan_namalainnya',
                        'filter'=>  CHtml::listData($model->getKelaspelayananItems(),'kelaspelayanan_id','kelaspelayanan_namalainnya'),
                    ),
                    array(
...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Kelas Ruangan', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('/persalinan/kelasruanganM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
