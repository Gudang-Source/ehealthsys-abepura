...
<fieldset>
    <legend class="accord1" style="width:460px;">Riwayat Pasien <?php echo CHtml::checkBox('cekRiwayatPasien',false, array('onkeypress'=>"return $(this).focusNextInputField(event)")) ?></legend>
    <div id="divRiwayatPasien" class="control-group">
        <iframe src="<?php echo Yii::app()->createUrl('persalinan/daftarPasien/getRiwayatPasien&id='.$modPasien->pasien_id); ?>" id="riwayatPasien" width="100%" height="100%" onload="javascript:resizeIframe(this);">
        </iframe>        
    </div>
</fieldset>
...
?>
<iframe src="" name="pesan" width="100%">
</iframe>
<?php
$this->endWidget();
//=======================================================================
