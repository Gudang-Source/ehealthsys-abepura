...
//                array_push($arrMenu,array('label'=>Yii::t('mds','List').' PSRinciantagihanpasienV', 'icon'=>'list', 'url'=>array('index'))) ;
//                (Yii::app()->user->checkAccess(Params::DEFAULT_CREATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Create').' PSRinciantagihanpasienV', 'icon'=>'file', 'url'=>array('create'))) :  '' ;
