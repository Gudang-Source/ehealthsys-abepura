...
<?php echo $form->errorSummary($model); ?>
        <div>
            ...
            <?php
                ...
                echo "<label> $modInstalasi->instalasi_nama </label>";
            ?>
            </div>
        </div>
        <div>
            ...
            <?php
                ...
                echo CHtml::hiddenField('ruanganid',$ruanganid);
                echo "<label>$modruangan->ruangan_nama</label>";
            ?>
            </div>
        </div>
...
<table id="tabelKasuspenyakitdiagnosa" class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
        ...
        {
            $hapus = Yii::app()->createUrl('persalinan/ruanganpegawaiM/Delete',array('ruangan_id'=>"$value->ruangan_id",'kelaspelayanan_id'=>"$value->pegawai_id"));
            $tr = '<tr>';
            $tr .= '<td>'.$modInstalasi->instalasi_nama.'</td>';
            $tr .= '<td>'.$value->ruangan->ruangan_nama.'</td>';
            $tr .= '<td>'.$value->ruangan->ruangan_namalainnya.'</td>';
            $tr .= '<td>'.$value->pegawai->namalengkap.'</td>';
            $tr .= '<td>'.CHtml::link("<i class='icon-trash'></i>",$hapus, array('onclick'=>'hapus(this);')).'</td>';
            $tr .= '</tr>';
            echo $tr;
        }
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Ruangan Pegawai', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('/persalinan/ruanganpegawaiM/Admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
    <?php
