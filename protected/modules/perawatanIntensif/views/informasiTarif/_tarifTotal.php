...
$modTarifTindakan=RITariftindakanM::model()->find('kelaspelayanan_id='.$kelaspelayanan_id.' AND 
                                                   daftartindakan_id='.$daftartindakan_id.'
                                                   AND komponentarif_id='.Params::KOMPONENTARIF_ID_TOTAL.''
		. '											AND jenistarif_id = '.$jenistarif_id.'');
}else{ 
    $modTarifTindakan=RITariftindakanM::model()->find('daftartindakan_id='.$daftartindakan_id.'
                                                   AND komponentarif_id='.Params::KOMPONENTARIF_ID_TOTAL.''
			. '										AND jenistarif_id = '.$jenistarif_id.'');
