        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    ...
                    <?php echo $form->textFieldRow($modTarifTindakanRuanganV,'daftartindakan_nama',array('placeholder'=>'Ketikan Daftar Tindakan','onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>30)); ?>
                </td>
            </tr>
        </table>      
