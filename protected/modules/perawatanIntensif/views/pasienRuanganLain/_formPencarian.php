        ...
        <tr>
            ...
            <td>
                ...
                <?php 
                    ...
                    echo $form->dropDownListRow($model,'ruanganasal_id', CHtml::listData($ruangan, 'ruangan_id', 'ruangan_nama') ,
                                 array('empty'=>'-- Pilih --',
                                       'onkeypress'=>"return $(this).focusNextInputField(event)",
                                       'class'=>'span2', 'onchange' => 'getKelasPelKamarRuangan(this);')); ?>
...
function getKelasPelKamarRuangan(obj)
{
    ...
    $.ajax({
        ...
        success:function(data){           
            $("#RIPasienridariruanganlainV_kelaspelayanan_id").find('option').remove().end().append(data.kelasPelayanan);
            $("#RIPasienridariruanganlainV_kamarruangan_id").find('option').remove().end().append(data.kamarRuangan);
        },
