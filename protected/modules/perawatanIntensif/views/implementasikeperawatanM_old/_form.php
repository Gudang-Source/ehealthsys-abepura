...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( 
 ...
 $modDiagnosakeperawatan =new RIDiagnosakeperawatanM;
            ...
            <tr>
               ...
               <td>
                ...
                <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Implementasi Keperawatan', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),
                 $this->createUrl('/rawatInap/ImplementasikeperawatanM/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
