...
<fieldset>
    ...
    <table class="table table-condensed">
        ...
        <tr>
            ...
            <td><?php echo CHtml::textField('RIPendaftaranT[jeniskasuspenyakit_nama]',$modPendaftaran->jeniskasuspenyakit->jeniskasuspenyakit_nama, array('readonly'=>true)); ?></td>
        ...
        <tr>
            ...
            <td>
                <?php echo CHtml::textField('RIPendaftaranT[instalasi_nama]',$modPendaftaran->instalasi->instalasi_nama, array('readonly'=>true)); ?>
            ...
            <td><?php echo CHtml::textField('RIPendaftaranT[ruangan_nama]', $modPendaftaran->ruangan->ruangan_nama, array('readonly'=>true)); ?></td>
        </tr>
    </table>
</fieldset> 
