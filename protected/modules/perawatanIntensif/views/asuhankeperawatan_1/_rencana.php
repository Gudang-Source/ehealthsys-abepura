...
//        'pasien_id',
        ...
        array(
                     'header'=>'Rencana',
                     'type'=>'raw',
                     'value'=>'$this->grid->getOwner()->renderPartial(\'_rencanaKeperawatan\',array(\'asuhankeperawatan_id\'=>$data->asuhankeperawatan_id),true)',
        ),
        array(
                     'header'=>'Implementasi',
                     'type'=>'raw',
                     'value'=>'$this->grid->getOwner()->renderPartial(\'_implementasiKeperawatan\',array(\'asuhankeperawatan_id\'=>$data->asuhankeperawatan_id),true)',
        ),
//        'tglaskep',
//        'evaluasi_subjektif',
//        'evaluasi_objektif',
