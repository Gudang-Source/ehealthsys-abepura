        ...
        <table>
            <tr>
                <td width="50%">
                    ...
                    <?php //echo $form->dropDownListRow($modelPulang,'kondisipulang', LookupM::getItems('kondisipulang'),array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event)",'onchange'=>'pasienmeninggal(this.value)')); ?>
                    <div class="control-group ">
