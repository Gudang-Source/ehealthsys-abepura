<tr id="tr_<?php echo $modDiagnosa->diagnosa_id; ?>">
    ...
    <td>
        <?php
            echo CHtml::link("<span class='icon-remove'>&nbsp;</span>",'',array("rel"=>"tooltip","title"=>"Klik untuk membatalkan Diagnosa",'href'=>'','onclick'=>'remove(this,'.$modDiagnosa->diagnosa_id.');return false;','style'=>'text-decoration:none;'));
        ?>
    </td>
</tr>