...
<?php echo $this->renderPartial('rawatInap.views.anamnesaTRI._headerPrintAnamnesa'); ?>
...
<table width="100%">
    ...
    <tr>
        ...
        <td colspan="3"></td>
        <td colspan="3" align="center" valign="middle"><?php echo Yii::app()->user->getState('kabupaten_nama').", ".MyFormatter::formatDateTimeId($modAnamnesa->tglanamnesis); ?><br>Dokter Pemeriksa</td>
    </tr>
    <tr>
        <td colspan="9">&nbsp;</td>
    </tr>
