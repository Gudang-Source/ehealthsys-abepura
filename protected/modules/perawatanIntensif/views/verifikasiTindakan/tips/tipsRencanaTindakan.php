<ol class="row-fluid">
    <div class="span6">
        ...
        <li>
            Tombol  <i class="icon-plus"></i>
            berfungsi untuk menambahkan items tindakan.
        </li>       
        <li>
            Tombol  <i class="icon-minus"></i>
            berfungsi untuk mengurangi items tindakan.
        </li>       
    ...
    <div class="span6">
        ...
        <li>
            ...
            berfungsi untuk mencetak daftar Resep di Penjualan Resep RS.
        </li>
    </div>
</ol>
