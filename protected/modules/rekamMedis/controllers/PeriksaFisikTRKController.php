				...
				{  //Jika Pasien Sudah Melakukan Pemeriksaan Fisik  Sebelumnya
                    ...
                    if(isset($_POST['RKPemeriksaanFisikT']))
                    {
                        ...
                        try {
                                ...
                                $modPemeriksaanFisik->keadaanumum = isset($_POST['RKPemeriksaanFisikT']['keadaanumum']) ? ((count($_POST['RKPemeriksaanFisikT']['keadaanumum'])>0) ? implode(', ', $_POST['RKPemeriksaanFisikT']['keadaanumum']) : '') : ''; 
								...
								if(isset($_POST['RKPemeriksaangambarT'])){
									if(count($_POST['RKPemeriksaangambarT'])>0){
