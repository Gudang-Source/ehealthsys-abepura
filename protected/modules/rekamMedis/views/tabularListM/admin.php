			...
			'class'=>'bootstrap.widgets.BootButtonColumn',
                        ...
                        'buttons'=>array(
                                        'remove' => array (
                                                ...
                                                'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/removeTemporary",array("id"=>"$data->tabularlist_id"))',
                                                'visible'=>'($data->tabularlist_aktif && Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ? TRUE : FALSE',
