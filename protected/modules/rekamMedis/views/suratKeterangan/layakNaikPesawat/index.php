...
.groupUkurans{
    ...
    <?php
        $this->renderPartial($this->path_view.'layakNaikPesawat/suratLayakNaikPesawat',array('model'=>$model,'modPasien'=>$modPasien,
...
<?php
if(!empty($_GET['suratketerangan_id'])){
    $urlPrint=  Yii::app()->createAbsoluteUrl($this->module->id.'/'.$this->id.'/PrintLayakNaikPesawat&pendaftaran_id='.$_GET['pendaftaran_id'].'&suratketerangan_id='.$_GET['suratketerangan_id'].'');
...
<script>
    function cekValidasi(){
        ...
        if(tekanan_darah == '' || tempratur == '' || pols == '' || rr == '' || usia_kehamilan == '' || keluhan_utama == ''){
