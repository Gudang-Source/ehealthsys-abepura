...
<div>
    ...
    <p align="justify">
        ...
        <p align="justify">
            ...
            <p align="justify">
                Sehubungan dengan hasil pemeriksaan di atas dapat disimpulkan bahwa pasien membutuhkan istirahat/ cuti pasca melahirkan selama <?php echo CHtml::activeTextField($model,'lamaistirahat', array('readonly'=>false,
                            'class'=>'span1','onkeypress'=>"return $(this).focusNextInputField(event)")); ?> hari.
            </p>
            <br/>
            <p align="justify">
