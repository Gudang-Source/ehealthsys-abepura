        ...
        <p align="justify">
            ...
            <table width="100%" style="width:750px;margin-left:80px;">
                ...
                <tr>
                    <td>Tinggi Badan</td>
                    <td>:</td>
                    <td><?php echo CHtml::textField('tinggi_badan',(!empty($_GET['pendaftaran_id']) ? $tinggi_badan : ''), array('readonly'=>true,
                                'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                        <?php 
                                echo "<span class='help-inline error'>".(!empty($tinggi_badan) || empty($_GET['pendaftaran_id']) ? "" : 'Tinggi Badan harus diinputkan di Pemeriksaan Pasien')."</span>";                         
                        ?>
                    </td>
                </tr>
                <tr>
                    <td>Berat Badan</td>
                    <td>:</td>
                    <td><?php echo CHtml::textField('berat_badan',(!empty($_GET['pendaftaran_id']) ? $berat_badan : ''), array('readonly'=>true,
                                'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                        <?php 
                                echo "<span class='help-inline error'>".(!empty($berat_badan) || empty($_GET['pendaftaran_id'])? "" : 'Berat Badan harus diinputkan di Pemeriksaan Pasien')."</span>";                         
                        ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo CHtml::textArea('pemeriksaan_lain',(!empty($_GET['pendaftaran_id']) ? $pemeriksaan_lain : ''), array('readonly'=>true,
                                'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                        <?php 
                                echo "<span class='help-inline error'>".(!empty($pemeriksaan_lain) || empty($_GET['pendaftaran_id']) ? "" : 'Pemeriksaan Lain harus diinputkan di Pemeriksaan Pasien')."</span>";                         
                        ?>
                    </td>
                </tr>
            </table><br>
            <p align="justify">
                Sehubungan dengan hasil pemeriksaan di atas dapat disimpulkan bahwa pasien tersebut dinyatakan <?php echo CHtml::activeTextField($model,'keterangan', array('readonly'=>false,
                                'onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'span3')); ?> pada saat pemeriksaan.
            </p><br/>
            <p align="justify">
