...
<div>
    <div>
        <TABLE ALIGN="CENTER" style="margin-left:200px; text-align: center;">
             <TR>
    ...
    <p align="justify">
        ...
        <p align="justify">
            Adalah benar sedang dirawat inap/ opname di RS <?php echo $data->nama_rumahsakit;?> mulai tanggal
                            <div style="margin-top:-30px;margin-left:590px;"> 
                                <?php 
                                    $model->tglistirahat = (!empty($model->tglistirahat) ? $format->formatDateTimeForUser($model->tglistirahat) : '');
...
//                                            'maxDate' => 'd',
            ...
            <br/>
            <table width="100%" style="width:700px;margin-left:80px;">
                <tr>
                    <td>Keluhan Utama</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Tempratur</td>
                    <td>:</td>
                    <td><?php echo CHtml::textField('nama_pasien',(!empty($_GET['pendaftaran_id']) ? $tempratur : ''), array('readonly'=>true,
                                'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                        <?php 
                ...
                <tr>
                    <td>Lab/Radiologi</td>
                    <td>:</td>
                    <td><?php echo CHtml::textField('lab_rad','', array('readonly'=>false,
                                'onkeypress'=>"return $(this).focusNextInputField(event)")); ?></td>
                </tr>
                <tr>
                    <td>Diagnosa</td>
