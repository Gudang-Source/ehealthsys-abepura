...
<table>
    ...
    <tr>
        <td>Tanggal Peminjaman</td><td>:</td><td><?php echo $modPinjam->tglpeminjamanrm; ?></td>
    </tr>
    <tr>
        <td>Tanggal Akan Dikembalikan</td><td>:</td><td><?php echo $modPinjam->tglakandikembalikan; ?></td>
    </tr>
    <tr>
