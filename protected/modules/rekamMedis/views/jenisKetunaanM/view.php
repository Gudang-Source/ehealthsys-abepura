<div class='white-container'>
    <legend class='rim2'>Lihat <b>Jenis Ketunaan</b></legend>
    <?php
    ...
    //                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' RKJenisKetunaanM', 'icon'=>'pencil','url'=>array('update','id'=>$model->jenisketunaan_id))) :  '' ;
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' RKJenisKetunaanM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->jenisketunaan_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
