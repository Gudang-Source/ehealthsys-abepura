...
$url = Yii::app()->createUrl('rekamMedis/laporan/FrameGrafikLaporanPasienPulang&id=1');
...
<div class="white-container">
    <legend class="rim2">Laporan <b>Pasien Pulang</b></legend>
    <?php //echo CHtml::link(Yii::t('mds','{icon} Advanced Search',array('{icon}'=>'<i class="icon-search"></i>')),'#',array('class'=>'search-button btn')); ?>
    <fieldset class="search-form box">
        <?php $this->renderPartial('pasienPulang/_search',array(
            'model'=>$model,
        )); ?>
    </fieldset><!-- search-form --> 
    <div class="block-tabel"> 
        <h6>Tabel <b>Pasien Pulang</b></h6>
        <?php $this->renderPartial('pasienPulang/_table', array('model'=>$model)); ?>
    </div>
    <div class="block-tabel">
