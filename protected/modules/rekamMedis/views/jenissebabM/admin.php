<div class='white-container'>
    <legend class='rim2'>Pengaturan <b>Jenis Sebab</b></legend>
    ...
    <div class='biru'>
        <div class='white'>
            ...
            $('.search-button').click(function(){
                    $('.search-form').toggle();
                $('#RKJenissebabM_jenissebab_nama').focus();
                    return false;
            });
            ...
            //                ),
                            array(
                                    ...
                                    'buttons'=>array(
                                        'view' => array(
                                                      'options'=>array('rel' => 'tooltip' , 'title'=> 'Lihat jenis sebab'),
                                                    ),
                                     ),
                            ),
                            array(
                                    ...
                                    'buttons'=>array(
                                        'update' => array (
                                                      ...
                                                      'options'=>array('rel' => 'tooltip' , 'title'=> 'Ubah jenis sebab'),
                                                    ),
                                     ),
                            ),
                    array(
                        'header'=>'Hapus',
                        'type'=>'raw',
                        'value'=>'($data->jenissebab_aktif)?CHtml::link("<i class=\'icon-form-silang\'></i> ","javascript:removeTemporary($data->jenissebab_id)",array("id"=>"$data->jenissebab_id","rel"=>"tooltip","title"=>"Menonaktifkan jenis sebab"))." ".CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->jenissebab_id)",array("id"=>"$data->jenissebab_id","rel"=>"tooltip","title"=>"Hapus jenis sebab")):CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->jenissebab_id)",array("id"=>"$data->jenissebab_id","rel"=>"tooltip","title"=>"Hapus jenis sebab"));',
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("input[name='RKJenissebabM[jenissebab_nama]']").focus();
    });
</script>