<div class='white-container'>
    <legend class='rim2'>Pengaturan <b>Sebab Diagnosa</b></legend>
    ...
    <div class='biru'>
        <div class='white'>
            ...
            $('.search-button').click(function(){
                    $('.search-form').toggle();
                $('#RKSebabDiagnosaM_jenissebab_id').focus();
                    return false;
            });
            ...
            <!--<div class='block-tabel'>-->
                <!--<h6>Tabel Nama <b>Sebab Diagnosa</b></h6>-->
            ...
            //                ),
                            array(
                                    ...
                                    'buttons'=>array(
                                            'view' => array(
                                                          'options'=>array('rel' => 'tooltip' , 'title'=> 'Lihat sebab diagnosa'),
                                                        ),
                                    ),
                            ),
                            array(
                                    ...
                                    'buttons'=>array(
                                        'update' => array (
                                                      ...
                                                      'options'=>array('rel' => 'tooltip' , 'title'=> 'Ubah sebab diagnosa'),
                                                    ),
                                     ),
                            ),
                    array(
                        ...
                        'type'=>'raw',
                        'value'=>'($data->sebabdiagnosa_aktif)?CHtml::link("<i class=\'icon-form-silang\'></i> ","javascript:removeTemporary($data->sebabdiagnosa_id)",array("id"=>"$data->sebabdiagnosa_id","rel"=>"tooltip","title"=>"Menonaktifkan sebab diagnosa"))." ".CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->sebabdiagnosa_id)",array("id"=>"$data->sebabdiagnosa_id","rel"=>"tooltip","title"=>"Hapus sebab diangosa")):CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->sebabdiagnosa_id)",array("id"=>"$data->sebabdiagnosa_id","rel"=>"tooltip","title"=>"Hapus sebab diagnosa"));',
...
$(document).ready(function(){
        $("input[name='RKSebabDiagnosaM[sebabdiagnosa_nama]']").focus();
    }); 
</script>