...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="form-actions">
                        ...
                        <?php echo CHtml::link(Yii::t('mds','{icon} Ulang',array('{icon}'=>'<i class="icon-refresh icon-white"></i>')), 
                                    Yii::app()->createUrl($this->module->id.'/subRak/admin'), 
                        ...
                        <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Sub Rak', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),
                                                                    $this->createUrl('subRak/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
                        <?php
...
<script type="text/javascript">
    ...
    {
        document.getElementById('RKSubRak_subrak_namalainnya').value = nama.value.toUpperCase();
    }
</script>