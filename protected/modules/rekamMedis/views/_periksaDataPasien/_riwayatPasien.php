<div class="white-container">
           ...
           <table class="items table table-striped table-bordered table-condensed" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <?php
                        echo CHtml::link("<i class='icon-form-persalinan'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailPersalinan",
                    ...
                    <td colspan="2">
                        <?php
                        echo CHtml::link("<i class='icon-form-kelahiran'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailKelahiran",
                    ...
                    <td colspan="2">
                        <?php
                        echo CHtml::link("<i class='icon-form-anamnesa'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailAnamnesa",
                    ...
                    <td>
                        <?php
                        echo CHtml::link("<i class='icon-form-periksa'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailPeriksaFisik",
    ...
    //                        }
                    ...
                    <td><?php $this->renderPartial('/_periksaDataPasien/_konsulpoli', array('pendaftaran_id'=>$modKunjungan->pendaftaran_id)); echo"&nbsp &nbsp";
                                                            echo CHtml::link("<i class='icon-konsulpoli'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailKonsul",
                    ...
                    <td><?php //$this->renderPartial('/_periksaDataPasien/_tindakan', array('pendaftaran_id'=>$modKunjungan->pendaftaran_id, 'pasien_id'=>$modKunjungan->pasien_id)); ?>
                        ...
                        echo CHtml::link("<i class='icon-form-tindakan'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailTindakan",
                    ...
                    <td><?php //$this->renderPartial('/_periksaDataPasien/_terapi', array('pendaftaran_id'=>$modKunjungan->pendaftaran_id, 'pasien_id'=>$modKunjungan->pasien_id)); ?>
                            <?php 
                                ...
                                echo CHtml::link("<i class='icon-form-terapi'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailTerapi",
                    ...
                    <td><?php //$this->renderPartial('/_periksaDataPasien/_pemakaianBahan', array('pendaftaran_id'=>$modKunjungan->pendaftaran_id, 'pasien_id'=>$modKunjungan->pasien_id)); ?>
                        <?php echo CHtml::link("<i class='icon-form-pakaibahan'></i> ",  Yii::app()->createUrl("rawatJalan/daftarPasien/detailPemakaianBahan",
