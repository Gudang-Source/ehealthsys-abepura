...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->textFieldRow($model,'diagnosa_id',array('value'=>$row->diagnosa_id,'class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
        ...
        <table id="tbl-DiagnosaKeperawatan" class="table table-striped table-bordered table-condensed">
           <thead>
            ...
            <tr>
                ...
                <td>
                    <?php echo $form->textArea($DiagnosaId,"[$i]diagnosa_medis",array('value'=>$row->diagnosakeperawatan_medis,'class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>10)); ?>
                </td>
                <td>
                    <?php echo $form->textArea($DiagnosaId,"[$i]diagnosa_keperawatan",array('value'=>$row->diagnosakeperawatan_keperawatan,'class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
                </td>
               <td>
                    <?php echo $form->textArea($DiagnosaId,"[$i]diagnosa_tujuan",array('value'=>$row->diagnosakeperawatan_tujuan,'class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
                </td>
