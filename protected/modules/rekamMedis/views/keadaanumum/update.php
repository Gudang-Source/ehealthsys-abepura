<div class="white-container">
    <legend class="rim2">Ubah <b>Keadaan Umum</b></legend>
    <?php
    ...
    //                array_push($arrMenu,array('label'=>Yii::t('mds','View').' RKKeadaanumum', 'icon'=>'eye-open', 'url'=>array('view','id'=>$model->keadaanumum_id))) ;
