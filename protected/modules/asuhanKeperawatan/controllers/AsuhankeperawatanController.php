...
Yii::import('rawatInap.controller.*');
    ...
    public function actionIndex()
    {
        ...
        if(isset($_POST['SAAsuhankeperawatanT']))
        {
            ...
            try{
                ...
                for($i =0; $jumlah > $i; $i++){    
                    $modAsuhanKeperawatan[$i] = new SAAsuhankeperawatanT();
...
//                    $this->refresh();
    ...
    public function actionDetailDiagnosaKeperawatan($id){
            ...
            $modDiagnosaKeperawatanSearch = new SAAsuhankeperawatanT('search');
...
//                        ));
    ...
    public function actionAdmin()
    {
        ...
        $model=new SAAsuhankeperawatanT('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['SAAsuhankeperawatanT']))
            $model->attributes=$_GET['SAAsuhankeperawatanT'];
        ...
        public function actionRemoveTemporary($id)
    {
        ...
        {
            $model= new SAAsuhankeperawatanT;
            $model->attributes=$_REQUEST['SAAsuhankeperawatanT'];
            $judulLaporan='Data SAAsuhankeperawatanT';
