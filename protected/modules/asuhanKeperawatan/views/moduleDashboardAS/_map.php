...
setTimeout(function()
    {           
        ...
        ?>
            addMarkerToMap(<?php echo isset($map['garis_latitude']) ? $map['garis_latitude'] : $map['latitude'] ?>, <?php echo isset($map['garis_longitude']) ? $map['garis_longitude'] : $map['longitude'] ?>, '<?php echo $map['kecamatan_nama'] ?>');
        <?php }} ?>
    }, 6000);
</script>