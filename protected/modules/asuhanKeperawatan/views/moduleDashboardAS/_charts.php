...
<div class="panel panel-primary" id="charts_env">
	...
	<div class="panel-heading">
		<div class="panel-title">Rencana Keperawatan Bulan Ini</div>
		...
		<thead>
			<tr>
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Jumlah Pengkajian Keperawatan Bulan Ini</div>
				...
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Jumlah Rencana Keperawatan Bulan Ini</div>
        ...
        data: [
			...
			if(count($dataAreaChart) > 0){
				foreach ($dataAreaChart as $i => $chart) { ?>
						...
						y: <?php echo isset($chart['jumlah']) ? $chart['jumlah'] : 0; ?> }, 
				<?php } 
			}
			?>
		],
    ...
    var donut_chart = Morris.Donut({
		...
		if(count($dataDonutChart) > 0){
			foreach ($dataDonutChart as $i => $chart) { ?>
				{label: 'Jumlah Evaluasi Keperawatan Bulan Ini',value: <?php echo $chart['jumlah']; ?>},
			<?php }
		}?>
        ],
        colors: [
