...
<div class="row-fluid">
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::label('Tanggal Verifikasi','pengkajianaskep_tgl', array('class'=>'control-label')) ?>
			<div class="controls">
				<?php   
		...
		<div class="control-group ">
			...
			<div class="controls">
			   <?php echo $form->textField($model,'verifikasiaskep_no',array('placeholder'=>'Ketik No. Verifikasi', 'class'=>'span3 angkahuruf-only', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
	</div>
	<div class="span4">
