...
$form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'method'=>'get',
	'id'=>'asuhankeperawatan-info-search',
	'type'=>'horizontal',
...
<div class="row-fluid">
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::label('Tanggal Asuhan Keperawatan','tglaskep', array('class'=>'control-label')) ?>
			<div class="controls">
				<?php   
	...
	<div class="span4">
			...
			<div class="controls">
			   <?php echo $form->textField($model,'no_pendaftaran',array('placeholder'=>'Ketik No. Pendaftaran', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
		<div class="control-group ">
	...
	<div class="span4">
		<div class="control-group ">
			...
			<div class="controls">
			   <?php echo $form->textField($model,'nama_pasien',array('placeholder'=>'Ketik No. Nama Pasien', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
		<div class="control-group">
