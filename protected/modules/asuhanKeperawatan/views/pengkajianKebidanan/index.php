<div class="white-container">
    <legend class="rim2">Transaksi Pengkajian <b>Kebidanan</b></legend>
	<?php
	...
	?>
	<fieldset class="box">
		<legend class="rim">Data Pengkajian Kebidanan</legend>
...
//	?>
	<fieldset class="box">
		<legend class="rim">Pemeriksaan Penunjang</legend>
...
//			echo CHtml::htmlButton(Yii::t('mds', '{icon} Excel', array('{icon}' => '<i class="icon-pdf icon-white"></i>')), array('class' => 'btn btn-primary', 'type' => 'button', 'onclick' => 'return false', 'disabled' => true)) . "&nbsp&nbsp";
			...
			echo CHtml::htmlButton(
					Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-print"></i>')), array(
