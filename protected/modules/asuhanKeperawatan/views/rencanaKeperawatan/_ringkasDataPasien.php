...
<fieldset class="box">
    ...
    <table class="table table-condensed">
        ...
        <tr>
            ...
            <td><?php echo CHtml::textField('ASInfopengkajianaskepV[kelaspelayanan_nama]', isset($modPasien->kelaspelayanan_nama) ? $modPasien->kelaspelayanan_nama : '-', array('readonly' => true)); ?></td>
        </tr>
        <tr>
            ...
            <td><?php echo CHtml::textField('ASInfopengkajianaskepV[diagnosa_nama]', isset($modPasien->diagnosa_nama) ? $modPasien->pendidikan_nama : '-', array('readonly' => true)); ?></td>

            <td><?php echo CHtml::label('No Kamar / No Bed', 'no_kamarbed', array('class' => 'control-label')); ?></td>
            <td><?php echo CHtml::textField('ASInfopengkajianaskepV[no_kamarbed]', isset($modPasien->kamarruangan_nokamar) ? $modPasien->kamarruangan_nokamar : '' . '/' . isset($modPasien->kamarruangan_nobed) ? $modPasien->kamarruangan_nobed : '', array('readonly' => true)); ?></td>
