...
<div class="white-container">
	<div class="row-fluid">
		...
		<div class="span4">
			<div class="control-group">
				<?php echo $form->labelEx($model, 'tglresume', array('class' => 'control-label inline')) ?>
				<div class="controls">
					<?php
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					$this->widget('MyJuiAutoComplete', array(
						'name' => 'ASResumeaskepR[nama_pegawai]',
						...
						'options' => array(
							...
							'focus' => 'js:function( event, ui ) {
                                                    ...
                                                    $("#ASResumeaskepR_nama_pegawai").val( ui.item.nama_pegawai );
                                                    return false;
                                                }',
		...
		array(
			...
			'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small", 
                            ...
                            "onClick" => "
								...
								$(\"#ASResumeaskepR_nama_pegawai\").val(\"$data->nama_pegawai\");
