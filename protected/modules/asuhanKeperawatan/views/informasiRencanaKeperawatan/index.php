...
");
?>
	<legend class="rim2">Informasi <b>Rencana Keperawatan</b></legend>
		...
		<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
			...
			'columns'=>array(
				...
				array(
					'header'=>'Lihat Detail',
					'type'=>'raw',
					'value'=>'CHtml::link("<i class=\'icon-form-detail\'></i> ",  Yii::app()->controller->createUrl("/asuhanKeperawatan/InformasiRencanaKeperawatan/Detail",array("rencanaaskep_id"=>$data->rencanaaskep_id)),array("target"=>"frameDetail","rel"=>"tooltip","title"=>"Klik untuk Detail Rencana Keperawatan", "onclick"=>"window.parent.$(\'#dialogDetail\').dialog(\'open\')"));','htmlOptions'=>array('style'=>'text-align: center; width:40px')
				),
			),
