...
");
?>
	<legend class="rim2">Informasi <b>Pengkajian Keperawatan</b></legend>
 <div class="block-tabel">
	<h6>Tabel <b>Pengkajian Keperawatan</b></h6>
		<?php $this->widget('bootstrap.widgets.BootAlert'); ?>
		<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
			'id'=>'informasiasuhankeperawatan-grid',
			'dataProvider'=>$model->searchInformasiKep(),
			'template'=>"{summary}\n{items}\n{pager}",
			...
			'columns'=>array(
				...
				array(
					'header'=>'Lihat Detail',
					'type'=>'raw',
					'value'=>'CHtml::link("<i class=\'icon-form-detail\'></i> ",  Yii::app()->controller->createUrl("/asuhanKeperawatan/InformasiPengkajianAskep/Detail",array("pengkajianaskep_id"=>$data->pengkajianaskep_id)),array("target"=>"frameDetail","rel"=>"tooltip","title"=>"Klik untuk Detail Pengkajian Keperawatan", "onclick"=>"window.parent.$(\'#dialogDetail\').dialog(\'open\')"));','htmlOptions'=>array('style'=>'text-align: center; width:40px')
				),
			),
