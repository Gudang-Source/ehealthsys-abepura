<div class="row-fluid">
	<div class="span4">
		<fieldset class="box">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_frekbab', array( 'class' => 'span3 numbersOnly integer', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_keluhanbab', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextArea($modPengkajian, 'pengkajianaskep_keluhanbab', array( 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_frekbak', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_frekbak', array( 'class' => 'span3 numbersOnly integer', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_keluhanbak', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextArea($modPengkajian, 'pengkajianaskep_keluhanbak', array( 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
		</fieldset>
	</div>
	<div class="span4">
		<fieldset class="box">
			...
			<div class="control-group">
				<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_aktsehari', array('class' => 'control-label', 'onkeypress' => "return $(this).focusNextInputField(event);")) ?>
				<div class="controls">  
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo CHtml::activeTextArea($modPengkajian, 'pengkajianaskep_keluhanakt', array( 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_polatidur', array('class' => 'control-label', 'onkeypress' => "return $(this).focusNextInputField(event);")) ?>
...
<!--					<?php // echo CHtml::activeRadioButton($modPengkajian,'pengkajianaskep_polatidur', array('value' => 'Pagi')); ?> Pagi
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo CHtml::activeTextArea($modPengkajian, 'pengkajianaskep_keluhanpolatid', array( 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
		</fieldset>
	</div>
	<div class="span4">
		<fieldset class="box">
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_kulit', array('class' => 'control-label','style'=>'width:auto;' , 'onkeypress' => "return $(this).focusNextInputField(event);")) ?>
						<div class="controls"> 
				...
				<div class="span6">
					<div class="control-group">
						<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_mulut', array('class' => 'control-label', 'style'=>'width:auto;','onkeypress' => "return $(this).focusNextInputField(event);")) ?>
						<div class="controls">  
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_rambut', array('class' => 'control-label', 'style'=>'width:auto;','onkeypress' => "return $(this).focusNextInputField(event);")) ?>
						<div class="controls">  
				...
				<div class="span6">
					<div class="control-group">
						<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_genitalia', array('class' => 'control-label', 'style'=>'width:auto;','onkeypress' => "return $(this).focusNextInputField(event);")) ?>
						<div class="controls">  
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_telinga', array('class' => 'control-label', 'style'=>'width:auto;','onkeypress' => "return $(this).focusNextInputField(event);")) ?>
						<div class="controls">  
				...
				<div class="span6">
					<div class="control-group">
						<?php echo CHtml::activeLabelEx($modPengkajian, 'pengkajianaskep_kuku', array('class' => 'control-label', 'style'=>'width:auto;','onkeypress' => "return $(this).focusNextInputField(event);")) ?>
						<div class="controls">  
	...
	<div class="span4">
		<fieldset class="box">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo CHtml::activeTextArea($modPengkajian, 'pengkajianaskep_seksualitas', array( 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
		</fieldset>
	</div>
	<div class="span6">
		<fieldset class="box">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_perspenyakit', array( 'class' => 'span5', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_perssembuh', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_perssembuh', array( 'class' => 'span5', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_ekswajah', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_ekswajah', array( 'class' => 'span5', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_intelektual', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_intelektual', array( 'class' => 'span5', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::activeLabel($modPengkajian, 'pengkajianaskep_koping', array('class' => 'control-label')); ?>
				<div class="controls">
					<?php echo CHtml::activeTextField($modPengkajian, 'pengkajianaskep_koping', array( 'class' => 'span5', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
				</div>
			</div>
		</fieldset>
	</div>
