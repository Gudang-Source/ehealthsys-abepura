...
<div class="row-fluid">
	...
	<div class="span4">
		<div class="control-group ">
			...
			<div class="controls">
			   <?php echo $form->textField($model,'no_implementasi',array('placeholder'=>'Ketik No. Implementasi', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
	</div>
</div>
