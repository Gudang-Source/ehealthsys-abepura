...
class ASInfoevaluasiaskepV extends InfoevaluasiaskepV
{
	...
	public function search()
	{
        ...
        public function searchInformasiEval()
        {
            $criteria = new CDbCriteria;
            $criteria->select = "evaluasiaskep_id, no_evaluasi, evaluasiaskep_tgl, no_pendaftaran, nama_pasien, nama_pegawai, pegawai_id, ruangan_nama, kelaspelayanan_nama, ruangan_id";
            $criteria->addBetweenCondition('evaluasiaskep_tgl', $this->tgl_awal, $this->tgl_akhir);
            $criteria->compare("LOWER(no_evaluasi)",  strtolower($this->no_evaluasi), TRUE);
            ...
            $criteria->group = "evaluasiaskep_id, no_evaluasi, evaluasiaskep_tgl, no_pendaftaran, nama_pasien, nama_pegawai, pegawai_id, ruangan_nama, kelaspelayanan_nama, ruangan_id";
            $criteria->order = "evaluasiaskep_tgl DESC";
