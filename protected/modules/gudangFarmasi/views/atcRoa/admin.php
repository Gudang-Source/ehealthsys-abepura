...
<!--<div class="block-tabel">-->
	...
	'id'=>'gfatc-m-grid',
	'dataProvider'=>$model->searchatcroa(),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
...
<!--</div>-->
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Route of Adm Atc',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
