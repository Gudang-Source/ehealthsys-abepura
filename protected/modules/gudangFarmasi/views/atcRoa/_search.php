...
<div class="row-fluid">
	<div class = "span4">
            ...
            <div class="control-group">
                    <?php echo CHtml::label('Route of Adm ATC','lookup_name', array('class'=>'control-label')) ?>
                    <div class="controls">
        ...
        <div class="span4">
            <div class="control-group">
                    <?php echo CHtml::label('Route of Adm ATC Lainnya','lookup_value', array('class'=>'control-label')) ?>
                    <div class="controls">
