...
<br/>1. Gunakan tombol ini <a class="btn btn-info" href="#" disabled="disabled"><i class="icon-print icon-white"></i>Print</a> untuk mencetak halaman file.
<br/>2. Gunakan tombol ini <a class="btn btn-danger"><i class="icon-refresh icon-white"></i> Ulang </a> untuk mendaftarkan pasien selanjutnya.
...
<br/>3. Gunakan tombol ini <button class="btn btn-primary" name="yt0" type="submit">
