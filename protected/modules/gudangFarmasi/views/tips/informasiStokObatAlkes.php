...
<table border="0" style="padding :none;">
  <tr>
    <td>1. </td>
    <td>Icon <i class="icon-form-ubah"></i></i> untuk mmengubah data.</td>
  </tr>
  <tr>
    <td>3. </td>
    <td>
        Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="icon-ok icon-white"></i> Simpan        
...
Cari
</button> berfungsi untuk mencari.</td>
  </tr>
  <tr>
    <td>4. </td>
