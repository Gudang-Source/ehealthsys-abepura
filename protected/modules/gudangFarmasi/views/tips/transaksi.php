...
<i class="icon-plus-sign icon-white"></i>
   ...
   <tr>  <td>5. </td>
        <td>Gunakan tombol ini <button id="" class="btn btn-primary" type="button" name="yt3" rel="tooltip" onkeypress="" onclick="" data-original-title="Klik untuk mencari data.">
<i class="icon-search icon-white"></i>
Cari</button> berfungsi untuk mencari data</td>
 </tr>
     <tr>  <td>6. </td>
