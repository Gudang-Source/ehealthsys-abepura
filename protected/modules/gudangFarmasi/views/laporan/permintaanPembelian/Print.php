...
if ($caraPrint != 'GRAFIK')
$this->renderPartial('permintaanPembelian/_table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

$status = null;
if ($status == 'detail')
$this->renderPartial('permintaanPembelian/detailPrint', array('model'=>$model, 'caraPrint'=>$caraPrint, 'status'=>$status)); 
