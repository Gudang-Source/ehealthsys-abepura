...
<div class="search-form">
    ...
    <div class="row-fluid">
        <div class="span4">
            <?php echo CHtml::label('Tanggal Mutasi Obat', 'tgl_awal', array('class' => 'control-label')) ?>
            <div class="controls">
...
<?php $model->bln_awal = $format->formatMonthForDb($model->bln_awal); ?>
            ...
            <?php
            echo $form->dropDownListRow($model, 'ruanganasal_id', CHtml::listData(RuanganM::model()->findAll(), 'ruangan_id', 'ruangan_nama'), array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event)",
