...
<div class="white-container">
    ...
    <fieldset class="box">
        <?php $this->renderPartial('mutasiObatAlkes/_search',array('model'=>$model,'format'=>$format)); ?>
    </fieldset>
    <div class="block-tabel">
        <h6>Tabel Mutasi <b>Obat Alkes</b></h6>
        <?php $this->renderPartial('mutasiObatAlkes/_table',array('model'=>$model,'format'=>$format)); ?>
    </div>
    <div class="block-tabel">
