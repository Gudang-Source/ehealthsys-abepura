            ...
            'columns'=>array(
                    ...
                    array(
                        ...
                        'value'=>'((isset($data->tglmenyetujui))&&(isset($data->tglmengetahui)) ?
										CHtml::Link("<i class=\"icon-form-terimaobalkes\"></i>","'.$this->createUrl("PenerimaanBarang/Index").'&permintaanpembelian_id=$data->permintaanpembelian_id",
											array("class"=>"", "rel"=>"tooltip","title"=>"Klik Mendaftarkan Ke Penerimaan Obat Alkes",)) :
