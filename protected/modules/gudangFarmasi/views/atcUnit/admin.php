...
<!--<div class="block-tabel">-->
	...
	'id'=>'gfatc-m-grid',
	'dataProvider'=>$model->searchunitatc(),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		...
		array(
			'header'=>'<center>Nama Unit ATC</center>',
			'value'=>'$data->lookup_name',
			'htmlOptions'=>array('style'=>'text-align:left;'),
			'filter'=>  CHtml::activeTextField($model, 'lookup_name'),
		),
		array(
			'header'=>'<center>Nama Unit ATC Lainnya</center>',
...
<!--</div>-->
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Unit Atc',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
