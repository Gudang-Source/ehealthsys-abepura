...
Cari
</button> berfungsi untuk mencari.
        </li>
        <li>
...
Ulang
    ...
    <div class="span6">
        <li>
            Icon <i class="icon-form-terimamobat"></i></i> untuk melakukan transaksi penerimaan mutasi.
        </li>
        <li>
            Icon <i class="icon-form-detail"></i></i> untuk melihat rincian mutasi.
        </li>
    </div>
</ol>
</p>
