<tr>
    <td>
        ...
        <?php // echo CHtml::activeHiddenField($modPenawaranDetail,'[ii]persenpph',array('readonly'=>true,'class'=>'span2 integer','style'=>'width:90px;','value'=>0)); ?>
        <?php // echo CHtml::activeHiddenField($modPenawaranDetail,'[ii]persenppn',array('readonly'=>true,'class'=>'span2 integer','style'=>'width:90px;','value'=>0)); ?>
    </td>
    <td>
    ...
    <td>
        ...
        echo CHtml::activeTextField($modPenawaranDetail,'[ii]stokakhir',array('readonly'=>true,'class'=>'span2 integer','style'=>'width:90px;')); ?>
    </td>
    <td>
    ...
    <td>
        <?php echo CHtml::activeTextField($modPenawaranDetail,'[ii]qty',array('readonly'=>false,'class'=>'span2 integer','style'=>'width:90px;','onblur'=>'hitungTotal();','onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
    </td>    
    <td>
        <?php echo CHtml::activeTextField($modPenawaranDetail,'[ii]minimalstok',array('readonly'=>true,'class'=>'span2 integer','style'=>'width:90px;')); ?>
    </td>
    <td>
        <?php echo CHtml::activeTextField($modPenawaranDetail,'[ii]harganetto',array('readonly'=>false,'class'=>'span2 integer','onblur'=>'hitungTotal();','style'=>'width:90px;','onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
    </td>
    <td>
        <?php echo CHtml::activeTextField($modPenawaranDetail,'[ii]subtotal',array('readonly'=>true,'class'=>'span2 integer','style'=>'width:90px;')); ?>
    </td>
    <td>
