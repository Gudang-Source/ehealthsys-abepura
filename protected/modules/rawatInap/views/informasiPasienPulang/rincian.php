...
<table width="100%" style='margin-left:auto; margin-right:auto;'>
    <tr>
        ...
        <td>
                <label class='control-label'><?php echo CHtml::encode($modAdmisi->getAttributeLabel('tgladmisi')); ?>:</label>
            <?php echo CHtml::encode($modAdmisi->tgladmisi); ?>
            <br/>
            ...
            <br/>
                <label class='control-label'><?php echo CHtml::encode($modAdmisi->getAttributeLabel('kelaspelayanan_id')); ?>:</label>
            <?php echo CHtml::encode($modAdmisi->kelaspelayanan->kelaspelayanan_nama); ?>
            <br/>
...
<table class='table table-striped table-bordered table-condensed'>
    ...
    <tbody>
        ...
        foreach ($modRincian as $i=>$row){
            $rowspan = count(RIRinciantagihanpasienriV::model()->findAll('ruangan_id = '.$row->ruangan_id.' and pendaftaran_id = '.$row->pendaftaran_id));
