...
class RIPasienridariruanganlainV extends PasienridariruanganlainV
{
    /**
    ...
    public function searchRI()
	{
         ...
         */
        public function cekTindakanDanObat(){
            ...
            $modObatalkes = ObatalkespasienT::model()->findAllByAttributes(array('pasienadmisi_id'=>$this->pasienadmisi_id, 'ruangan_id'=>  Yii::app()->user->getState('ruangan_id')));
