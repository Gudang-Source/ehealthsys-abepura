...
$modObatAlkes = new RJObatAlkesM('searchDialog');
$modObatAlkes->unsetAttributes();
if(isset($_GET['RJObatAlkesM'])){
    $modObatAlkes->attributes = $_GET['RJObatAlkesM'];
    $modObatAlkes->jenisobatalkes_nama = $_GET['RJObatAlkesM']['jenisobatalkes_nama'];
    $modObatAlkes->satuankecil_nama = $_GET['RJObatAlkesM']['satuankecil_nama'];
}
