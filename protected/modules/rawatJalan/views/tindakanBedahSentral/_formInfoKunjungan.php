...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    'options'=>array(
		...
		$modDialogKunjungan = new RJInfokunjunganrjrdriV('searchDialogKunjungan');
		...
		if(isset($_GET['RJInfokunjunganrjrdriV'])) {
			$modDialogKunjungan->attributes = $_GET['RJInfokunjunganrjrdriV'];
		}         
