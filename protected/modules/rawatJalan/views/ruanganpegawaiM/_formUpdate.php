...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php
		...
		echo CHtml::hiddenField('pegawai_id','',array('readonly'=>true));
	...
	<div class="controls">
        ...
        <table id="tabelKasuspenyakitdiagnosa" class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                {
                    $hapus = Yii::app()->createUrl('rawatJalan/ruanganpegawaiM/Delete',array('ruangan_id'=>"$value->ruangan_id",'pegawai_id'=>"$value->pegawai_id"));
                    $tr = '<tr>';
...
function submitruanganpegawai()
{
    ...
    if(pegawai_id==''){
        ...
        $.post("${urlGetRuanganpegawai}", {instalasi_id:instalasi_id, ruangan_id:ruangan_id, pegawai_id:pegawai_id},
        function(data){
