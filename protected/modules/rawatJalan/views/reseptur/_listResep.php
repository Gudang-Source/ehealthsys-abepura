...
<table class="items table table-striped table-condensed" id="tblInputTindakan">
	...
	<td><center>
            <?php 
            if (!empty($resep->penjualanresep_id)) : echo "-";
            else : ?>
                <a onclick="hapusresep('<?php echo $resep->reseptur_id; ?>',this);return false;" rel="tooltip" href="javascript:void(0);" title="Klik untuk menghapus Reseptur"><i class="icon-trash"></i></a>
            <?php endif; ?>
        </center></td>
    </tr>
    <?php } ?>
