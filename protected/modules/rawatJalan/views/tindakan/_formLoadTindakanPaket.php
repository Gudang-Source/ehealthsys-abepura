...
//        )); ?>
    ...
    <td><?php echo CHtml::activeTextField($modTindakan, "[$i]qty_tindakan", array('onblur'=>'hitungSubtotal(this)','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'inputFormTabel integer lebar1')) ?></td>
...
<tr>
    ...
    <td colspan="3">
        <?php echo CHtml::activeTextField($modTindakan, '[0]keterangantindakan', array('readonly'=>false,'class'=>'inputFormTabel span3','placeholder'=>'Keterangan Tindakan')) ?>
    </td>
</tr> 
<?php } ?>
