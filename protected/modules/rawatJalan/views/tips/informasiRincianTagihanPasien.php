...
<table border="0" style="padding :none;">
  ...
  <tr>
    <td>2. </td>
    <td>Icon  <i class="icon-form-detail"></i> berfungsi untuk melihat rincian tagihan pasien.</td>
  </tr>
  <tr>
    <td>3. </td>
    <td>Gunakan tombol ini  <button class="btn btn-info" name="yt0" type="submit"><i class="icon-print icon-white"></i>
Print
</button> berfungsi untuk mmencetak data.
    </td>
  </tr>
