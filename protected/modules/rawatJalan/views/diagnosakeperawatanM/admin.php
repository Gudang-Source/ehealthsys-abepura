...
<?php 
        ...
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Diagnosa Keperawatan', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('diagnosakeperawatanM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('input[name="RJDiagnosakeperawatanM[diagnosa_nama]"]').focus();
    });
</script>