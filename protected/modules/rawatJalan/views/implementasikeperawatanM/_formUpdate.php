...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->textFieldRow($model,'diagnosakeperawatan_id',array('value'=>$_GET['id'], 'class'=>'span3', 'onkeypress'=>"return nextFocus(this,event,'ImplementasikeperawatanM_implementasikeperawatan_kode','ImplementasikeperawatanM_rencanakeperawatan_id','')")); ?>
           ...
           <thead>
            ...
            <tbody>
                ...
                <td>
                    ...
                    <?php echo $form->dropDownList($ImplementasiKeperawatan,"[$i]rencanakeperawatan_id",CHtml::listData(RencanakeperawatanM::model()->findAll(), 'rencanakeperawatan_id', 'rencana_kode'), array('value'=>$ImplementasiKeperawatan->rencanakeperawatan_id, 'class'=>'span2 required', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?> 
                </td>
                <td>
                    <?php echo $form->textField($ImplementasiKeperawatan,"[$i]implementasikeperawatan_kode",array('value'=>$ImplementasiKeperawatan->implementasikeperawatan_kode,'class'=>'span2 required','onkeypress'=>"return $(this).focusNextInputField(event);")); ?> 
                </td>
                <td>
                    <?php echo $form->textArea($ImplementasiKeperawatan,"[$i]implementasi_nama",array('value'=>$ImplementasiKeperawatan->implementasi_nama,'class'=>'span3 required', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>10)); ?>
                </td>
...
function addRow(obj)
{
    ...
    $('#tbl-ImplementasiKeperawatan tr:last td:last').append('$buttonMinus');
        renameInput('RJImplementasikeperawatanM','implementasikeperawatan_id');
        renameInput('RJImplementasikeperawatanM','rencanakeperawatan_id');
        renameInput('RJImplementasikeperawatanM','implementasikeperawatan_kode');
        renameInput('RJImplementasikeperawatanM','implementasi_nama');
        renameInput('RJImplementasikeperawatanM','iskolaborasiimplementasi');
