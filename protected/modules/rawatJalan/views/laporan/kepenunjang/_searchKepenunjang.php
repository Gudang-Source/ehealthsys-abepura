...
<div class="search-form" style="">
	...
	<div class="row-fluid">
		...
		<div class="span8">
			<div id='searching'>
				<fieldset class="box2">
				<legend class="rim">Berdasarkan Ruangan Penunjang <?php echo CHtml::checkBox('cek_all', true, array('value'=>'cek', 'onchange'=>'cek_all_tindakan(this)'));?></legend>
					<?php echo'<table width="100%" id="penunjang">
						<tr>
							<td>
