<div class="white-container">
    ...
    <fieldset class="box search-form">
        <?php $this->renderPartial($this->path_view.'bukuRegister/_search2',array(
            'model'=>$model,
        )); ?>
    </fieldset><!-- search-form --> 
    <div class="block-tabel row-fluid">
        <h6>Tabel <b>Buku Register</b></h6>
        <?php $this->renderPartial($this->path_view.'bukuRegister/_tableBukuRegister', array('model'=>$model)); ?>
    </div>
