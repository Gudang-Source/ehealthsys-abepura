<div class="white-container">
    ...
    <fieldset class="search-form box">
        <?php $this->renderPartial($this->path_view.'jasaInstalasi/_searchJasaInstalasi',array(
            'model'=>$model,
        )); ?>
    </fieldset><!-- search-form -->
    <div class="row-fluid block-tabel">
        <h6>Tabel <b>Jasa Instalasi</b></h6> 
        <?php $this->renderPartial($this->path_view.'jasaInstalasi/_tableJasaInstalasi', array('model'=>$model)); ?>
    </div>
    <div class="row-fluid block-tabel">
        <h6><b>Grafik</b></h6>
