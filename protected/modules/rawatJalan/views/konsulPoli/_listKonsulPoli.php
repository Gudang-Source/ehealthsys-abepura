<table class="items table table-striped table-condensed" id="tblListKonsul">
    ...
    <?php foreach ($modRiwayatKonsul as $i => $konsul) { ?>
        <tr>
            ...
            <td><?php echo $konsul->konsulpoli_id ?> <?php echo CHtml::link("<i class='icon-print'></i>", '#', array('onclick'=>'printPermintaan('.$konsul->konsulpoli_id.');return false;','rel'=>'tooltip','title'=>'Klik untuk mencetak detail konsul Poliklinik')); ?></td>
