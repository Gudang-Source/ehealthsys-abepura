...
//        $criteria->group='pendaftaran_id';
    ...
    public function searchPrint() {
     ...
     public function searchGrafik() {
        ...
        $criteria->select = 'count(t.pendaftaran_id) as jumlah, t.carabayar_nama as data, t.tindakanpelayanan_id';
        $criteria->group = 't.carabayar_nama, t.pendaftaran_id, t.tindakanpelayanan_id';
