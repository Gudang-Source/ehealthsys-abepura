...
class RJPenjualanresepT extends PenjualanresepT {
    ...
    public function searchDetailTerapi($data)
	{
		...
		$criteria->with = array('obatalkes'); //diganti dengan getObatTerapi karena yg ini menghasilkan data kosong
		...
		if(!empty($data)){
			$criteria->addCondition('t.pendaftaran_id ='.$data); 
		}
