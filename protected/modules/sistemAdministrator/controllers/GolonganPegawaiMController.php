...
class GolonganPegawaiMController extends MyAuthController
{
	...
	public function actionAdmin()
	{
		...
		$model=new SAGolonganPegawaiM('search');
	...
	{
		$model=SAGolonganPegawaiM::model()->findByPk($id);
		if($model===null)
	...
	protected function performAjaxValidation($model)
	{
       ...
       public function actionDelete()
        ...
        //                    $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('admin'));
                    ...
                    if(isset($_POST['id']))
                    {
                       $update = SAGolonganPegawaiM::model()->updateByPk($id,array('golonganpegawai_aktif'=>false));
                       if($update)
                        {
                            if (Yii::app()->request->isAjaxRequest)
                            {
        ...
        public function actionPrint()
         {
             ...
             $model= new SAGolonganPegawaiM();
             $model->attributes=$_REQUEST['SAGolonganPegawaiM'];
