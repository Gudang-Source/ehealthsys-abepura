...
class SatuanHasilLabController extends MyAuthController
{
	/**
	 * @var string the default layout for the views. Defaults to '//layouts/column2', meaning
	 * using two-column layout. See 'protected/views/layouts/column2.php'.
	 */
	public $layout='//layouts/iframe'; //diakses dari tab menu Master Pemeriksaan Laboratorium
	public $defaultAction = 'admin';
	
	public $path_view = 'sistemAdministrator.views.satuanHasilLab.';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SALookupM']))
		{
			$model->attributes=$_POST['SALookupM'];
                        $model->lookup_type = Params::LOOKUPTYPE_SATUAN_HASIL_LAB;
...
//                    $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('admin'));
        ...
        public function actionPrint()
        {
            ...
            $judulLaporan='Data Satuan Hasil Lab';
