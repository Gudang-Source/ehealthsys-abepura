...
class StatusPeriksaHasilMController extends MyAuthController
{
	/**
	...
	public $path_view = 'sistemAdministrator.views.statusPeriksaHasilM.';
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SALookupM']))
		{
			$model->attributes=$_POST['SALookupM'];
                        $model->lookup_type = Params::LOOKUPTYPE_STATUS_PERIKSA_HASIL;
...
//                    $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('admin'));
        ...
        public function actionPrint()
        {
            ...
            $judulLaporan='Data Status Periksa Hasil';
