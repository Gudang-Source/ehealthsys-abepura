<fieldset class="box">
    <legend class="rim">Tambah Therapi Obat</legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Therapi Obat ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
