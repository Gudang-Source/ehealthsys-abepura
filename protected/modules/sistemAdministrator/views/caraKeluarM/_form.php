...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	'id'=>'rdcara-keluar-m-form',
	'enableAjaxValidation'=>false,
        'type'=>'horizontal',
        'htmlOptions'=>array('onKeyPress'=>'return disableKeyPress(event)'),
        'focus'=>'#SACaraKeluarM_lookup_name',
)); ?>
	...
	<div class="form-actions">
                        ...
                        <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Cara Keluar', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),
