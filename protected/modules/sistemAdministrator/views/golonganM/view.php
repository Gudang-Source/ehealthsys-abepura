<div class="white-container">
    ...
    //                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' SAGolonganM', 'icon'=>'pencil','url'=>array('update','id'=>$model->golongan_id))) :  '' ;
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' SAGolonganM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->golongan_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
