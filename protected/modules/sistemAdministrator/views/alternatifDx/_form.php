...
<div class="form-actions">
	...
	?>
	<?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Alternatif Diagnosa', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')), $this->createUrl($this->id . '/admin', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-success')); ?>
