<fieldset class="box row-fluid">
    <legend class="rim">Ubah Tabular List</legend>
    <?php
    $this->breadcrumbs=array(
            'Ritabular List Ms'=>array('index'),
            $model->tabularlist_id=>array('view','id'=>$model->tabularlist_id),
            'Update',
    );

    $arrMenu = array();
                    array_push($arrMenu,array('label'=>Yii::t('mds','Update').' Tabular List ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
    ...
    //                array_push($arrMenu,array('label'=>Yii::t('mds','View').' Tabular List', 'icon'=>'eye-open', 'url'=>array('view','id'=>$model->tabularlist_id))) ;
