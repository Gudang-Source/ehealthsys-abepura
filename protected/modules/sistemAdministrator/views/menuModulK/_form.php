    ...
    <tr>
        ...
        <td>
            ...
            <div class="control-group">
                <?php echo CHtml::label('Url <span class="required">*</span>', 'SAMenuModulK_menu_url', array('class'=>'control-label required')) ?>
                <div class="controls">
            ...
            <?php echo $form->textFieldRow($model,'menu_urutan',array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
            <div>
