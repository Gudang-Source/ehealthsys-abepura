		...
		<td>     
			<div class='control-group'>
				...
				<div class="controls">
					...
					<?php echo CHtml::hiddenField('SABankM[rekening][1][rekening5_id]','',array('class'=>'span3'));  ?>
			...
			<div class='control-group'>
				...
				<div class="controls">
					...
					<?php echo CHtml::hiddenField('SABankM[rekening][2][rekening5_id]','',array('class'=>'span3'));  ?>
