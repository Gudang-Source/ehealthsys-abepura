<div class="row-fluid">
  <div class="span12"><legend class="rim">Tambah Penyebab Luar Cedera</legend><br />
  </div>
</div>
<?php
...
$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Penyebab Luar Cedera ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
