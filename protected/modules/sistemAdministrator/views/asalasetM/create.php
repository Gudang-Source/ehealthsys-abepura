<div class="white-container">
    <legend class="rim2">Tambah <b>Asal Aset</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Asal Aset ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
