...
<div class="form-actions">
	...
	?>
	<?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Intervensi', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')), $this->createUrl($this->id . '/admin', array('modul_id' => Yii::app()->session['modul_id'],'tab'=>($this->hasTab==TRUE)?'frame':null)), array('class' => 'btn btn-success')); ?>
