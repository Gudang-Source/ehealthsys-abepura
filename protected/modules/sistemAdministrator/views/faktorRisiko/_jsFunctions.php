<script type="text/javascript">
	function setLookup(lookup_type) {
		...
		$.ajax({
			...
			data: {faktorrisiko_id: faktorrisiko_id}, //
			dataType: "json",
	...
	function refreshTable() {
		...
		if (diagnosakep_id !== '' && faktorrisiko_nama !== '') {
			...
			$.ajax({
				type: 'GET',
				url: '<?php echo $this->createUrl('getLookup'); ?>',
				data: {diagnosakep_id: diagnosakep_id, faktorrisiko_nama: faktorrisiko_nama},
				dataType: "json",
				success: function (data) {
	...
	$(document).ready(function () {
		tambahLookup();
<?php if (!empty($model->faktorrisikodet_id)) { ?>
			setLookup('<?php echo $model->faktorrisiko_id; ?>');
<?php } ?>
