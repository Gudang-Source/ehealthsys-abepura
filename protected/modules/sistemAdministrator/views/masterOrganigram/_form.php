		...
		<div class = "span4">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<?php echo CHtml::textField('jabatan_nama',(isset($model->jabatan->jabatan_nama) ? $model->jabatan->jabatan_nama : ""),array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
				</div>	
			</div>	
...
//											'maxDate' => 'd',
	...
	<div class="form-actions">
		...
		if(strtolower($this->id) == 'index'){
			...
			echo CHtml::link(Yii::t('mds','{icon} Batal',array('{icon}'=>'<i class="icon-ban-circle icon-white"></i>')),$this->createUrl($action,array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));
		}
		?>
	...
	$this->widget('ext.bootstrap.widgets.BootGridView',array( 
		...
		'columns'=>array(
			...
			array(
				...
				'filter'=>  CHtml::activeDropDownList($modPegawai, 'jabatan_id', CHtml::listData(SAJabatanM::model()->getJabatanItems(),'jabatan_id','jabatan_nama'),array('empty'=>'')),
			),
			'nomorindukpegawai',
			'gelardepan',
			'nama_pegawai', 
			array(
				'name'=>'jeniskelamin',
				'filter'=>  CHtml::activeDropDownList($modPegawai, 'jeniskelamin', LookupM::getItems(Params::LOOKUPTYPE_JENIS_KELAMIN),array('empty'=>'')),
			),
		),
