		...
		<tr>
			<td>
				...
				<div class='control-group'>
					...
					<div class="controls">
						<?php echo CHtml::hiddenField('SABankRekM[rekening][1][saldonormal]','D', array('readonly'=>true));  ?>
				...
				<div class='control-group'>
					...
					<div class="controls">
						<?php echo CHtml::hiddenField('SABankRekM[rekening][2][saldonormal]','K', array('readonly'=>true));  ?>
