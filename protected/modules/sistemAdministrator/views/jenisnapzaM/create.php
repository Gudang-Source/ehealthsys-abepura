<fieldset class="box row-fluid">
  <legend class="rim">Tambah Jenis Napza</legend>
    <?php
    ...
    $arrMenu = array();
                    array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Jenis Napza ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
