<tr>
	<td style="text-align: center;">
		...
		<?php echo CHtml::activeTextField($model, '[ii]indikatorimplkepdet_indikator',array('class'=>'span12'));?>
	</td>
	<td style="text-align: center;">
		<?php echo CHtml::activeCheckBox($model,'[ii]indikatorimplkepdet_aktif', array('onkeypress'=>"return $(this).focusNextInputField(event);","onClick"=>'cek(this);','checked'=>'checked')); ?>
	</td>
