...
<div class="row-fluid">
    ...
    <div class="span4">
        ...
        <?php echo $form->textFieldRow($model,'alatmedis_kode',array('class'=>'span3','maxlength'=>2)); ?>
    </div>
    <div class="span4">
        <?php echo $form->textFieldRow($model,'alatmedis_format',array('class'=>'span3','maxlength'=>10)); ?>
