...
//                ),
        ...
        array(
            'header'=>'Hapus',
            'type'=>'raw',
            'value'=>'($data->lokasirak_aktif)?CHtml::link("<i class=\'icon-remove\'></i> ","javascript:removeTemporary($data->lokasirak_id)",array("id"=>"$data->lokasirak_id","rel"=>"tooltip","title"=>"Menonaktifkan"))." ".CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->lokasirak_id)",array("id"=>"$data->lokasirak_id","rel"=>"tooltip","title"=>"Hapus")):CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->lokasirak_id)",array("id"=>"$data->lokasirak_id","rel"=>"tooltip","title"=>"Hapus"));',
...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Lokasi Rak', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
