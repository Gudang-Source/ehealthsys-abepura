<!--<fieldset class="box">-->
    <!--<legend class="rim">Lihat Kelompok Pemeriksaan Laboratorium</legend>-->
    <?php
...
//                    array_push($arrMenu,array('label'=>Yii::t('mds','View').' Kelompok Pemeriksaan Laboratorium '/*.$model->lookup_id*/, 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
    ...
    <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Kelompok Pemeriksaan Laboratorium', array('{icon}'=>'<i class="icon-file icon-white"></i>')), $this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp";
