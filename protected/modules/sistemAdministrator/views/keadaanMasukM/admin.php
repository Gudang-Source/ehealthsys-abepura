...
$arrMenu = array();
				(Yii::app()->user->checkAccess(Params::DEFAULT_ADMIN)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' Keadaan Masuk ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) :  '' ;
...
$('.search-button').click(function(){
		$('.search-form').toggle();
	$('#SAKeadaanMasukM_lookup_name').focus();
		return false;
});
...
<!--<div class="block-tabel">-->
	<!--<h6>Tabel <b>Keadaan Masuk</b></h6>-->
	<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
		'id'=>'rdkeadaan-masuk-m-grid',
		'dataProvider'=>$model->searchKeadaanMasuk(),
		'filter'=>$model,
		'template'=>"{summary}\n{items}\n{pager}",
...
//                ),
				array(
						...
						'buttons'=>array(
						'view' => array (
										  'options'=>array('title'=>'Lihat keadaan masuk'),
										),
						),
				),
				array(
						...
						'buttons'=>array(
							'update' => array (
										  ...
										  'options'=>array('title'=>'Ubah keadaan masuk'),
										),
						 ),
				),
				array(
    ...
    <?php 
    echo CHtml::link(Yii::t('mds','{icon} Tambah Keadaan Masuk',array('{icon}'=>'<i class="icon-plus icon-white"></i>')), 
