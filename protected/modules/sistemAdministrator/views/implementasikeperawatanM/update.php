...
//                    array_push($arrMenu,array('label'=>Yii::t('mds','Update').' Implementasi Keperawatan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
    ...
    <?php echo $this->renderPartial($this->path_view.'_formUpdate',array('model'=>$model,'modImplementasiKeperawatan'=>$modImplementasiKeperawatan, 'modDiagnosakeperawatan'=>$modDiagnosakeperawatan)); ?>
</div>