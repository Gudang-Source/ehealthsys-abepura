...
<table width="100%">
    <tr>
        <td>
            <?php echo $form->dropDownListRow($model,'jenisnapza_id',CHtml::listData(JenisnapzaM::model()->findAll(), 'jenisnapza_id', 'jenisnapza_nama'),array('class'=>'span3 required', 'onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            ...
            <?php //echo $form->textFieldRow($model,'jenisnapza_id',array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
