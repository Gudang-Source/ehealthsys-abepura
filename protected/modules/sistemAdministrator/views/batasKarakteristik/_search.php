...
<table>
    ...
    <tr>
		<td>
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $form->textField($model, 'bataskarakteristikdet_indikator', array('class' => 'span3', 'maxlength' => 50)); ?>
				</div>
			</div>
        </td>
	...
	<tr>
		<td>
			<?php echo $form->checkBoxRow($model, 'bataskarakteristikdet_aktif', array('checked' => 'bataskarakteristikdet_aktif')); ?>
        </td>
	</tr>
</table>
