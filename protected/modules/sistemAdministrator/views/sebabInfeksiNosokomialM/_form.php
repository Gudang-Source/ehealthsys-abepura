...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'enableAjaxValidation'=>false,
        ...
        'focus'=>'#RMSebabInfeksiNosokomialM_sebabin_nama',
)); ?>
	...
	<div class="form-actions">
                        ...
                        <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Sebab Infeksi', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),
...
<script type="text/javascript">
    ...
    {
        document.getElementById('RMSebabInfeksiNosokomialM_sebabin_namalainnya').value = nama.value.toUpperCase();
    }
</script>