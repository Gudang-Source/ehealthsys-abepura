<div class="row-fluid">
  <div class="span12"><legend class="rim">Tambah Sebab Infeksi</legend><br />
  </div>
</div>
...
$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Sebab Infeksi Nosokomial ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
