...
$('.search-button').click(function(){
	$('.search-form').toggle();
    $('#RMSebabInfeksiNosokomialM_sebabin_nama').focus();
	return false;
});
...
//                ),
        ...
        array(
            'header'=>'Hapus',
            'type'=>'raw',
            'value'=>'($data->sebabin_aktif)?CHtml::link("<i class=\'icon-remove\'></i> ","javascript:removeTemporary($data->sebabin_id)",array("id"=>"$data->sebabin_id","rel"=>"tooltip","title"=>"Menonaktifkan"))." ".CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->sebabin_id)",array("id"=>"$data->sebabin_id","rel"=>"tooltip","title"=>"Hapus")):CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->sebabin_id)",array("id"=>"$data->sebabin_id","rel"=>"tooltip","title"=>"Hapus"));',
...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Sebab Infeksi', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('sebabInfeksiNosokomialM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
