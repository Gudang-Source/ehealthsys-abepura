<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'nominaltunjangan',array('class'=>'span3 integer2')); ?>
	<?php echo $form->checkBoxRow($model,'tunjangan_aktif',array('checked'=>'tunjangan_aktif')); ?>
