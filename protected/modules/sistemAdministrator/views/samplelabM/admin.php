<div class="white-container">
    <legend class="rim2">Pengaturan <b>Sampel Laboratorium</b></legend>
            ...
            $arrMenu = array();
            //                (Yii::app()->user->checkAccess(Params::DEFAULT_ADMIN)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' Sampel Lab ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) :  '' ;
            ...
            $('.search-button').click(function(){
                    $('.search-form').toggle();
                $('#LKSamplelabM_samplelab_nama').focus();
                    return false;
            });
            ...
            <!--<div class="block-tabel">-->
                <!--<h6>Tabel <b>Sampel Lab</b></h6>-->
                <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
                    'id'=>'lksamplelab-m-grid',
    ...
    <!--</div>-->
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Sampel Lab', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";        
...
{
    $("#lksamplelab-m-search :input[name='"+ obj.name +"']").val(obj.value);
}     
function print(caraPrint)
{
    window.open("${urlPrint}/"+$('#lksamplelab-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
...
$(document).ready(function(){
        $("input[name='SASamplelabM[samplelab_nama]']").focus();
});
</script>