<div class="white-container">
    <legend class="rim2">Tambah <b>Sampel Laboratorium</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Sampel Lab ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
