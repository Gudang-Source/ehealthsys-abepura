<div class="view">
	...
	<?php echo $this->renderPartial($this->path_view.'_kasusPenyakit',array('ruangan_id'=>$data->ruangan_id),true)?>
        <br />
        <b><?php echo CHtml::encode('Kelas','Kelas'); ?>:</b>
	<?php echo $this->renderPartial($this->path_view.'_kelasPelayanan',array('ruangan_id'=>$data->ruangan_id),true)?>
	<br />
        <b><?php echo CHtml::encode('Daftar Tindakan','Daftar Tindakan'); ?>:</b>
	<?php echo $this->renderPartial($this->path_view.'_daftarTindakan',array('ruangan_id'=>$data->ruangan_id),true)?>
	<br />
        <b><?php echo CHtml::encode('Pegawai','Pegawai'); ?>:</b>
	<?php echo $this->renderPartial($this->path_view.'_ruanganPegawai',array('ruangan_id'=>$data->ruangan_id),true)?>
	<br />
