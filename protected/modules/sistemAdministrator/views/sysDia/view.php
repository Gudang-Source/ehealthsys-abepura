...
//                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' SASysdiaM', 'icon'=>'pencil','url'=>array('update','id'=>$model->sysdia_id))) :  '' ;
//                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' SASysdiaM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->sysdia_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
