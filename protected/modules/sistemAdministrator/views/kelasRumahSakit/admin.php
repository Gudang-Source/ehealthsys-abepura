...
<br><br>
<legend class="rim">Tabel Kelas Rumah Sakit</legend>
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'gfatc-m-grid',
	'dataProvider'=>$model->searchLookupMasterRS('kelas_rumahsakit'),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		...
		array(
			'header'=>'<center>Nama Kelas Rumah Sakit</center>',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Kelas Rumah Sakit',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
