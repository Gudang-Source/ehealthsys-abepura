<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="row-fluid">
		<div class = "span6">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $form->dropDownList($model,'lookup_value',LookupM::getItems('namakepemilikanrs'),
	...
	<div class="form-actions">
		...
		<?php echo CHtml::link(Yii::t('mds','{icon} Pengaturan Kelas Rumah Sakit',array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
