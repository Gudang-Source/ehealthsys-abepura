...
//                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' SASubrakM', 'icon'=>'pencil','url'=>array('update','id'=>$model->subrak_id))) :  '' ;
//                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' SASubrakM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->subrak_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
