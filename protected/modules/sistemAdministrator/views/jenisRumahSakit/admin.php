...
<br><br>
<legend class="rim">Tabel Jenis Rumah Sakit</legend>
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'gfatc-m-grid',
	'dataProvider'=>$model->searchLookupMasterRS('jenisrs_profilrs'),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		...
		array(
			'header'=>'<center>Jenis Rumah Sakit</center>',
			'value'=>'$data->lookup_name',
			'htmlOptions'=>array('style'=>'text-align:left;'),
		),
		array(
			'header'=>'<center>Jenis Rumah Sakit Lainnya</center>',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Jenis Rumah Sakit',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
