<div class="white-container">
    <legend class="rim2">Pengaturan <b>Status Hasil Periksa Laboratorium</b></legend>
            ...
            $arrMenu = array();
                            (Yii::app()->user->checkAccess(Params::DEFAULT_ADMIN)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' Satuan Periksa Hasil ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) :  '' ;
                            //array_push($arrMenu,array('label'=>Yii::t('mds','List').' Satuan Periksa Hasil', 'icon'=>'list', 'url'=>array('index'))) ;
            //                (Yii::app()->user->checkAccess(Params::DEFAULT_CREATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Satuan Periksa Hasil', 'icon'=>'file', 'url'=>array('create'))) :  '' ;
            ...
            $('.search-button').click(function(){
                    $('.search-form').toggle();
                $('#LKStatusPeriksaHasilM_lookup_name').focus();
                    return false;
            });
            ...
            <!--<div class="block-tabel">-->
                <!--<h6>Tabel Status <b>Hasil Periksa</b></h6>-->
                <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
                    'id'=>'rdkeadaan-masuk-m-grid',
                    'dataProvider'=>$model->searchStatusPeriksaHasil(),
                    'filter'=>$model,
                    'template'=>"{summary}\n{items}\n{pager}",
    ...
    <!--</div>-->
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Status Hasil Periksa', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";        
