<fieldset class="box">
    <legend class="rim">Tambah Lokasi Gudang</legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Lokasi Gudang ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
