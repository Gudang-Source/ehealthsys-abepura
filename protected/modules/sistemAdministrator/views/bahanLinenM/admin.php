...
<div class="white-container">
	<legend class="rim2">Pengaturan <b>Bahan Linen</b></legend>
...
<!--</div>-->
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Bahan Linen',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
...
{
    $("#sabahanlinen-m-search :input[name='"+ obj.name +"']").val(obj.value);
}
