<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="row-fluid">
		...
		<div class = "span4">			
			<?php echo $form->textFieldRow($model,'bahanlinen_nama',array('class'=>'span4', 'onkeyup'=>"return $(this).focusNextInputField(event);",'size'=>200, 'maxlength'=>200)); ?>
			<?php echo $form->textFieldRow($model,'bahanlinen_namalain',array('class'=>'span4', 'onkeyup'=>"return $(this).focusNextInputField(event);",'size'=>200, 'maxlength'=>200)); ?>
