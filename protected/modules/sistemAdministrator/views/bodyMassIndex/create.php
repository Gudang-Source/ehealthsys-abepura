<div class="row-fluid">
  <div class="span12"><legend class="rim">Tambah Body Mass Index</legend><br />
  </div>
</div>
...
$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Body Mass Index ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
