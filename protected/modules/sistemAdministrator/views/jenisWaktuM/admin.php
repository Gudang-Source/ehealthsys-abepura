<div class="white-container">
        ...
        'template'=>"{summary}\n{items}\n{pager}",
            'columns'=>array(
                    ...
                    array(
                        ...
                        'filter'=>CHtml::activeTextField($model, 'jeniswaktu_nama'),
                    ),
                    'jeniswaktu_namalain',
                    array(
                        'header'=>'Jam',
    ...
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Jenis Waktu', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('/sistemAdministrator/JenisWaktuM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
...
{
    $("#sajeniswaktu-m-search :input[name='"+ obj.name +"']").val(obj.value);
}
function print(caraPrint)
{
    window.open("${urlPrint}/"+$('#sajeniswaktu-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
...
<script type="text/javascript">
    ...
    $('.filters #JenisWaktuM_jeniswaktu_nama').focus();
</script>