	...
	<div class="row-fluid">
		<div class = "span6">
			...
			<div class="control-group">
				<?php echo CHtml::label('Nama Status Akreditasi <span class="required">*</span>','lookup_name', array('class'=>'control-label required')) ?>
				<div class="controls">
					<?php echo $form->textField($model,'lookup_name',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>100)); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::label('Nama Lain Status Akreditasi <span class="required">*</span>','lookup_value', array('class'=>'control-label required')) ?>
				<div class="controls">
