...
<br><br>
<legend class="rim">Tabel Status Akreditasi</legend>
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'gfatc-m-grid',
	'dataProvider'=>$model->searchLookupMasterRS('statusakreditasrs'),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		...
		array(
			'header'=>'<center>Status Akreditasi</center>',
			'value'=>'$data->lookup_name',
			'htmlOptions'=>array('style'=>'text-align:left;'),
		),
		array(
			'header'=>'<center>Status Akreditasi Lainnya</center>',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Status Akreditasi',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
