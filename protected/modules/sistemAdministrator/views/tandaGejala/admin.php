<div class="white-container">
    <legend class="rim2">Pengaturan <b>Tanda dan Gejala</b></legend>
	<?php
    ...
    <div class='block-tabel'>
        <h6>Tabel <b>Tanda dan Gejala</b></h6>
		<?php
		...
		$this->widget('ext.bootstrap.widgets.BootGridView', array(
			...
			'columns' => array(
				...
				array(
					'header' => 'Indikator',
					'name' => 'tandagejala_indikator',
					'value' => 'isset($data->tandagejala_indikator) ? $data->tandagejala_indikator : " - "',
				),
				array(
					'header' => 'Status',
				...
				array(
					...
					'type' => 'raw',
					'value' => '($data->tandagejala_aktif)?CHtml::link("<i class=\'icon-form-silang\'></i> ","javascript:removeTemporary($data->tandagejala_id)",array("id"=>"$data->tandagejala_id","rel"=>"tooltip","title"=>"Menonaktifkan Tanda dan Gejala"))." ".CHtml::link("<i class=\'icon-form-sampah\'></i> ", "javascript:deleteRecord($data->tandagejala_id)",array("id"=>"$data->tandagejala_id","rel"=>"tooltip","title"=>"Hapus Tanda dan Gejala")):CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->tandagejala_id)",array("id"=>"$data->tandagejala_id","rel"=>"tooltip","title"=>"Hapus Tanda dan Gejala"));',
