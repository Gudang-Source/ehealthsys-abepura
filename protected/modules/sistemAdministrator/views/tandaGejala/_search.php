...
<table>
    ...
    <tr>
		<td>
			<div class="control-group">
				<?php echo Chtml::label('Indikator', 'tandagejala_indikator', array('class' => 'control-label')) ?>
				<div class="controls">
					<?php echo $form->textField($model, 'tandagejala_indikator', array('class' => 'span3', 'maxlength' => 50)); ?>
				</div>
			</div>
        </td>
	...
	<tr>
		<td>
			<?php echo $form->checkBoxRow($model, 'tandagejala_aktif', array('checked' => 'tandagejala_aktif')); ?>
        </td>
	</tr>
</table>
