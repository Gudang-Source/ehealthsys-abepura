<div class="white-container">
    <legend class="rim2">Tambah <b>Kategori Tindakan</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Kategori Tindakan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
