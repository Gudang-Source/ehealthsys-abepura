...
<br><br>
<legend class="rim">Tabel Kepemilikan Rumah Sakit</legend>
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'gfatc-m-grid',
	'dataProvider'=>$model->searchLookupMasterRS('namakepemilikanrs'),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		...
		array(
			'header'=>'<center>Kepemilikan Rumah Sakit</center>',
			'value'=>'$data->lookup_name',
			'htmlOptions'=>array('style'=>'text-align:left;'),
		),
		array(
			'header'=>'<center>Kepemilikan Rumah Sakit Lainnya</center>',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Kepemilikan Rumah Sakit',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
