<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="row-fluid">
		<div class = "span6">
			...
			<div class="control-group">
				<?php echo CHtml::label('Nama Lain Kepemilikan Rumah Sakit <span class="required">*</span>','lookup_value', array('class'=>'control-label required')) ?>
				<div class="controls">
	...
	<div class="form-actions">
		...
		<?php echo CHtml::link(Yii::t('mds','{icon} Pengaturan Kepemilikan Rumah Sakit',array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
