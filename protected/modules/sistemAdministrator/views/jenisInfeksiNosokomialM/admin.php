...
$('.search-button').click(function(){
	$('.search-form').toggle();
    $('#RMJenisInfeksiNosokomialM_jenisin_nama').focus();
	return false;
});
...
//                ),
        ...
        array(
            'header'=>'Hapus',
            'type'=>'raw',
            'value'=>'($data->jenisin_aktif)?CHtml::link("<i class=\'icon-remove\'></i> ","javascript:removeTemporary($data->jenisin_id)",array("id"=>"$data->jenisin_id","rel"=>"tooltip","title"=>"Menonaktifkan"))." ".CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->jenisin_id)",array("id"=>"$data->jenisin_id","rel"=>"tooltip","title"=>"Hapus")):CHtml::link("<i class=\'icon-trash\'></i> ", "javascript:deleteRecord($data->jenisin_id)",array("id"=>"$data->jenisin_id","rel"=>"tooltip","title"=>"Hapus"));',
...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Jenis Infeksi', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('jenisInfeksiNosokomialM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
