...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'enableAjaxValidation'=>false,
        ...
        'focus'=>'#RMJenisInfeksiNosokomialM_jenisin_nama',
)); ?>
	...
	<div class="form-actions">
                        ...
                        <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Jenis Infeksi', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),
                                                                    $this->createUrl('jenisInfeksiNosokomialM/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
...
<script type="text/javascript">
    ...
    {
        document.getElementById('RMJenisInfeksiNosokomialM_jenisin_namalainnya').value = nama.value.toUpperCase();
    }
</script>