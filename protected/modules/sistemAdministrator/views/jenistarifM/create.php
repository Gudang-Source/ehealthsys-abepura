<div class="white-container">
    <legend class="rim2">Tambah <b>Jenis Tarif</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Jenis Tarif ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
