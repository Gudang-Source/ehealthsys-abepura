...
<legend class='rim'>Tabel Sub Sub Kelompok</legend>
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	...
	'columns'=>array(
		...
		array(
                        'name'=>'subkelompok_id',
                        'filter'=> CHtml::dropDownList('SASubsubkelompokM[subkelompok_id]',$model->subkelompok_id,CHtml::listData($model->SubKelompokItems, 'subkelompok_id', 'subkelompok_nama'), array('empty'=>'--Pilih--')),
