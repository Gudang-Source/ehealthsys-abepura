	...
	<?php echo $form->errorSummary($model); ?>
        <table>
            <tr>
                ...
                <td>
                    <?php echo $form->textFieldRow($model,'carabayar_loket',array('class'=>'span2', 'onkeypress'=>"return nextFocus(this,event,'SACaraBayarM_metode_pembayaran','SACaraBayarM_carabayar_nama')", 'maxlength'=>50)); ?>
