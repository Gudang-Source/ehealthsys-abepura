<div class="white-container">
    <legend class="rim2">Tambah <b>Cara Bayar</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Cara Bayar ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
