...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'enableAjaxValidation'=>false,
        ...
        'focus'=>'#RMMorfologiNeoplasmaM_morfologineoplasma_nama',
)); ?>
...
<script type="text/javascript">
    ...
    {
        document.getElementById('RMMorfologiNeoplasmaM_morfologineoplasma_namalainnya').value = nama.value.toUpperCase();
    }
</script>