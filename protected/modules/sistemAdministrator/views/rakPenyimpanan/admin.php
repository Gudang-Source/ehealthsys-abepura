...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('sarakpenyimpanan-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<!--<div class="white-container">-->
	<!--<legend class="rim2">Pengaturan <b>Rak Penyimpanan</b></legend>-->
	...
	<!--<div class="block-tabel">-->
		<!--<h6 class="rim2">Tabel SARakpenyimpananM</h6>-->
	<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
		'id'=>'sarakpenyimpanan-m-grid',
...
<!--</div>-->
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Rak Penyimpanan',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
...
{
    $("#sarakpenyimpanan-m-search :input[name='"+ obj.name +"']").val(obj.value);
}
function print(caraPrint)
{
    window.open("${urlPrint}/"+$('#sarakpenyimpanan-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
