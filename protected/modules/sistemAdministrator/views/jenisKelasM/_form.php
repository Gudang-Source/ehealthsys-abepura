...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->textFieldRow($model,'jeniskelas_namalainnya',array('class'=>'span3', 'onkeypress'=>"return nextFocus(this,event,'btn_simpan','SAJenisKelasM_jeniskelas_nama')", 'maxlength'=>25)); ?>
            <?php //echo $form->checkBoxRow($model,'jeniskelas_aktif', array('onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
