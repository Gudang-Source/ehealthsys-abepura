...
<div class="row-fluid">
	...
	<div class = "span6">
		...
		<div class="control-group">
			<?php echo CHtml::label('Nama Tahapan Akreditasi','lookup_name', array('class'=>'control-label')) ?>
			<div class="controls">
				<?php echo $form->textField($model,'lookup_name',array('class'=>'span3')); ?>
			</div>
		</div>
		<div class="control-group">
			<?php echo CHtml::label('Nama Lain Tahapan Akreditasi','lookup_value', array('class'=>'control-label')) ?>
			<div class="controls">
