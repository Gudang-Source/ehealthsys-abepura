<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="row-fluid">
		<div class = "span6">
			<?php echo CHtml::activeHiddenField($model,'lookup_type',array('class'=>'span3','value'=>'pentahapanakreditasrs')); ?>
			<div class="control-group">
				<?php echo CHtml::label('Nama Tahapan Akreditasi <span class="required">*</span>','lookup_name', array('class'=>'control-label required')) ?>
				<div class="controls">
					<?php echo $form->textField($model,'lookup_name',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>100)); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo CHtml::label('Nama Lain Tahapan Akreditasi <span class="required">*</span>','lookup_value', array('class'=>'control-label required')) ?>
				<div class="controls">
	...
	<div class="form-actions">
		...
		<?php echo CHtml::link(Yii::t('mds','{icon} Pengaturan Tahapan Akreditasi',array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
