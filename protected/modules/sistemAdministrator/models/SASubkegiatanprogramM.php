...
class SASubkegiatanprogramM extends SubkegiatanprogramM {
	...
	{
		return Rekening5M::model()->findAllByAttributes(array('rekening5_nb'=>'D','rekening5_aktif'=>true),array('order'=>'nmrekening5'));
	}
	/*
	...
	{
		return Rekening5M::model()->findAllByAttributes(array('rekening5_nb'=>'K','rekening5_aktif'=>true),array('order'=>'nmrekening5'));
	}
}
