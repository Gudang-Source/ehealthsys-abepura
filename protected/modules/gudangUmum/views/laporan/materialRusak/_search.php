                ...
                <td> 
                    ...
                    <fieldset>    
                        <?php $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
                            ...
                            'content'=>array(
                            'content1'=>array(
                                'header'=>'Berdasarkan Kondisi Barang',
                                'isi'=>  '  <table><tr></tr></table>
                                            <table class="kondisi">                                            
                                            <tr>
                                                    <td><div class="controls">'.CHtml::hiddenField('filter', 'kondisi').
                                                            CHtml::checkBox('pilihSemua', true, array('onclick'=>'checkAllKondisi();')).'<label><b>Pilih Semua</b></label>
                                                            <div id="checkBoxKondisi">
                                                                '.$form->checkBoxList($model,'kondisi_barang', 
                                                                CHtml::listData(LookupM::model()->findAll("lookup_type = 'inventariskeadaan' AND lookup_aktif = TRUE AND lookup_name <> 'Baik' ORDER BY lookup_urutan ASC "), 'lookup_name', 'lookup_value'), 
                                                                        array('class'=>'suplier')).'<br>
                                                            </div>                
                                                        </div>
                                                    </td>
                                            </tr>
