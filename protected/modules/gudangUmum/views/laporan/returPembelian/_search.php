            ...
            display:inline-block;
                    ...
                    <div class="row-fluid">
                        <div class="span4">
                            ...
                            <?php echo CHtml::label('Tanggal Retur', 'tglterimabahan', array('class' => 'control-label')) ?>
                            <div class="controls">
                        ...
                        <div class = "span12">
                            <div class = "control-group">
                                ...
                                <div class="controls">
                                    <?php echo $form->textField($model,'nofaktur',array('class'=>'span3 '))?>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                    <td><div class="controls">'.CHtml::hiddenField('filter', 'supplier').
                                                            ...
                                                            <div id="checkBoxSupplier">
                                                                '.$form->checkBoxList($model,'supplier_id', CHtml::listData(SupplierM::model()->findAll("supplier_aktif = TRUE ORDER BY supplier_nama ASC"), 'supplier_id', 'supplier_nama'), array('class'=>'suplier')).'<br>
                                                            </div>                
                                                        </div>
                                                    </td>
                                            </tr>
