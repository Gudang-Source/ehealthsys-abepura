<tr>   
    ...
    <td><?php echo CHtml::activeTextField($modDetail, '[]qty_pesan', array('class'=>'span1','readonly'=>true, 'style'=>'text-align:right;')).' '.$modDetail->satuanbrg; ?></td>
    <?php //} ?>
    <td><?php echo CHtml::activeTextField($modDetail, '[]qty_mutasi', array('class'=>'span1 numbersOnly mutasi', 'onblur'=>'cekStok(this);', 'style'=>'text-align:right;')).' '.$modDetail->satuanbrg; ?></td>
