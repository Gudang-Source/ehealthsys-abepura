...
<table border="0" style="padding :none;">
  ...
  <tr>
    <td>2. </td>
    <td>Icon <i class="icon-form-detail"></i> berfungsi untuk menampilkan detail pemesanan barang.</td>
  </tr>
  <tr>
    <td>3. </td>
    <td>Icon <i class="icon-form-mutasi"></i> berfungsi untuk untuk melanjutkan ke mutasi.</td>
  </tr>
  <tr>
    <td>4. </td>
