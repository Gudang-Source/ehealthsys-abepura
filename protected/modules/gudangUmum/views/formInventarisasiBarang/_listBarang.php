...
<div id="form-carikata">
	<?php echo CHtml::textField('carikata',"",array('class' => 'custom-only','onkeyup'=>'return $(this).focusNextInputField(event);','onblur'=>'cariKata();','placeholder'=>'Ketik kata yang akan dicari')) ?>
	...
	'columns'=>array(
		...
		array(
			...
			'value'=> function($data) {
				...
				return CHtml::textField("GUBarangV[".$data->barang_id."][subtotal]", ($total * $harga), array("class"=>"subtotal span2 integer2", "readonly"=>true));
			},
                )
    ),
