<div class="white-container">
	<legend class="rim2">Transaksi <b>Formulir Inventarisasi Barang</b></legend>
	<?php 
    ...
    if(isset($_GET['sukses'])){
        Yii::app()->user->setFlash('success',"Data Formulir Inventarisasi Barang berhasil disimpan !");
    }
    ?>
	...
	<fieldset class="box" id="form-inventarisasi-barang">
        <legend class="rim"><span class='judul'>Data Formulir Inventarisasi Barang</span></legend>
        <p class="help-block"><?php echo Yii::t('mds', 'Fields with <span class="required">*</span> are required.') ?></p>
        <?php echo $form->errorSummary($model); ?>
        <div>
            <?php $this->renderPartial($this->path_view.'_formFormulirInventarisasi', array('form'=>$form,'format'=>$format,'model'=>$model)); ?>
        </div>
    </fieldset>
