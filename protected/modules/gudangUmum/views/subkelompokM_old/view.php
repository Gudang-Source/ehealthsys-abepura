<div class='white-container'>
    <legend class='rim2'>Lihat <b>Sub Kelompok</b></legend>
    <?php
    ...
    //                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' GUSubkelompokM', 'icon'=>'pencil','url'=>array('update','id'=>$model->subkelompok_id))) :  '' ;
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' GUSubkelompokM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->subkelompok_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
