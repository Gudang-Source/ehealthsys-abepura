...
function addRow(obj)
{
    ...
    renameInput('GURuanganM','ruangan_nama');
    renameInput('GURuanganM','ruangan_namalainnya');
    renameInput('GURuanganM','ruangan_lokasi');

    renameInput('GURuanganM','ruangan_singkatan');
    renameInput('GURuanganM','ruangan_jenispelayanan');
    renameInput('GURuanganM','ruangan_fasilitas');
    renameInput('GURuanganM','ruangan_image');
