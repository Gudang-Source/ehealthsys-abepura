<tr>   
   ...
   <!-- <td><?php //echo $modBarang->subsubkelompok->subkelompok->kelompok->bidang->bidang_nama; ?></td>
    ...
    <td><?php echo CHtml::activeTextField($modDetail, '[]jmlterima', array('class'=>'span1 integer2 qty', 'onblur'=>'setTotalHarga();',  'style'=>'text-align: right' )).' '.$modBarang->barang_satuan;; ?></td>
