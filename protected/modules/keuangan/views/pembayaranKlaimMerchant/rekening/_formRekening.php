 ...
 */
?>
<legend class="rim">Jurnal Rekening Pembayaran Klaim Merchant</legend>
...
//        $modRekenings[0]=new RekeningpembayarankasirV(); //<<untuk menampilkan baris pertama blank
        $this->renderPartial('akuntansi.views.pembayaranKlaimMerchant.rekening._rowRekening',array('form'=>$form, 'modRekenings'=>$modRekenings)); ?>
    </tbody>
</table>
</div>
<?php 
...
$this->widget('ext.bootstrap.widgets.GroupGridView',array(
...
?>
<?php $this->renderPartial('akuntansi.views.pembayaranKlaimMerchant.rekening._jsFunctions',array('form'=>$form, 'modRekenings'=>$modRekenings)); ?>
