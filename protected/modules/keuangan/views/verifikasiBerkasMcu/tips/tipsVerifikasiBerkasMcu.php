<ol class="row-fluid">
    <div class="span6">
        ...
        <li>
            Icon <i class="icon-edit"></i> berfungsi untuk melakukan verifikasi berkas.
        </li>
        <li>
    ...
    <div class="span6">
        ...
        <li>
            ...
            berfungsi untuk melakukan pemanggilan ulang.
        </li>
        <li>
        ...
        <li>
            ...
            berfungsi untuk mencetak daftar verifikasi berkas MCU.
        </li>
    </div>
</ol>
