<div class="white-container" id="input-penerimaan-kas">
    ...
    <table width="100%">
        <tr>
            ...
            <td>
                ...
                <?php echo $form->textFieldRow($modPenUmum,'hargasatuan',array('onblur'=>'hitungTotalHarga()','class'=>'inputFormTabel integer reqForm', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
            ...
            <tr>
                ...
                <td width="20%">
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo CHtml::textField('totTagihan',$totTagihan,array('readonly'=>true,'class'=>'inputFormTabel integer span3', 'onkeypress'=>"return $(this).focusNextInputField(event);")) ?>
                        </div>
                    </div>
	...
	<input type="hidden" id="tandabuktibayar_id">
    <div class="form-actions">
        <div style="float:left;margin-right:6px;">
           ...
           <?php echo CHtml::link(Yii::t('mds','{icon} Ulang',array('{icon}'=>'<i class="icon-refresh icon-white"></i>')), 
                    Yii::app()->createUrl($this->module->id.'/penerimaanKas/index'), 
                    array('class'=>'btn btn-danger',
                          'onclick'=>'myConfirm("Apakah anda ingin mengulang ini?","Perhatian!",function(r){if(r) window.location = window.location.href;}); return false;'));  ?>
            <?php
				echo CHtml::htmlButton(Yii::t('mds','{icon} Print',array('{icon}'=>'<i class="icon-print icon-white"></i>')),array('class'=>'btn btn-info', 'type'=>'button','id'=>'printhasil','disabled'=>true,'onclick'=>'print()'))."&nbsp"; 
