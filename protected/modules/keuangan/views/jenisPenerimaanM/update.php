<div class="white-container">
    <legend class='rim2'>Ubah <b>Jenis Penerimaan</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Update').' Jenis Penerimaan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
