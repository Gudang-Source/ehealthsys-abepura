<div class="white-container">
    <legend class='rim2'>Tambah <b>Jenis Penerimaan</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Jenis Penerimaan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
