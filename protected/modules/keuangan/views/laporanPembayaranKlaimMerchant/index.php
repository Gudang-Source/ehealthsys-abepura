<div class="white-container">
    <?php
    $url = Yii::app()->createUrl('keuangan/laporanPembayaranKalimMerchant/FrameGrafikLaporanPembayaranKalimMerchant&id=1');
    ...
    ");
    ?>
    <legend class="rim2">Laporan Pembayaran <b>Klaim Merchant</b></legend>
    <fieldset class="box">
