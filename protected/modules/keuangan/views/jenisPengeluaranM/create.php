<div class="white-container">
    <legend class='rim2'>Tambah <b>Jenis Pengeluaran</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Jenis Pengeluaran ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
