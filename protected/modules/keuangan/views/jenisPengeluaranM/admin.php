<div class="white-container">
    <legend class='rim2'>Pengaturan <b>Pengeluaran Umum</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' Pengeluaran Umum ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master')));
    ...
    <!--</div>-->
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Pengeluaran Umum', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('JenisPengeluaranM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
