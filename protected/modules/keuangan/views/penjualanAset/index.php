...
<legend class="rim2">Transaksi <b>Penjualan Peralatan Medis</b></legend>
	<fieldset class="box">
		...
		<div class="form-actions">
			<?php echo CHtml::htmlButton(Yii::t('mds','{icon} Search',array('{icon}'=>'<i class="icon-search icon-white"></i>')),array('class'=>'btn btn-primary', 'type'=>'button', 'onclick'=>'ambilDataPenghapusan(); return false;')); ?>
		</div>
	</fieldset>
<div id="div_tblInputUraian" class="block-tabel">
	<h6>Tabel Peralatan Medis</h6>
...
<div class="form-actions">
	<?php $disableSave = (isset($_GET['sukses'])) ? 'disabled' : ''; ?>
		<?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="icon-ok icon-white"></i>')), array('class' => 'btn btn-primary', 'type'=>'button','onclick'=>'cekSimpanPeralatanMedis()', 'onkeypress'=>'cekSimpanPeralatanMedis()','disabled'=>$disableSave)); ?>
    <?php
