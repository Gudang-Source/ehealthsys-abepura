<div class="white-container">
    <legend class='rim2'>Tambah <b>Mata Uang</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Mata Uang ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
