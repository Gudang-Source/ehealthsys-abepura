 ...
 */
class KUPengeluaranumumT extends PengeluaranumumT
{
	/**
	...
	public $periodegaji,$biayaadministrasi,$biayamaterai,$instalasi_id;
	public $is_posting,$jmlgaji;
	...
	public function getTotal(){
            return $this->totalharga + $this->biayaadministrasi;
        }
