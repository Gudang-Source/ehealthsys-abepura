...
class LaporanPembayaranKlaimPiutangController extends MyAuthController {
    ...
    public function actionIndex()
    {
            ...
            $model=new KUInformasiPembayaranKlaimPiutangV();
    ...
    public function actionPrint(){
        ...
        if (isset($_REQUEST['KUInformasiPembayaranKlaimPiutangV'])) {
            $model->attributes = $_REQUEST['KUInformasiPembayaranKlaimPiutangV'];
            $model->tgl_awal = $format->formatDateTimeForDb($_REQUEST['KUInformasiPembayaranKlaimPiutangV']['tgl_awal']);
            $model->tgl_akhir = $format->formatDateTimeForDb($_REQUEST['KUInformasiPembayaranKlaimPiutangV']['tgl_akhir']);
        }
