<!--<div class="white-container">
    <legend class="rim2">Tambah <b>Jenis Diet</b></legend>-->
<fieldset class="box row-fluid">
    <legend class="rim">Tambah <b>Jenis Diet</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Jenis Diet ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
