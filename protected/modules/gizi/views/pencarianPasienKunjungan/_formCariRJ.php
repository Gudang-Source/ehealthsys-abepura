...
//                'filter'=>$model,
	...
	'columns'=>array(
                    ...
                    array(
                        ...
                        'type'=>'raw',
                        'value'=>'CHtml::link("<i class=\"icon-user\"></i>",Yii::app()->controller->createUrl("/gizi/pemeriksaanGizi&pendaftaran_id",array("pendaftaran_id"=>$data->pendaftaran_id,"pasien_id"=>$data->pasien_id,"pasienadmisi_id"=>"")), array("rel"=>"tooltip","title"=>"Klik untuk Rencana Pemeriksaan"))', 'htmlOptions'=>array('style'=>'text-align: center; width:40px')
                    ),
