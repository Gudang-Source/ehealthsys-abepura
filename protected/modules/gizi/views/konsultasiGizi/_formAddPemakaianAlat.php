<tr>
    ...
    <td>
        <?php echo CHtml::hiddenField("pemakaianAlat[0][hargajual]", $modObatAlkes->hargajual,array('readonly'=>true,'class'=>'inputFormTabel lebar3 currency')); ?>
    ...
    <!--<td>-->
        <?php echo CHtml::hiddenField("pemakaianAlat[0][subtotal]", $modObatAlkes->hargajual,array('readonly'=>true,'class'=>'inputFormTabel lebar3 currency')); ?>
    <!--</td>-->
</tr>
