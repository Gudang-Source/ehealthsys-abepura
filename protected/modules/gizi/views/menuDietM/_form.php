...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
                <table style="width:450px">
                    ...
                    <tr>
                        <td  colspan="2">
                            <div class='control-group'>
                                  <?php echo $form->labelEx($model,'daftartindakan_id',array('class'=>'control-label', 'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                             <div class="controls">
                                 <?php echo $form->hiddenField($model,'daftartindakan_id',array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                                    <?php
                    ...
                    <tr>
                        <td>
                            <?php echo $form->textFieldRow($model,'jml_porsi',array('class'=>'span1 numbers-only', 'onkeypress'=>"return $(this).focusNextInputField(event)", "style"=>"text-align: right;")); ?>
                        </td>
                        <td>
                                <?php echo $form->dropDownList($model,'ukuranrumahtangga',
                                CHtml::listData($model->URTItems, 'lookup_name', 'lookup_value'),
                                array('class'=>'inputRequire span2', 'style'=>"margin-right:80px;",'onkeypress'=>"return $(this).focusNextInputField(event)",
                                'empty'=>'-- Pilih --',)); ?>
                        </td>
                    </tr>
                </table>
