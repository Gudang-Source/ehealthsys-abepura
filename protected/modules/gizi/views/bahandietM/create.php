<!--<div class="white-container">
    <legend class="rim2">Tambah <b>Bahan Diet</b></legend>-->
<fieldset class="box row-fluid">
    <legend class="rim">Tambah <b>Bahan Diet</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Bahan Diet ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
