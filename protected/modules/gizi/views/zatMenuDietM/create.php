<!--<div class="white-container">
    <legend class="rim2">Tambah Zat <b>Menu Diet</b></legend>-->
<fieldset class="box row-fluid">
    <legend class="rim">Tambah <b>Zat Menu Diet</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Zat Menu Diet ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
