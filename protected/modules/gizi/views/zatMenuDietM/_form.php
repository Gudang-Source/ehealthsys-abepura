...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	'id'=>'gzzatmenudiet-m-form',
	'enableAjaxValidation'=>false,
                'type'=>'horizontal',
                'focus'=>'#ZatMenuDietM_zatgizi_id',
	...
	<?php echo $form->errorSummary($model); ?>
                                ...
                                array('class'=>'inputRequire', 'onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --',)); ?>
		<?php echo $form->textFieldRow($model,'kandunganmenudiet',array('class'=>'span1', 'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                ...
                <div class="form-actions">
                        ...
                        <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Zat Menu Diet', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),
                                                                    $this->createUrl('zatMenuDietM/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));?>
                        <?php
