...
<div class = "span4">
    ...
    <div class="control-group ">
        <?php echo CHtml::label("No. Mobile Pasien <span class='required'>*</span>", '',array('class'=>'control-label required'))?>
        <div class="controls">
...
<?php
    $this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
        'id'=>'dialogPasien',
        'options'=>array(
            'title'=>'Pencarian Data Pasien Konsultasi Gizi',
            'autoOpen'=>false,
            'modal'=>true,
            'width'=>960,
            'height'=>480,
        ...
        $modDataPasien = new GZPasienM('searchDialog');
        $modDataPasien->unsetAttributes();
        if(isset($_GET['GZPasienM'])) {
            $modDataPasien->attributes = $_GET['GZPasienM'];
            $modDataPasien->cari_kelurahan_nama = $_GET['GZPasienM']['cari_kelurahan_nama'];
            $modDataPasien->cari_kecamatan_nama = $_GET['GZPasienM']['cari_kecamatan_nama'];
        }
