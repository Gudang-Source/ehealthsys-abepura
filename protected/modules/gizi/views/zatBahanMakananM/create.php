<!--<div class="white-container">
    <legend class="rim2">Tambah Zat <b>Bahan Makanan</b></legend>-->
<fieldset class="box row-fluid">
    <legend class="rim">Tambah <b>Zat Bahan Makanan</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Zat Makanan ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
