<fieldset class="box row-fluid">
    <?php
        if ($model->lookup_type == 'jenisbahanmakanan'):      
            echo "<legend class='rim'>Pengaturan <b>Jenis Bahan Makanan</b></legend>";             
            $tambah = CHtml::link(Yii::t('mds', '{icon} Tambah Jenis Bahan Makanan', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('/gizi/JenisBahanMakanan/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
        else:   
            echo "<legend class='rim'>Pengaturan <b>Kelompok Bahan Makanan</b></legend>";            
            $tambah = CHtml::link(Yii::t('mds', '{icon} Tambah Kelompok Bahan Makanan', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('/gizi/KelompokBahanMakanan/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp";
        endif;
    ?>  
