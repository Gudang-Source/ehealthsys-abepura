...
<table border="0" style="padding :none;">
  ...
  <tr>
    ...
    <td>Icon  <i class="icon-form-detail"></i> untuk melihat rincian pengajuan bahan makanan.</td>
  </tr>  
  <tr>
    <td style = "vertical-align:middle;">3. </td>
    <td>Icon  <i class="icon-form-terimabahan"></i> untuk melanjutkan ke penerimaan.</td>
  </tr> 
  <tr>
