<!--<div class="white-container">
    <legend class="rim2">Tambah Bahan <b>Menu Diet</b></legend>-->
<fieldset class="box row-fluid">
    <legend class="rim">Tambah <b>Bahan Menu Diet</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Bahan Menu Diet ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
