<div class="white-container">
    ...
    <table style="width:100%" class="table table-striped">
        ...
        <tr>
            ...
            <td width="30%">
                <?php echo CHtml::label((isset($model->jabatan_id) ? $model->jabatan->jabatan_nama : "") . '/' . (isset($model->kelompokjabatan) ? $model->kelompokjabatan : ""), (isset($model->jabatan_id) ? $model->jabatan->jabatan_nama : "") . '/' . (isset($model->kelompokjabatan) ? $model->kelompokjabatan : ""));
                ?>                    
            </td>
            <td width="20%">
