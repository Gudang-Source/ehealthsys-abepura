...
<!--    <td>-->
    ...
    <td><?php echo CHtml::activeTextField($modTindakan, '[0]tarifcyto_tindakan', array('readonly'=>true,'class'=>'inputFormTabel currency')) ?><?php echo CHtml::activeHiddenField($modTindakan, '[0]jumlahTarif', array('readonly'=>true,'class'=>'inputFormTabel currency')) ?></td>
    <td rowspan="2">
        <?php 
