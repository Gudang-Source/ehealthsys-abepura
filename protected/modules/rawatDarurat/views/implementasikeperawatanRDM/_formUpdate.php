...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'diagnosakeperawatan_id',array('value'=>$model->diagnosakeperawatan_id, 'class'=>'span3', 'onkeypress'=>"return nextFocus(this,event,'ImplementasikeperawatanM_implementasikeperawatan_kode','ImplementasikeperawatanM_rencanakeperawatan_id','')")); ?>
...
function addRow(obj)
{
    ...
    $('#tbl-ImplementasiKeperawatan tr:last td:last').append('$buttonMinus');
        renameInput('RDImplementasikeperawatanM','implementasikeperawatan_id');
        renameInput('RDImplementasikeperawatanM','rencanakeperawatan_id');
        renameInput('RDImplementasikeperawatanM','implementasikeperawatan_kode');
        renameInput('RDImplementasikeperawatanM','implementasi_nama');
        renameInput('RDImplementasikeperawatanM','iskolaborasiimplementasi');
