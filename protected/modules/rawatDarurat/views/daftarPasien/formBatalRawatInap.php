...
<fieldset>
    <legend class="rim">Alasan Batal <?php $pulang = RDPasienPulangT::model()->findByPk($modPendaftaran->pasienpulang_id); echo ucwords(strtolower($pulang->carakeluar->carakeluar_nama)); ?></legend>
