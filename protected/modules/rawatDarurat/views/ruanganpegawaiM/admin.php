...
<?php 
        echo CHtml::link(Yii::t('mds','{icon} Tambah Ruangan Pegawai',array('{icon}'=>'<i class="icon-plus icon-white"></i>')), 
        ...
        // echo CHtml::link(Yii::t('mds','{icon} Tambah Ruangan Pegawai',array('{icon}'=>'<i class="icon-file icon-white"></i>')), 
        //                             Yii::app()->createUrl($this->module->id.'/ruanganpegawaiM/create'), 
        //                             array('class'=>'btn btn-success'));
