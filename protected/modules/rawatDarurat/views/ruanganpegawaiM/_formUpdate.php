...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<p class="help-block"><?php echo Yii::t('mds','Fields with <span class="required">*</span> are required.') ?></p>
        ...
        <table id="tabelKasuspenyakitdiagnosa" class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                {
                    $hapus = Yii::app()->createUrl('rawatDarurat/ruanganpegawaiM/Delete',array("id"=>"$value->ruangan_id","pegawai"=>"$value->pegawai_id"));
                    $tr = '<tr>';
	...
	<div class="form-actions">
                ...
                <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Ruangan Pegawai', array('{icon}'=>'<i class="icon-file icon-white"></i>')), $this->createUrl(Yii::app()->controller->id.'/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp"; ?>
                <?php
