<?php 
//$this->wid/get('bootstrap.widgets.BootMenu', array(
...
$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','List').' Kabupaten ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
