<div class="white-container">
    ...
    $url = Yii::app()->createUrl('rawatDarurat/laporan/frameGrafikLaporanJasaInstalasi&id=1');
    ...
    <fieldset class="box row-fluid">
        <?php $this->renderPartial('jasaInstalasi/_searchJasaInstalasi',array(
            'model'=>$model,
        )); ?>
    </fieldset><!-- search-form -->
    <div class="block-tabel">
        <h6>Tabel <b>Jasa Instalasi</b></h6> 
        <?php $this->renderPartial('jasaInstalasi/_tableJasaInstalasi', array('model'=>$model)); ?>
    </div>
    <div class="block-tabel">
