<div class="white-container">
    ...
    $url = Yii::app()->createUrl('rawatDarurat/laporan/frameGrafikLaporanBiayaPelayanan&id=1');
    ...
    <fieldset class="box row-fluid">
        <?php $this->renderPartial('biayaPelayanan/_searchBiayaPelayanan',array(
            'model'=>$model,
        )); ?>
    </fieldset><!-- search-form --> 
    <div class="block-tabel">
        <h6>Tabel <b>Biaya Pelayanan</b></h6>
        <?php $this->renderPartial('biayaPelayanan/_tableBiayaPelayanan', array('model'=>$model)); ?>
    </div>
    <div class="block-tabel">
