<?php isset($_GET['pasienkirimkeunitlain_id'])?$disabled=true:$disabled=false; ?>
<div class = "span4">
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Ketik No. Pendaftaran','class'=>'all-caps','rel'=>'tooltip','title'=>'Ketik no. pendaftaran','disabled' => $disabled,
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Ketik No. Rekam Medik','class'=>'all-caps','rel'=>'tooltip','title'=>'Ketik no. rekam medik untuk mencari data kunjungan','disabled' => $disabled,
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); 
            ?>
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Ketik Nama Pasien','rel'=>'tooltip','title'=>'Ketik nama pasien untuk mencari data kunjungan','disabled' => $disabled,
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); 
            ?>
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    $modDialogKunjungan = new BSPasienKirimKeUnitLainV('searchDialogKunjungan');
    $modDialogKunjungan->unsetAttributes();
    if(isset($_GET['BSPasienKirimKeUnitLainV'])) {
        $modDialogKunjungan->attributes = $_GET['BSPasienKirimKeUnitLainV'];
    }
