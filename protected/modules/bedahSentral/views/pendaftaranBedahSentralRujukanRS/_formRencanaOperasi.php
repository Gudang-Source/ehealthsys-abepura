...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $form->dropDownList($modRencanaOperasi,'dokterpelaksana1_id', CHtml::listData($modRencanaOperasi->getDokterItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai') ,array('empty'=>'-- Pelaksana 1 --','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'span3')); ?>
...
<div class="control-group">
	...
	<div class="controls">
		<?php echo $form->dropDownList($modRencanaOperasi,'dokterpelaksana2_id', CHtml::listData($modRencanaOperasi->getDokterItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai') ,array('empty'=>'-- Pelaksana 2 --','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'span3')); ?>
		<?php echo $form->error($modRencanaOperasi, 'dokterpelaksana2_id'); ?>
	</div>
</div>

<?php echo $form->dropDownListRow($modRencanaOperasi,'dokteranastesi_id', CHtml::listData($modRencanaOperasi->getDokterItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai') ,array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'span3')); ?>
