    ...
    //                                    'accordion'=>false, //default
                            'content'=>array(
                                'content1'=>array(
                                    ...
                                    'isi'=>'<table width="100%">'
                                                . '<tr>'
                                                    . '<td>'.CHtml::hiddenField('filter', 'wilayah').'<label>Propinsi</label>'. '</td>'
                                                    . '<td>'.$form->dropDownList($model, 'propinsi_id', CHtml::listData($model->getPropinsiItems(), 'propinsi_id', 'propinsi_nama'), array('empty' => '-- Pilih --',
                                                ...
                                                . '<tr>'
                                                    ...
                                                    . '<td>'.
                                                                $form->dropDownList($model, 'kelurahan_id', array(), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)"))
                                                    .'</td>'
                                                . '</tr>'
                                            . '</table>',
                                    'active'=>true,
