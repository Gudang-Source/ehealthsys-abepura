<legend class="rim2">Laporan Rekap Piutang</legend>
<?php
    $url = Yii::app()->createUrl(Yii::app()->controller->module->id.'/laporan/frameGrafikLaporanRekapPiutangPenjamin&id=1');
    ...
    $('#searchLaporan').submit(function(){
        ...
        $.fn.yiiGridView.update('laporanrekappiutangpenjamin-grid', {
                data: $(this).serialize()
        });
        $.fn.yiiGridView.update('laporanrekappiutangumum-grid', {
                data: $(this).serialize()
        });
        return false;
    });
...
<?php   $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
        ...
        $urlPrint=  Yii::app()->createAbsoluteUrl($module.'/'.$controller.'/printLaporanRekapPiutangPenjamin');
