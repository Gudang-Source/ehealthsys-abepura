<legend class="rim2">Infomasi Tarif Bedah Sentral</legend> 		
...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'enableAjaxValidation'=>false,
        ...
        'htmlOptions'=>array('enctype'=>'multipart/form-data','onKeyPress'=>'return disableKeyPress(event)'),
            ...
            <?php echo $form->dropDownListRow($modTarifTindakanRuanganV,'kategoritindakan_id',CHtml::listData(TariftindakanperdaruanganV::model()->findAll('kategoritindakan_id is not null'), 'kategoritindakan_id', 'kategoritindakan_nama'),array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
            ...
            <?php echo $form->dropDownListRow($modTarifTindakanRuanganV,'kelaspelayanan_id',CHtml::listData(TariftindakanperdaruanganV::model()->findAll(), 'kelaspelayanan_id', 'kelaspelayanan_nama'),array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
