...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Kelas Ruangan', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('kelasruanganM/create',array('modul_id'=> Yii::app()->session['modul_id'])), 
