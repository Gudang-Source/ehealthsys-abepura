...
<?php $this->widget('ext.bootstrap.widgets.BootGroupGridView',array(
	...
	'columns'=>array(
                    ...
                    array(
                        ...
                        'buttons'=>array(
                            'view'=>array(
                                'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/View",
                                        array("id"=>"$data->ruangan_id","pegawai"=>"$data->pegawai_id"))',
                    ...
                    array(
                        ...
                        'buttons'=>array(
                            'update'=>array(
                                'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/Update",
                                        array("id"=>"$data->ruangan_id"))',
                    ...
                    array(
                        ...
                        'buttons'=>array(
                            'delete'=>array(
                                'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/Delete",
                                        array("ruangan_id"=>"$data->ruangan_id","pegawai_id"=>"$data->pegawai_id"))',
...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Ruangan Pegawai', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('RuanganpegawaiM/create',array('modul_id'=> Yii::app()->session['modul_id'])), 
