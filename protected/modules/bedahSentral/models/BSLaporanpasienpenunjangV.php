 ...
 * @author sujana
 */
class BSLaporanpasienpenunjangV extends LaporanpasienpenunjangV {
    
    public $jns_periode, $bln_awal, $bln_akhir, $thn_awal, $thn_akhir, $tgl_awal, $tgl_akhir, $data, $jumlah;
