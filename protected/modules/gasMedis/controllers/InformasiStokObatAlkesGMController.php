...
class InformasiStokObatAlkesGMController extends InformasiStokObatAlkesController {
    ...
    public function actionIndex()
    {
        ...
        $instalasiAsals = array(); // CHtml::listData(GFInstalasiM::getInstalasiStokOas(),'instalasi_id','instalasi_nama');
        $ruanganAsals = array(); // CHtml::listData(GFRuanganM::getRuanganStokOas(Params::INSTALASI_ID_FARMASI),'ruangan_id','ruangan_nama');
