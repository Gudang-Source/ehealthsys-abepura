...
class PemakaianBahanGMController extends PemakaianBahanController
{
    public $path_view = "gasMedis.views.pemakaianBahanGM.";
    ...
    public function actionIndex($pendaftaran_id=null)
    {
        ...
        if(!empty($pendaftaran_id)){
            $modKunjungan= RJInfokunjunganrjV::model()->findByAttributes(array('pendaftaran_id'=>$pendaftaran_id));
        }
    ...
    public function actionSetRiwayatObatAlkesPasien(){
        if(Yii::app()->request->isAjaxRequest) {
            $format = new MyFormatter();
            $rows = "";
            $loadOaPasiens = RJObatalkesPasienT::model()->findAllByAttributes(array('pendaftaran_id'=>$_POST['pendaftaran_id']));
    ...
    public function actionPrint($pendaftaran_id) 
    {
        ...
        $format = new MyFormatter;    
        $modPendaftaran = RJInfokunjunganrjV::model()->findByAttributes(array('pendaftaran_id'=>$pendaftaran_id));     
