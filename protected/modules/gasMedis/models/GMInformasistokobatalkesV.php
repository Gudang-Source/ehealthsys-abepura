...
class GMInformasistokobatalkesV extends InformasistokobatalkesV
{
    public $kemasanbesar;
    public $discount;
        ...
        public function attributeLabels()
	{
		$label = parent::attributeLabels();
                $label['obatalkes_nama'] = 'Nama Gas Medis';
                $label['obatalkes_kode'] = 'Kode Gas Medis';
                $label['obatalkes_golongan'] = 'Golongan Gas Medis';
                return $label;
	}
