 ...
 */
class MOResepturdetailT extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MOResepturdetailT the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('obatalkes_id, racikan_id, sumberdana_id, reseptur_id, qty_reseptur, harganetto_reseptur, hargajual_reseptur', 'required'),
			array('obatalkes_id, racikan_id, satuankecil_id, sumberdana_id, reseptur_id, rke, permintaan_reseptur, jmlkemasan_reseptur, kekuatan_reseptur', 'numerical', 'integerOnly'=>true),
			array('qty_reseptur, hargasatuan_reseptur, harganetto_reseptur, hargajual_reseptur', 'numerical'),
			...
			array('resepturdetail_id, obatalkes_id, racikan_id, satuankecil_id, sumberdana_id, reseptur_id, r, rke, permintaan_reseptur, jmlkemasan_reseptur, kekuatan_reseptur, satuankekuatan, qty_reseptur, hargasatuan_reseptur, signa_reseptur, harganetto_reseptur, hargajual_reseptur, etiket', 'safe', 'on'=>'search'),
		);
	}
