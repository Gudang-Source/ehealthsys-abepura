...
//            $models = ROInfokunjunganrjrdriV::model()->findAll();
...
//        }
        ...
        $model = new ROInfokunjunganrjrdriV;
        $model->tgl_awal = date('Y-m-d');
        $model->tgl_akhir = date('Y-m-d');

        if(isset($_GET['ROInfokunjunganrjrdriV'])){
            $model->attributes=$_GET['ROInfokunjunganrjrdriV'];
            $model->tgl_awal = $format->formatDateTimeForDb($_GET['ROInfokunjunganrjrdriV']['tgl_awal']);
            $model->tgl_akhir = $format->formatDateTimeForDb($_GET['ROInfokunjunganrjrdriV']['tgl_akhir']);
