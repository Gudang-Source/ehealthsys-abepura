...
class KelasruanganMController extends MyAuthController
{
        ...
        public $path_view = 'radiologi.views.kelasruanganM.';
                ...
                if(isset($_POST['kelaspelayanan_id']))
                {
                    ...
                    try{
                        ...
                        for($i=0;$i<COUNT($_POST['kelaspelayanan_id']);$i++)
                        {
                            ...
                            $kelasruangan = KelasruanganM::model()->findByAttributes(array('ruangan_id'=>$model->ruangan_id,'kelaspelayanan_id'=>$model->kelaspelayanan_id ));
                        ...
                        if(($jumlah+$kelasruangan_exist) == count($_POST['kelaspelayanan_id'])){
                            $transaction->commit();
