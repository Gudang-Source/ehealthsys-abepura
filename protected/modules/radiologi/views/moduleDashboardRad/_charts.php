		...
		<thead>
			<tr>
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Pengunjung Baru</div>
				...
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Pengunjung Lama</div>
...
$(document).ready(function($) 
{
	...
	Morris.Line({
		...
		xkey: 'x',
		ykeys: ['y_1','y_2'],
		labels: ['Kunjungan Baru', 'Kunjungan Lama'],
		parseTime: false,
    ...
    var donut_chart = Morris.Donut({
		...
		if(count($dataDonutChart) > 0){
			foreach ($dataDonutChart as $i => $chart) { ?>
				{label: "<?php echo $chart['penjamin_nama']; ?>", value: <?php echo $chart['jumlah']; ?>},
			<?php }
		}?>
        ],
        colors: [
