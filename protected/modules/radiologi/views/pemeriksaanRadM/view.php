<div class="white-container">
    ...
    <?php $this->widget('ext.bootstrap.widgets.BootDetailView',array(
            ...
            'attributes'=>array(
                    'pemeriksaanrad_id',
                    'daftartindakan_id',
                    'jenispemeriksaanrad.jenispemeriksaanrad_nama',
                    'pemeriksaanrad_nama',
                    'pemeriksaanrad_namalainnya',
                    'pemeriksaanrad_aktif',
            ),
    )); ?>
    <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Pemeriksaan Radiologi', array('{icon}'=>'<i class="icon-file icon-white"></i>')), $this->createUrl(Yii::app()->controller->id.'/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp"; ?>
