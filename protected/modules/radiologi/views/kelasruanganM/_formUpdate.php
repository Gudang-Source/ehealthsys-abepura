...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<p class="help-block"><?php echo Yii::t('mds','Fields with <span class="required">*</span> are required.') ?></p>
        ...
        <table id="tabelkelasruangan" class="table table-striped table-condensed">
            <thead>
            <tr>
            ...
            <tbody>
                ...
                {
                    $hapus = Yii::app()->createUrl('radiologi/kelasruanganM/Delete',array('ruangan_id'=>"$value->ruangan_id",'kelaspelayanan_id'=>"$value->kelaspelayanan_id"));
                    $tr = '<tr>';
