 ...
 */
class ROPasienM extends PasienM
{
    /**
...
//    public $tgl_rm_akhir;
    ...
    public function rules()
    {
            ...
            return array(
                    array('no_rekam_medik, tgl_rekam_medik, nama_pasien, tanggal_lahir, alamat_pasien, agama, 
                          warga_negara, statusrekammedis, create_ruangan, kabupaten_id, propinsi_id, kecamatan_id,
                          jeniskelamin', 'required'), //kelurahan_id, 
                    ...
                    array('create_time, tgl_rekam_medik','default','value'=>date('Y-m-d H:i:s'),'setOnEmpty'=>false,'on'=>'insert'),
...
//        $criteria->addBetweenCondition('t.tgl_pendaftaran', $this->tgl_rm_awal, $this->tgl_rm_akhir);
        $criteria->join = 'RIGHT JOIN hasilpemeriksaanrad_t ON hasilpemeriksaanrad_t.pasien_id = t.pasien_id RIGHT JOIN pasienkirimkeunitlain_t ON pasienkirimkeunitlain_t.pasien_id=hasilpemeriksaanrad_t.pasien_id';
