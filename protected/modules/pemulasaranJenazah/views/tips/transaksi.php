...
<table border="0" style="padding :none;">
  ...
  <tr>
    ...
    <td>3. </td>
    <td>Tombol   
  <button id="btnAddParamedis2" class="btn btn-search" type="button" name="yt5" rel="tooltip" onkeypress="return $(this).focusNextInputField(event)" onclick="$('#dialogTarif').dialog('open');" data-original-title="Klik untuk mencari Tarif Ambulans">
<i class="icon-search icon-white"></i>
<i class="icon-white icon-chevron-right"></i>
</button> untukl mencari data tarif anmbulans.</td>
  </tr>
