...
<div class="search-form" style="">
    ...
    <table width='100%'>
        <tr>
            ...
            <td>
                <fieldset class='box2'>
                    <legend class="rim">Berdasarkan Kelas Pelayanan 
    ...
    <div class="form-actions">
        <?php
            echo CHtml::htmlButton(Yii::t('mds', '{icon} Search', array('{icon}' => 
                '<i class="icon-ok icon-white"></i>')), array('class' => 'btn btn-primary', 'type' => 'submit', 'id' => 'btn_simpan'));
        ?>
