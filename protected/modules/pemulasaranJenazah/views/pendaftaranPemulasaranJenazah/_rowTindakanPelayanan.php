<tr>
    ...
    <td>
        <?php echo CHtml::activeTextField($modTindakan,'[ii]qty_tindakan',array('readonly'=>true,'class'=>'span1 integer')); ?>
    </td>
    <td>
    ...
    <td>
        <?php echo CHtml::link('<i class="icon-remove"></i>', '#', array('onclick'=>'batalTindakan(this);return false;','rel'=>'tooltip','title'=>'Klik untuk membatalkan konsultasi gizi'));  ?>
    </td>
</tr>
