...
<div class='white-container'>
    <legend class="rim2">Pendaftaran Pemulasaran <b>Jenazah Dari Luar</b></legend>
    ...
    <div class="row-fluid">
        <div class="span6">
                ...
                if(Yii::app()->user->getState('issmsgateway')){
                   $this->renderPartial('_formSms', array('form'=>$form,'modSmsgateway'=>$modSmsgateway)); 
                }
                ?>
        </div>
    </div>
                ...
                <?php $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
                        ...
                        'content'=>array(
                            'content-pjpasien'=>array(
                                'header'=>CHtml::htmlButton("<i class='icon-minus icon-white'></i>",array('class'=>'btn btn-primary btn-mini','onclick'=>'','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk tampilkan penanggung jawab pasien')).'<b> Penanggung Jawab Jenazah</b>',
                ...
                <?php $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
                        ...
                        'content'=>array(
                            'content-karcis'=>array(
                                'header'=>CHtml::htmlButton("<i class='icon-minus icon-white'></i>",array('class'=>'btn btn-primary btn-mini','onclick'=>'','onkeyup'=>"return $(this).focusNextInputField(event)",'rel'=>'tooltip','title'=>'Klik untuk memilih karcis')).'<b> Karcis Pemulasaran Jenazah</b>',
...
<?php
    ...
    $this->endWidget();
?>
<?php $this->renderPartial('_jsFunctions', array('model'=>$model, 'modPasien'=>$modPasien, 'modPenanggungJawab'=>$modPenanggungJawab, 'modRujukan'=>$modRujukan, 'modPasienMasukPenunjang'=>$modPasienMasukPenunjang, 'modTindakan'=>$modTindakan,'modAsuransiPasien'=>$modAsuransiPasien)); ?>

<?php $this->renderPartial($this->path_view.'_jsFunctions', array('modAsuransiPasienBadak'=>$modAsuransiPasienBadak, 'modAsuransiPasienDepartemen'=>$modAsuransiPasienDepartemen, 'modAsuransiPasienPekerja'=>$modAsuransiPasienPekerja,'modPegawai'=>$modPegawai,'model'=>$model, 'modPasien'=>$modPasien, 'modPenanggungJawab'=>$modPenanggungJawab, 'modRujukan'=>$modRujukan, 'modPasienMasukPenunjang'=>$modPasienMasukPenunjang, 'modTindakan'=>$modTindakan,'modAsuransiPasien'=>$modAsuransiPasien)); ?>
