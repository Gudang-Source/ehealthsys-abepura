...
//    $("#PJPemakaianambulansT_jumlahkm").val(jmlKM);
//    $("#PJPemakaianambulansT_tarifperkm").val(tarifKM);
//    $("#PJPemakaianambulansT_totaltarifambulans").val(tarif);
