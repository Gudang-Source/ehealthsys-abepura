<div class="block-tabel" id="formNonRacikan">
    <h6>Pemakaian Obat & <b>Alat Kesehatan</b></h6>
    <table width="100%">
        <tr>
            <td>
...
$moObatAlkes = new PJObatAlkesM('search');
$moObatAlkes->unsetAttributes();
if(isset($_GET['PJObatAlkesM']))
    $moObatAlkes->attributes = $_GET['PJObatAlkesM'];
