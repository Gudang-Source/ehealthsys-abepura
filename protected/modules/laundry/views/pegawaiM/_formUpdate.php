...
<!--<img src="<?php //echo Params::urlPegawaiDirectory()?>9680901rizky.jpg " id="gambar">  -->
                ...
                <td>
                   <img src="<?php echo Params::urlPegawaiTumbsDirectory().$model->photopegawai ?> ">     
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="2">
                        ...
                        <div class="control-group">
                           ...
                           $this->widget('application.extensions.emultiselect.EMultiSelect',
                            ...
                            'ruangan_id[]',
                            $arrRuanganPegawai,
                           CHtml::listData(RDRuanganM::model()->findAll(array('order'=>'ruangan_nama')), 'ruangan_id', 'ruangan_nama'),
