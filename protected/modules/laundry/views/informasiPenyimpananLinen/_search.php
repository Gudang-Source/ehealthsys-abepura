...
$form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'method'=>'get',
	'id'=>'penyimpananlinen-info-search',
	'type'=>'horizontal',
	'focus'=>'#'.CHtml::activeId($model,'nopenyimpamanlinen'),

)); ?>
<div class="row-fluid">
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::label('Tanggal Penyimpanan','tglpenyimpananlinen', array('class'=>'control-label')) ?>
			<div class="controls">
				<?php   
	...
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::activeLabel($model,'nopenyimpamanlinen',array('class'=>'control-label')); ?>
			<div class="controls">
			   <?php echo $form->textField($model,'nopenyimpamanlinen',array('placeholder'=>'Ketik No. Penyimpanan', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
		<div class="control-group">
