<tr>
	...
	<td>
        <?php echo CHtml::activeTextField($modDetail,'[ii]jmlbahanpemakaian',array('readonly'=>true,'class'=>'span2 integer','style'=>'width:45px;','onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
    </td>
	<td>
