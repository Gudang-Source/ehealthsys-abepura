...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'id' => 'pencarian-form',
    'type' => 'horizontal',
    'focus'=>'#'.CHtml::activeId($modInfoPencucian,'nopenerimaanlinen'),
        ));
?>
	<div class="row-fluid">
		<div class="span4">
		...
		<div class="span4">
			...
			<div class="control-group ">
				<?php echo $form->labelEx($modInfoPencucian,'Jenis Perawatan', array('class'=>'control-label')) ?>
					<div class="controls">
						<?php echo $form->dropDownList($modInfoPencucian,'jenisperawatan',LookupM::getItems('jenisperawatan'),array('empty'=>'--Pilih--','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
					</div> 
			</div>
		</div>
		<div class="span4">
