<div class="search-form" style="">
    ...
    <fieldset class="box">
        ...
        <div class="row-fluid">
			...
			<div class="span4">
				<?php echo $form->textFieldRow($model,'jml_tampil',array('class'=>'span3 integer')); ?>
			</div>
        </div>
        <div class="form-actions">
            <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Cari', array('{icon}' => '<i class="icon-ok icon-white"></i>')), array('class' => 'btn btn-primary', 'type' => 'submit', 'id' => 'btn_simpan')); ?>
            <?php
