...
$form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'method'=>'get',
	'id'=>'perawatanlinen-info-search',
	'type'=>'horizontal',
	'focus'=>'#'.CHtml::activeId($model,'noperawatan'),

)); ?>
<div class="row-fluid">
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::label('Tanggal Perawatan','tglperawatanlinen', array('class'=>'control-label')) ?>
			<div class="controls">
				<?php   
	...
	<div class="span4">
		<div class="control-group ">
			<?php echo CHtml::activeLabel($model,'noperawatan',array('class'=>'control-label')); ?>
			<div class="controls">
			   <?php echo $form->textField($model,'noperawatan',array('placeholder'=>'Ketik No. Perawatan', 'class'=>'span3', 'maxlength'=>20,'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
			</div>
		</div>
		<div class="control-group">
