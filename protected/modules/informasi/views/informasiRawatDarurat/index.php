<div class="white-container">
    <legend class="rim2">Informasi <b>Rawat Darurat</b></legend>
    <div class="block-tabel">
        <h6>Tabel Informasi <b>Rawat Darurat</b></h6>
        <?php
    ...
    <fieldset class="box">
        ...
        <table width="100%">
            <tr>
                <td>
                    <?php echo $form->textFieldRow($modRawatDarurat,'no_pendaftaran',array('class'=>'span3','onkeypress'=>"return $(this).focusNextInputField(event)", 'maxlength'=>50, 'autofocus'=>TRUE)); ?>
                </td>
                <td>
                    <?php echo $form->textFieldRow($modRawatDarurat,'nama_pasien',array('class'=>'span3','onkeypress'=>"return $(this).focusNextInputField(event)", 'maxlength'=>50)); ?>
                </td>
                <td>
                    <?php echo $form->textFieldRow($modRawatDarurat,'no_rekam_medik',array('class'=>'span3','onkeypress'=>"return $(this).focusNextInputField(event)", 'maxlength'=>50)); ?>
                </td>
            </tr>
        </table>
