...
$modTarifTindakan=  INTariftindakanM::model()->find('kelaspelayanan_id='.$kelaspelayanan_id.' AND komponentarif_id='.Params::KOMPONENTARIF_ID_TOTAL.'');
}else{ 
    $modTarifTindakan=INTariftindakanM::model()->find('daftartindakan_id='.$daftartindakan_id.'
