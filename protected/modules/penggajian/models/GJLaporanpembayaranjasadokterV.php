...
class GJLaporanpembayaranjasadokterV extends LaporanpembayaranjasadokterV
{
	...
	public function criteriaSearch()
	{
		...
		$criteria->addBetweenCondition('tglbayarjasa',$format->formatDateTimeForDb($this->tgl_awal), $format->formatDateTimeForDb($this->tgl_akhir));
