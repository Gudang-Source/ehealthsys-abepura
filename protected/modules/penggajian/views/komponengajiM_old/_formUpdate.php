...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
    ...
    <div>
        <?php echo $form->radioButtonRow($model,'penerimaan', array('onkeypress'=>"return $(this).focusNextInputField(event);", 'name'=>"komponen", "checked"=>"true")); ?>
	...
	<div class="form-actions">
                        ...
                        <?php echo CHtml::link(Yii::t('mds','{icon} Ulang',array('{icon}'=>'<i class="icon-refresh icon-white"></i>')), 
                                    Yii::app()->createUrl($this->module->id.'/komponengajiMGJ/admin'), 
