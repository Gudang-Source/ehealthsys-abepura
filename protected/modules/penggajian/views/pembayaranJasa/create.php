...
<fieldset class="box">
	...
	<?php echo $this->renderPartial($this->path_view. '_form', array('form'=>$form, 'model'=>$model)); ?>
</fieldset>
...
function hitungSemua(){
    ...
    $("#GJPembayaranjasaT_totaltarif").val(totTarif);
    $("#GJPembayaranjasaT_totaljasa").val(totJasa);
    $("#GJPembayaranjasaT_totalbayarjasa").val(totBayar);
    $("#GJPembayaranjasaT_totalsisajasa").val(totSisa);
    formatNumbers();
}
