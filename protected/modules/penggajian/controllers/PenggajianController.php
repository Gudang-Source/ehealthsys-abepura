...
//        public $defaultAction = 'admin';
	...
	public function actionIndex($idPenggajian=null,$pengeluaranumum_id=null)
	{
		...
		$this->render($this->path_view. 'index',array('modPengUmum'=>$modPengUmum,
									'modUraian'=>$modUraian,
...
//
//                     $modJurnalRekening = PenggajianController::saveJurnalRekening($modPengUmum, $data_parsing['GJPengeluaranumumT']);
