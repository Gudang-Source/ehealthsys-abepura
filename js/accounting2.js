...
function unformatNumber(stringNumber)
{
//    return Number(stringNumber.replace(/[^0-9\,]+/g,""));
//      return Number(accounting.unformat(stringNumber));
      return accounting.unformat(stringNumber);
}
...
{
    return accounting.toFixed(number, 1);
}

/**
 * untuk format ke bilangan bulat (integer)
 * @param {type} number
 * @returns {unresolved}
 */
...
/**
 * untuk format ke bilangan pecahan (float)
 * @param {type} number
 * @returns {unresolved}
 */
